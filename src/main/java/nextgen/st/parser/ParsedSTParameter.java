...
public class ParsedSTParameter {
	...
	private nextgen.model.STParameterType _type;
	...
	public nextgen.model.STParameterType getType() {
		return this._type;
	}

	public ParsedSTParameter setType(nextgen.model.STParameterType value) {
		this._type = value;
		return this;
	}
