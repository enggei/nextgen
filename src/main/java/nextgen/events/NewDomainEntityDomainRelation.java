...
public final class NewDomainEntityDomainRelation {
	...
	public static void post(nextgen.model.DomainEntity domainEntity, nextgen.model.DomainRelatio domainRelation) {
	...
	public final nextgen.model.DomainRelatio domainRelation;

	public NewDomainEntityDomainRelation(nextgen.model.DomainEntity domainEntity, nextgen.model.DomainRelatio domainRelation) {
