...
public class STGroupActionEditor extends nextgen.swing.BaseEditor<nextgen.model.STGroupAction> {

	private final javax.swing.JTabbedPane editors = nextgen.swing.ComponentFactory.newJTabbedPane();
	private final nextgen.swing.forms.STGroupActionForm form = new nextgen.swing.forms.STGroupActionForm();

	public STGroupActionEditor() {
		super();
	}
	...
	@Override
	public void setModel(nextgen.model.STGroupAction model) {
