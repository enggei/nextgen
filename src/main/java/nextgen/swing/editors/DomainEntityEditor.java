...
public class DomainEntityEditor extends nextgen.swing.BaseEditor<nextgen.model.DomainEntity> {

	private final javax.swing.JTabbedPane editors = nextgen.swing.ComponentFactory.newJTabbedPane();
	private final nextgen.swing.forms.DomainEntityForm form = new nextgen.swing.forms.DomainEntityForm();
	...
	public void setModel(nextgen.model.DomainEntity model) {
		...
		if (getComponentCount() == 0) {
			...
			form.getEnumsJTextField().addKeyListener(newSaveListener(txt -> appModel().doLaterInTransaction(tx -> tryToSave())));
