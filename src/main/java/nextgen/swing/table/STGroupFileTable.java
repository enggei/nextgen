...
public class STGroupFileTable extends javax.swing.JTable {

/*
*/
	private Consumer<nextgen.model.STGroupFile> selectionListener;

	public STGroupFileTable() {
		super(new ResultsTableModel());
	}

	public STGroupFileTable setSelectionListener(Consumer<nextgen.model.STGroupFile> selectionListener) {
		this.selectionListener = selectionListener;
		return this;
	}

	public STGroupFileTable setContent(java.util.stream.Stream<nextgen.model.STGroupFile> content) {
		return setContent(content.collect(java.util.stream.Collectors.toList()));
	}

	public STGroupFileTable setContent(java.util.Collection<nextgen.model.STGroupFile> content) {
	...
	public java.util.List<nextgen.model.STGroupFile> getSelectedValues() {
		java.util.List<nextgen.model.STGroupFile> values = new java.util.ArrayList<>();
		for (int selectedRow : getSelectedRows()) values.add(tableModel().content.get(selectedRow).model);
		return values;
	}

	public STGroupFileTable refresh() {
		tableModel().fireTableDataChanged();
		return this;
	}

	public STGroupFileTable clear() {
	...
	public static final class RowElement {
		...
		protected RowElement(nextgen.model.STGroupFile model) {
			this.model = model;
		}
	...
	static final class ResultsTableModel extends javax.swing.table.AbstractTableModel {
		...
		ResultsTableModel(java.util.Collection<nextgen.model.STGroupFile> data) {
			for (nextgen.model.STGroupFile row : data) content.add(new RowElement(row));
		}
		...
		private nextgen.model.STGroupFile getValueAt(int row) {
