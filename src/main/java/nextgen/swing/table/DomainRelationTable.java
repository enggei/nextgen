...
public class DomainRelationTable extends javax.swing.JTable {

/*
	0 name	String	
*/
	private Consumer<nextgen.model.DomainRelation> selectionListener;

	public DomainRelationTable() {
		super(new ResultsTableModel());
	}

	public DomainRelationTable setSelectionListener(Consumer<nextgen.model.DomainRelation> selectionListener) {
		this.selectionListener = selectionListener;
		return this;
	}

	public DomainRelationTable setContent(java.util.stream.Stream<nextgen.model.DomainRelation> content) {
		return setContent(content.collect(java.util.stream.Collectors.toList()));
	}

	public DomainRelationTable setContent(java.util.Collection<nextgen.model.DomainRelation> content) {
	...
	public java.util.List<nextgen.model.DomainRelation> getSelectedValues() {
		java.util.List<nextgen.model.DomainRelation> values = new java.util.ArrayList<>();
		for (int selectedRow : getSelectedRows()) values.add(tableModel().content.get(selectedRow).model);
		return values;
	}

	public DomainRelationTable refresh() {
		tableModel().fireTableDataChanged();
		return this;
	}

	public DomainRelationTable clear() {
	...
	public static final class RowElement {
		...
		protected RowElement(nextgen.model.DomainRelation model) {
			this.model = model;
			_name = model.getName();
		}
	...
	static final class ResultsTableModel extends javax.swing.table.AbstractTableModel {
		...
		ResultsTableModel(java.util.Collection<nextgen.model.DomainRelation> data) {
			for (nextgen.model.DomainRelation row : data) content.add(new RowElement(row));
		}
		...
		private nextgen.model.DomainRelation getValueAt(int row) {
