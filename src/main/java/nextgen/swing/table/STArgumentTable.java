...
public class STArgumentTable extends javax.swing.JTable {

/*
*/
	private Consumer<nextgen.model.STArgument> selectionListener;

	public STArgumentTable() {
		super(new ResultsTableModel());
	}

	public STArgumentTable setSelectionListener(Consumer<nextgen.model.STArgument> selectionListener) {
		this.selectionListener = selectionListener;
		return this;
	}

	public STArgumentTable setContent(java.util.stream.Stream<nextgen.model.STArgument> content) {
		return setContent(content.collect(java.util.stream.Collectors.toList()));
	}

	public STArgumentTable setContent(java.util.Collection<nextgen.model.STArgument> content) {
	...
	public java.util.List<nextgen.model.STArgument> getSelectedValues() {
		java.util.List<nextgen.model.STArgument> values = new java.util.ArrayList<>();
		for (int selectedRow : getSelectedRows()) values.add(tableModel().content.get(selectedRow).model);
		return values;
	}

	public STArgumentTable refresh() {
		tableModel().fireTableDataChanged();
		return this;
	}

	public STArgumentTable clear() {
	...
	public static final class RowElement {
		...
		protected RowElement(nextgen.model.STArgument model) {
			this.model = model;
		}
	...
	static final class ResultsTableModel extends javax.swing.table.AbstractTableModel {
		...
		ResultsTableModel(java.util.Collection<nextgen.model.STArgument> data) {
			for (nextgen.model.STArgument row : data) content.add(new RowElement(row));
		}
		...
		private nextgen.model.STArgument getValueAt(int row) {
