...
public class STInterfaceTable extends javax.swing.JTable {

/*
	0 name	String	
*/
	private Consumer<nextgen.model.STInterface> selectionListener;

	public STInterfaceTable() {
		super(new ResultsTableModel());
	}

	public STInterfaceTable setSelectionListener(Consumer<nextgen.model.STInterface> selectionListener) {
		this.selectionListener = selectionListener;
		return this;
	}

	public STInterfaceTable setContent(java.util.stream.Stream<nextgen.model.STInterface> content) {
		return setContent(content.collect(java.util.stream.Collectors.toList()));
	}

	public STInterfaceTable setContent(java.util.Collection<nextgen.model.STInterface> content) {
	...
	public java.util.List<nextgen.model.STInterface> getSelectedValues() {
		java.util.List<nextgen.model.STInterface> values = new java.util.ArrayList<>();
		for (int selectedRow : getSelectedRows()) values.add(tableModel().content.get(selectedRow).model);
		return values;
	}

	public STInterfaceTable refresh() {
		tableModel().fireTableDataChanged();
		return this;
	}

	public STInterfaceTable clear() {
	...
	public static final class RowElement {
		...
		protected RowElement(nextgen.model.STInterface model) {
			this.model = model;
			_name = model.getName();
		}
	...
	static final class ResultsTableModel extends javax.swing.table.AbstractTableModel {
		...
		ResultsTableModel(java.util.Collection<nextgen.model.STInterface> data) {
			for (nextgen.model.STInterface row : data) content.add(new RowElement(row));
		}
		...
		private nextgen.model.STInterface getValueAt(int row) {
