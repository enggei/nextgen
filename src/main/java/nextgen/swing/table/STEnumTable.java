...
public class STEnumTable extends javax.swing.JTable {

/*
	0 name	String	
*/
	private Consumer<nextgen.model.STEnum> selectionListener;

	public STEnumTable() {
		super(new ResultsTableModel());
	}

	public STEnumTable setSelectionListener(Consumer<nextgen.model.STEnum> selectionListener) {
		this.selectionListener = selectionListener;
		return this;
	}

	public STEnumTable setContent(java.util.stream.Stream<nextgen.model.STEnum> content) {
		return setContent(content.collect(java.util.stream.Collectors.toList()));
	}

	public STEnumTable setContent(java.util.Collection<nextgen.model.STEnum> content) {
	...
	public java.util.List<nextgen.model.STEnum> getSelectedValues() {
		java.util.List<nextgen.model.STEnum> values = new java.util.ArrayList<>();
		for (int selectedRow : getSelectedRows()) values.add(tableModel().content.get(selectedRow).model);
		return values;
	}

	public STEnumTable refresh() {
		tableModel().fireTableDataChanged();
		return this;
	}

	public STEnumTable clear() {
	...
	public static final class RowElement {
		...
		protected RowElement(nextgen.model.STEnum model) {
			this.model = model;
			_name = model.getName();
		}
	...
	static final class ResultsTableModel extends javax.swing.table.AbstractTableModel {
		...
		ResultsTableModel(java.util.Collection<nextgen.model.STEnum> data) {
			for (nextgen.model.STEnum row : data) content.add(new RowElement(row));
		}
		...
		private nextgen.model.STEnum getValueAt(int row) {
