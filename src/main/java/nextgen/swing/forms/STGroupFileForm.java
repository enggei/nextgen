...
public class STGroupFileForm extends JPanel {

	nextgen.model.STGroupFile model;

	public STGroupFileForm() {
		setLayout(new FormLayout("center:max(50dlu;pref):none, fill:pref:grow", ""));
	}


	public void modelToView(nextgen.model.STGroupFile model) {
		this.model = model;
	}
	...
	public nextgen.model.STGroupFile viewToModel() {
		return model;
	}
