...
public class STArgumentKVForm extends JPanel {

	nextgen.model.STArgumentKV model;
	...
	public void modelToView(nextgen.model.STArgumentKV model) {
		this.model = model;
	}
	...
	public nextgen.model.STArgumentKV viewToModel() {
		return model;
	}
