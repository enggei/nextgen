...
public class Relation {
	...
	static final String st = "Relation(lexical,self,eqha,name,type,dst) ::= <<~name~ ~type~ ~dst~~if(lexical)~ lexical~endif~~if(self)~ self-referential~endif~~if(eqha)~ ~eqha~~endif~ >>";
}  