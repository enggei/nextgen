...
public class JavaPatterns extends JavaST {
   ...
   public static nextgen.templates.java.MethodDeclaration newMainMethod() {
      return nextgen.templates.java.JavaPatterns.newMethodDeclaration()
            .addModifiers("public")
            .addModifiers("static")
            .setName("main")
            .addParameters(nextgen.templates.java.JavaPatterns.newParameter()
                  .setType(nextgen.templates.java.JavaPatterns.newClassOrInterfaceType()
                        .addNames("String")
                        .setIsArrayType(true))
                  .setName("args"));
   }
   ...
   public static nextgen.templates.java.CompilationUnit newCompilationUnit(String packageName, nextgen.templates.java.ClassOrInterfaceDeclaration classOrInterfaceDeclaration) {
      return newCompilationUnit()
            .setPackageDeclaration(nextgen.templates.java.JavaPatterns.newPackageDeclaration(packageName))
            .addTypes(classOrInterfaceDeclaration);
   }
}