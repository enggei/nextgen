...
public class VisitRelationMethod {
	...
	public java.util.List<Object> getProperties_Name() {
		return streamProperties().map(VisitRelationMethod_Properties::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getProperties_DefaultValue() {
		return streamProperties().map(VisitRelationMethod_Properties::getDefaultValue).collect(java.util.stream.Collectors.toList());
	}
	...
	public java.util.List<Object> getDst_Name() {
		return streamDst().map(VisitRelationMethod_Dst::getName).collect(java.util.stream.Collectors.toList());
	}
