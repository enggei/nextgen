...
public class AlertTitleElement {
	...
	public AlertTitleElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public AlertTitleElement removeKey() {
		this._key = null;
		return this;
	} 
	...
	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(AlertTitleElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(AlertTitleElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}
	...
	static final String st = "AlertTitleElement(classes,className,id,key,style,attribute,children) ::= <<<AlertTitle~if(classes)~\n" + 
