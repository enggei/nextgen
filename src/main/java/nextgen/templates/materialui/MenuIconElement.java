...
public class MenuIconElement {
	...
	public MenuIconElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public MenuIconElement removeKey() {
		this._key = null;
		return this;
	} 
	...
	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(MenuIconElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(MenuIconElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}
	...
	static final String st = "MenuIconElement(className,id,key,style,attribute) ::= <<<MenuIcon~if(className)~\n" + 
