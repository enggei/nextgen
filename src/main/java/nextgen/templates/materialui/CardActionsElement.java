...
public class CardActionsElement {
	...
	public CardActionsElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public CardActionsElement removeKey() {
		this._key = null;
		return this;
	} 

	public CardActionsElement setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public CardActionsElement removeStyle() {
		this._style = null;
		return this;
	} 
	...
	public CardActionsElement addAttribute(Object _name, Object _value) {
	...
	public CardActionsElement addAttribute(CardActionsElement_Attribute value) {
		return addAttribute(value._name, value._value);
	}

	public java.util.stream.Stream<CardActionsElement_Attribute> streamAttribute() {
		return this._attribute.stream().map(CardActionsElement_Attribute::new);
	}

	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(CardActionsElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(CardActionsElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}


	public static final class CardActionsElement_Attribute {

		Object _name;
		Object _value;

		public CardActionsElement_Attribute(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private CardActionsElement_Attribute(java.util.Map<String, Object> map) {
	...
	static final String st = "CardActionsElement(classes,className,disableSpacing,id,key,style,attribute,children) ::= <<<CardActions~if(classes)~\n" + 
