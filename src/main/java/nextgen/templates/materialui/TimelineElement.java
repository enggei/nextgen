...
public class TimelineElement {
	...
	public TimelineElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public TimelineElement removeKey() {
		this._key = null;
		return this;
	} 
	...
	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(TimelineElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(TimelineElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}
	...
	static final String st = "TimelineElement(align,classes,className,id,key,style,attribute,children) ::= <<<Timeline~if(align)~\n" + 
