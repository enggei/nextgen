...
public class TreeNode {
	...
	static final String st = "TreeNode(name,imports,packageName,methods,selectedStatements,actions,constructorStatements,uuidExpression,type,baseTreeNode) ::= <<package ~packageName~;\n" + 
				"\n" + 
				"import javax.swing.*;\n" + 
