...
public class MobXST {
	...
	.append("eom() ::= \"}\"\n")
	.append("gt() ::= \">\"\n")
	.append(BackendStore.st + "\n")
	.append(BackendAction.st + "\n")
	.append(Inject.st + "\n")
	...
	private static org.stringtemplate.v4.STGroup stGroup = decorate(new org.stringtemplate.v4.STGroupString("MobXST", stg, '~', '~'));

	public static void setSTGroup(final String stgFile) {
		stGroup = decorate(new org.stringtemplate.v4.STGroupFile(stgFile, '~', '~'));
	}

	public static BackendStore newBackendStore() {
		return new BackendStore(stGroup);
	}  

	public static BackendAction newBackendAction() {
		return new BackendAction(stGroup);
	}  
