...
public class Main {
	...
	Main(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("main");
	...
	public Main setDatabind(Object value) {
	...
	public Main removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Main setAccesskey(Object value) {
	...
	public Main removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Main set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Main remove_class() {
		this.__class = null;
		return this;
	} 

	public Main setContenteditable(Object value) {
	...
	public Main removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Main setContextmenu(Object value) {
	...
	public Main removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Main setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Main removeDir() {
		this._dir = null;
		return this;
	} 

	public Main setDraggable(Object value) {
	...
	public Main removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Main setDropzone(Object value) {
	...
	public Main removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Main setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Main removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Main setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Main removeId() {
		this._id = null;
		return this;
	} 

	public Main setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Main removeLang() {
		this._lang = null;
		return this;
	} 

	public Main setSpellcheck(Object value) {
	...
	public Main removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Main setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Main removeStyle() {
		this._style = null;
		return this;
	} 

	public Main setTabindex(Object value) {
	...
	public Main removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Main setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Main removeTitle() {
		this._title = null;
		return this;
	} 

	public Main setTranslate(Object value) {
	...
	public Main removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Main addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Main setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Main setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Main removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Main removeContent(int index) {
	...
	public Main addData(Object _name, Object _value) {
	...
	public Main addData(Main_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Main_Data> streamData() {
		return this._data.stream().map(Main_Data::new);
	}

	public static final class Main_Data {

		Object _name;
		Object _value;

		public Main_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Main_Data(java.util.Map<String, Object> map) {
