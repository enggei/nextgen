...
public class Map {
	...
	Map(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("map");
		st.add("name", _name);
	...
	public Map setName(Object value) {
		this._name = value;
		return this;
	}
	...
	public Map removeName() {
		this._name = null;
		return this;
	} 

	public Map setDatabind(Object value) {
	...
	public Map removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Map setAccesskey(Object value) {
	...
	public Map removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Map set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Map remove_class() {
		this.__class = null;
		return this;
	} 

	public Map setContenteditable(Object value) {
	...
	public Map removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Map setContextmenu(Object value) {
	...
	public Map removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Map setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Map removeDir() {
		this._dir = null;
		return this;
	} 

	public Map setDraggable(Object value) {
	...
	public Map removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Map setDropzone(Object value) {
	...
	public Map removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Map setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Map removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Map setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Map setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Map removeLang() {
		this._lang = null;
		return this;
	} 

	public Map setSpellcheck(Object value) {
	...
	public Map removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Map setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Map setTabindex(Object value) {
	...
	public Map removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Map setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Map removeTitle() {
		this._title = null;
		return this;
	} 

	public Map setTranslate(Object value) {
	...
	public Map removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Map addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Map setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Map setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Map removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Map removeContent(int index) {
	...
	public Map addData(Object _name, Object _value) {
	...
	public Map addData(Map_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Map_Data> streamData() {
		return this._data.stream().map(Map_Data::new);
	}
	...
	public static final class Map_Data {
		...
		public Map_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Map_Data(java.util.Map<String, Object> map) {
