...
public class H1 {
	...
	H1(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("h1");
	...
	public H1 setDatabind(Object value) {
	...
	public H1 removeDatabind() {
		this._databind = null;
		return this;
	} 

	public H1 setAccesskey(Object value) {
	...
	public H1 removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public H1 set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public H1 remove_class() {
		this.__class = null;
		return this;
	} 

	public H1 setContenteditable(Object value) {
	...
	public H1 removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public H1 setContextmenu(Object value) {
	...
	public H1 removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public H1 setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public H1 setDraggable(Object value) {
	...
	public H1 removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public H1 setDropzone(Object value) {
	...
	public H1 removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public H1 setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public H1 removeHidden() {
		this._hidden = null;
		return this;
	} 

	public H1 setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public H1 setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public H1 removeLang() {
		this._lang = null;
		return this;
	} 

	public H1 setSpellcheck(Object value) {
	...
	public H1 removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public H1 setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public H1 removeStyle() {
		this._style = null;
		return this;
	} 

	public H1 setTabindex(Object value) {
	...
	public H1 removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public H1 setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public H1 removeTitle() {
		this._title = null;
		return this;
	} 

	public H1 setTranslate(Object value) {
	...
	public H1 removeTranslate() {
		this._translate = null;
		return this;
	} 

	public H1 addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public H1 setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public H1 setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public H1 removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public H1 removeContent(int index) {
	...
	public H1 addData(Object _name, Object _value) {
	...
	public H1 addData(H1_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<H1_Data> streamData() {
		return this._data.stream().map(H1_Data::new);
	}

	public static final class H1_Data {

		Object _name;
		Object _value;

		public H1_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private H1_Data(java.util.Map<String, Object> map) {
