...
public class Dialog {
	...
	public Dialog setOpen(Object value) {
		this._open = value;
		return this;
	}
	...
	public Dialog removeOpen() {
		this._open = null;
		return this;
	} 

	public Dialog setDatabind(Object value) {
	...
	public Dialog removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Dialog setAccesskey(Object value) {
	...
	public Dialog removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Dialog set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Dialog remove_class() {
		this.__class = null;
		return this;
	} 

	public Dialog setContenteditable(Object value) {
	...
	public Dialog removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Dialog setContextmenu(Object value) {
	...
	public Dialog removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Dialog setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Dialog removeDir() {
		this._dir = null;
		return this;
	} 

	public Dialog setDraggable(Object value) {
	...
	public Dialog removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Dialog setDropzone(Object value) {
	...
	public Dialog removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Dialog setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Dialog removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Dialog setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Dialog removeId() {
		this._id = null;
		return this;
	} 

	public Dialog setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Dialog removeLang() {
		this._lang = null;
		return this;
	} 

	public Dialog setSpellcheck(Object value) {
	...
	public Dialog removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Dialog setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Dialog removeStyle() {
		this._style = null;
		return this;
	} 

	public Dialog setTabindex(Object value) {
	...
	public Dialog removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Dialog setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Dialog removeTitle() {
		this._title = null;
		return this;
	} 

	public Dialog setTranslate(Object value) {
	...
	public Dialog removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Dialog addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Dialog setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Dialog setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Dialog removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Dialog removeContent(int index) {
	...
	public Dialog addData(Object _name, Object _value) {
	...
	public Dialog addData(Dialog_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Dialog_Data> streamData() {
		return this._data.stream().map(Dialog_Data::new);
	}

	public static final class Dialog_Data {

		Object _name;
		Object _value;

		public Dialog_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Dialog_Data(java.util.Map<String, Object> map) {
