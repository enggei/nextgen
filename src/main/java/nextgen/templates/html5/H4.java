...
public class H4 {
	...
	H4(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("h4");
	...
	public H4 setDatabind(Object value) {
	...
	public H4 removeDatabind() {
		this._databind = null;
		return this;
	} 

	public H4 setAccesskey(Object value) {
	...
	public H4 removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public H4 set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public H4 remove_class() {
		this.__class = null;
		return this;
	} 

	public H4 setContenteditable(Object value) {
	...
	public H4 removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public H4 setContextmenu(Object value) {
	...
	public H4 removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public H4 setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public H4 setDraggable(Object value) {
	...
	public H4 removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public H4 setDropzone(Object value) {
	...
	public H4 removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public H4 setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public H4 removeHidden() {
		this._hidden = null;
		return this;
	} 

	public H4 setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public H4 setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public H4 removeLang() {
		this._lang = null;
		return this;
	} 

	public H4 setSpellcheck(Object value) {
	...
	public H4 removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public H4 setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public H4 removeStyle() {
		this._style = null;
		return this;
	} 

	public H4 setTabindex(Object value) {
	...
	public H4 removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public H4 setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public H4 removeTitle() {
		this._title = null;
		return this;
	} 

	public H4 setTranslate(Object value) {
	...
	public H4 removeTranslate() {
		this._translate = null;
		return this;
	} 

	public H4 addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public H4 setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public H4 setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public H4 removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public H4 removeContent(int index) {
	...
	public H4 addData(Object _name, Object _value) {
	...
	public H4 addData(H4_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<H4_Data> streamData() {
		return this._data.stream().map(H4_Data::new);
	}

	public static final class H4_Data {

		Object _name;
		Object _value;

		public H4_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private H4_Data(java.util.Map<String, Object> map) {
