...
public class Sub {
	...
	Sub(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("sub");
	...
	public Sub setDatabind(Object value) {
	...
	public Sub removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Sub setAccesskey(Object value) {
	...
	public Sub removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Sub set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Sub remove_class() {
		this.__class = null;
		return this;
	} 

	public Sub setContenteditable(Object value) {
	...
	public Sub removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Sub setContextmenu(Object value) {
	...
	public Sub setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Sub setDraggable(Object value) {
	...
	public Sub removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Sub setDropzone(Object value) {
	...
	public Sub removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Sub setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Sub setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Sub removeLang() {
		this._lang = null;
		return this;
	} 

	public Sub setSpellcheck(Object value) {
	...
	public Sub removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Sub setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Sub setTabindex(Object value) {
	...
	public Sub removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Sub setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Sub setTranslate(Object value) {
	...
	public Sub removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Sub addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Sub setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Sub setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Sub removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Sub removeContent(int index) {
	...
	public Sub addData(Object _name, Object _value) {
	...
	public Sub addData(Sub_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Sub_Data> streamData() {
		return this._data.stream().map(Sub_Data::new);
	}

	public static final class Sub_Data {

		Object _name;
		Object _value;

		public Sub_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Sub_Data(java.util.Map<String, Object> map) {
