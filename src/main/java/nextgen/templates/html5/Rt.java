...
public class Rt {
	...
	Rt(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("rt");
	...
	public Rt setDatabind(Object value) {
	...
	public Rt removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Rt setAccesskey(Object value) {
	...
	public Rt removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Rt set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Rt remove_class() {
		this.__class = null;
		return this;
	} 

	public Rt setContenteditable(Object value) {
	...
	public Rt removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Rt setContextmenu(Object value) {
	...
	public Rt removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Rt setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Rt setDraggable(Object value) {
	...
	public Rt removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Rt setDropzone(Object value) {
	...
	public Rt removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Rt setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Rt removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Rt setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Rt setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Rt removeLang() {
		this._lang = null;
		return this;
	} 

	public Rt setSpellcheck(Object value) {
	...
	public Rt removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Rt setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Rt removeStyle() {
		this._style = null;
		return this;
	} 

	public Rt setTabindex(Object value) {
	...
	public Rt removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Rt setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Rt removeTitle() {
		this._title = null;
		return this;
	} 

	public Rt setTranslate(Object value) {
	...
	public Rt removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Rt addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Rt setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Rt setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Rt removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Rt removeContent(int index) {
	...
	public Rt addData(Object _name, Object _value) {
	...
	public Rt addData(Rt_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Rt_Data> streamData() {
		return this._data.stream().map(Rt_Data::new);
	}

	public static final class Rt_Data {

		Object _name;
		Object _value;

		public Rt_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Rt_Data(java.util.Map<String, Object> map) {
