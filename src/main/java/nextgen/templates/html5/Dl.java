...
public class Dl {
	...
	Dl(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("dl");
	...
	public Dl setDatabind(Object value) {
	...
	public Dl removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Dl setAccesskey(Object value) {
	...
	public Dl removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Dl set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Dl remove_class() {
		this.__class = null;
		return this;
	} 

	public Dl setContenteditable(Object value) {
	...
	public Dl removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Dl setContextmenu(Object value) {
	...
	public Dl removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Dl setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Dl setDraggable(Object value) {
	...
	public Dl removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Dl setDropzone(Object value) {
	...
	public Dl removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Dl setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Dl removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Dl setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Dl setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Dl removeLang() {
		this._lang = null;
		return this;
	} 

	public Dl setSpellcheck(Object value) {
	...
	public Dl removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Dl setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Dl removeStyle() {
		this._style = null;
		return this;
	} 

	public Dl setTabindex(Object value) {
	...
	public Dl removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Dl setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Dl removeTitle() {
		this._title = null;
		return this;
	} 

	public Dl setTranslate(Object value) {
	...
	public Dl removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Dl addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Dl setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Dl setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Dl removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Dl removeContent(int index) {
	...
	public Dl addData(Object _name, Object _value) {
	...
	public Dl addData(Dl_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Dl_Data> streamData() {
		return this._data.stream().map(Dl_Data::new);
	}

	public static final class Dl_Data {

		Object _name;
		Object _value;

		public Dl_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Dl_Data(java.util.Map<String, Object> map) {
