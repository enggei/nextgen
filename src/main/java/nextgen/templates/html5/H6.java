...
public class H6 {
	...
	H6(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("h6");
	...
	public H6 setDatabind(Object value) {
	...
	public H6 removeDatabind() {
		this._databind = null;
		return this;
	} 

	public H6 setAccesskey(Object value) {
	...
	public H6 removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public H6 set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public H6 remove_class() {
		this.__class = null;
		return this;
	} 

	public H6 setContenteditable(Object value) {
	...
	public H6 removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public H6 setContextmenu(Object value) {
	...
	public H6 removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public H6 setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public H6 setDraggable(Object value) {
	...
	public H6 removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public H6 setDropzone(Object value) {
	...
	public H6 removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public H6 setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public H6 removeHidden() {
		this._hidden = null;
		return this;
	} 

	public H6 setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public H6 setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public H6 removeLang() {
		this._lang = null;
		return this;
	} 

	public H6 setSpellcheck(Object value) {
	...
	public H6 removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public H6 setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public H6 removeStyle() {
		this._style = null;
		return this;
	} 

	public H6 setTabindex(Object value) {
	...
	public H6 removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public H6 setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public H6 removeTitle() {
		this._title = null;
		return this;
	} 

	public H6 setTranslate(Object value) {
	...
	public H6 removeTranslate() {
		this._translate = null;
		return this;
	} 

	public H6 addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public H6 setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public H6 setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public H6 removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public H6 removeContent(int index) {
	...
	public H6 addData(Object _name, Object _value) {
	...
	public H6 addData(H6_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<H6_Data> streamData() {
		return this._data.stream().map(H6_Data::new);
	}

	public static final class H6_Data {

		Object _name;
		Object _value;

		public H6_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private H6_Data(java.util.Map<String, Object> map) {
