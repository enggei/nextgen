...
public class Keygen {
	...
	Keygen(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("keygen");
		st.add("autofocus", _autofocus);
		st.add("challenge", _challenge);
		st.add("disabled", _disabled);
		st.add("form", _form);
		st.add("keytype", _keytype);
		st.add("name", _name);
	...
	public Keygen setAutofocus(Object value) {
	...
	public Keygen removeAutofocus() {
		this._autofocus = null;
		return this;
	} 

	public Keygen setChallenge(Object value) {
	...
	public Object getChallenge(Object defaultValue) {
		return this._challenge == null ? defaultValue : this._challenge;
	}
	...
	public Keygen removeChallenge() {
		this._challenge = null;
		return this;
	} 

	public Keygen setDisabled(Object value) {
	...
	public Keygen removeDisabled() {
		this._disabled = null;
		return this;
	} 

	public Keygen setForm(Object value) {
		this._form = value;
		return this;
	}
	...
	public Keygen removeForm() {
		this._form = null;
		return this;
	} 

	public Keygen setKeytype(Object value) {
		this._keytype = value;
		return this;
	}
	...
	public Object getKeytype(Object defaultValue) {
		return this._keytype == null ? defaultValue : this._keytype;
	}
	...
	public Keygen removeKeytype() {
		this._keytype = null;
		return this;
	} 

	public Keygen setName(Object value) {
		this._name = value;
		return this;
	}
	...
	public Keygen removeName() {
		this._name = null;
		return this;
	} 

	public Keygen setDatabind(Object value) {
	...
	public Keygen removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Keygen setAccesskey(Object value) {
	...
	public Keygen removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Keygen set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Keygen remove_class() {
		this.__class = null;
		return this;
	} 

	public Keygen setContenteditable(Object value) {
	...
	public Keygen removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Keygen setContextmenu(Object value) {
	...
	public Keygen removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Keygen setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Keygen removeDir() {
		this._dir = null;
		return this;
	} 

	public Keygen setDraggable(Object value) {
	...
	public Keygen removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Keygen setDropzone(Object value) {
	...
	public Keygen removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Keygen setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Keygen removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Keygen setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Keygen removeId() {
		this._id = null;
		return this;
	} 

	public Keygen setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Keygen removeLang() {
		this._lang = null;
		return this;
	} 

	public Keygen setSpellcheck(Object value) {
	...
	public Keygen removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Keygen setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Keygen removeStyle() {
		this._style = null;
		return this;
	} 

	public Keygen setTabindex(Object value) {
	...
	public Keygen removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Keygen setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Keygen removeTitle() {
		this._title = null;
		return this;
	} 

	public Keygen setTranslate(Object value) {
	...
	public Keygen removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Keygen addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Keygen setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Keygen setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Keygen removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Keygen removeContent(int index) {
	...
	public Keygen addData(Object _name, Object _value) {
	...
	public Keygen addData(Keygen_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Keygen_Data> streamData() {
		return this._data.stream().map(Keygen_Data::new);
	}

	public static final class Keygen_Data {

		Object _name;
		Object _value;

		public Keygen_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Keygen_Data(java.util.Map<String, Object> map) {
