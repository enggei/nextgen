...
public class Footer {
	...
	Footer(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("footer");
	...
	public Footer setDatabind(Object value) {
	...
	public Footer removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Footer setAccesskey(Object value) {
	...
	public Footer removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Footer set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Footer remove_class() {
		this.__class = null;
		return this;
	} 

	public Footer setContenteditable(Object value) {
	...
	public Footer removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Footer setContextmenu(Object value) {
	...
	public Footer removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Footer setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Footer removeDir() {
		this._dir = null;
		return this;
	} 

	public Footer setDraggable(Object value) {
	...
	public Footer removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Footer setDropzone(Object value) {
	...
	public Footer removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Footer setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Footer removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Footer setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Footer removeId() {
		this._id = null;
		return this;
	} 

	public Footer setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Footer removeLang() {
		this._lang = null;
		return this;
	} 

	public Footer setSpellcheck(Object value) {
	...
	public Footer removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Footer setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Footer removeStyle() {
		this._style = null;
		return this;
	} 

	public Footer setTabindex(Object value) {
	...
	public Footer removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Footer setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Footer removeTitle() {
		this._title = null;
		return this;
	} 

	public Footer setTranslate(Object value) {
	...
	public Footer removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Footer addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Footer setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Footer setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Footer removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Footer removeContent(int index) {
	...
	public Footer addData(Object _name, Object _value) {
	...
	public Footer addData(Footer_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Footer_Data> streamData() {
		return this._data.stream().map(Footer_Data::new);
	}

	public static final class Footer_Data {

		Object _name;
		Object _value;

		public Footer_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Footer_Data(java.util.Map<String, Object> map) {
