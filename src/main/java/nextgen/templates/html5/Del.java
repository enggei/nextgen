...
public class Del {
	...
	Del(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("del");
		st.add("cite", _cite);
		st.add("datetime", _datetime);
	...
	public Del setCite(Object value) {
		this._cite = value;
		return this;
	}
	...
	public Del removeCite() {
		this._cite = null;
		return this;
	} 

	public Del setDatetime(Object value) {
	...
	public Object getDatetime(Object defaultValue) {
		return this._datetime == null ? defaultValue : this._datetime;
	}
	...
	public Del removeDatetime() {
		this._datetime = null;
		return this;
	} 

	public Del setDatabind(Object value) {
	...
	public Del removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Del setAccesskey(Object value) {
	...
	public Del removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Del set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Del remove_class() {
		this.__class = null;
		return this;
	} 

	public Del setContenteditable(Object value) {
	...
	public Del removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Del setContextmenu(Object value) {
	...
	public Del removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Del setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Del removeDir() {
		this._dir = null;
		return this;
	} 

	public Del setDraggable(Object value) {
	...
	public Del removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Del setDropzone(Object value) {
	...
	public Del removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Del setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Del removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Del setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Del setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Del removeLang() {
		this._lang = null;
		return this;
	} 

	public Del setSpellcheck(Object value) {
	...
	public Del removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Del setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Del removeStyle() {
		this._style = null;
		return this;
	} 

	public Del setTabindex(Object value) {
	...
	public Del removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Del setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Del removeTitle() {
		this._title = null;
		return this;
	} 

	public Del setTranslate(Object value) {
	...
	public Del removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Del addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Del setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Del setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Del removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Del removeContent(int index) {
	...
	public Del addData(Object _name, Object _value) {
	...
	public Del addData(Del_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Del_Data> streamData() {
		return this._data.stream().map(Del_Data::new);
	}

	public static final class Del_Data {

		Object _name;
		Object _value;

		public Del_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Del_Data(java.util.Map<String, Object> map) {
