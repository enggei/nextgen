...
public class Dt {
	...
	Dt(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("dt");
	...
	public Dt setDatabind(Object value) {
	...
	public Dt removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Dt setAccesskey(Object value) {
	...
	public Dt removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Dt set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Dt remove_class() {
		this.__class = null;
		return this;
	} 

	public Dt setContenteditable(Object value) {
	...
	public Dt removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Dt setContextmenu(Object value) {
	...
	public Dt removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Dt setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Dt setDraggable(Object value) {
	...
	public Dt removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Dt setDropzone(Object value) {
	...
	public Dt removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Dt setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Dt removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Dt setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Dt setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Dt removeLang() {
		this._lang = null;
		return this;
	} 

	public Dt setSpellcheck(Object value) {
	...
	public Dt removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Dt setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Dt removeStyle() {
		this._style = null;
		return this;
	} 

	public Dt setTabindex(Object value) {
	...
	public Dt removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Dt setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Dt removeTitle() {
		this._title = null;
		return this;
	} 

	public Dt setTranslate(Object value) {
	...
	public Dt removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Dt addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Dt setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Dt setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Dt removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Dt removeContent(int index) {
	...
	public Dt addData(Object _name, Object _value) {
	...
	public Dt addData(Dt_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Dt_Data> streamData() {
		return this._data.stream().map(Dt_Data::new);
	}

	public static final class Dt_Data {

		Object _name;
		Object _value;

		public Dt_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Dt_Data(java.util.Map<String, Object> map) {
