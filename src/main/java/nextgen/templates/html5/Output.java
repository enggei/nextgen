...
public class Output {
	...
	Output(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("output");
		st.add("for", _for);
		st.add("form", _form);
		st.add("name", _name);
	...
	public Output setFor(Object value) {
		this._for = value;
		return this;
	}
	...
	public Object getFor(Object defaultValue) {
		return this._for == null ? defaultValue : this._for;
	}
	...
	public Output removeFor() {
		this._for = null;
		return this;
	} 

	public Output setForm(Object value) {
		this._form = value;
		return this;
	}
	...
	public Output removeForm() {
		this._form = null;
		return this;
	} 

	public Output setName(Object value) {
		this._name = value;
		return this;
	}
	...
	public Output removeName() {
		this._name = null;
		return this;
	} 

	public Output setDatabind(Object value) {
	...
	public Output removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Output setAccesskey(Object value) {
	...
	public Output removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Output set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Output remove_class() {
		this.__class = null;
		return this;
	} 

	public Output setContenteditable(Object value) {
	...
	public Output removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Output setContextmenu(Object value) {
	...
	public Output removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Output setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Output removeDir() {
		this._dir = null;
		return this;
	} 

	public Output setDraggable(Object value) {
	...
	public Output removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Output setDropzone(Object value) {
	...
	public Output removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Output setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Output removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Output setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Output removeId() {
		this._id = null;
		return this;
	} 

	public Output setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Output removeLang() {
		this._lang = null;
		return this;
	} 

	public Output setSpellcheck(Object value) {
	...
	public Output removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Output setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Output removeStyle() {
		this._style = null;
		return this;
	} 

	public Output setTabindex(Object value) {
	...
	public Output removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Output setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Output removeTitle() {
		this._title = null;
		return this;
	} 

	public Output setTranslate(Object value) {
	...
	public Output removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Output addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Output setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Output setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Output removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Output removeContent(int index) {
	...
	public Output addData(Object _name, Object _value) {
	...
	public Output addData(Output_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Output_Data> streamData() {
		return this._data.stream().map(Output_Data::new);
	}

	public static final class Output_Data {

		Object _name;
		Object _value;

		public Output_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Output_Data(java.util.Map<String, Object> map) {
