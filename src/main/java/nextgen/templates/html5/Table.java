...
public class Table {
	...
	public Table setSortable(Object value) {
	...
	public Object getSortable(Object defaultValue) {
		return this._sortable == null ? defaultValue : this._sortable;
	}

	public boolean hasSortable() {
		return this._sortable != null;
	}

	public Table removeSortable() {
		this._sortable = null;
		return this;
	} 

	public Table setDatabind(Object value) {
	...
	public Table removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Table setAccesskey(Object value) {
	...
	public Table removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Table set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Table remove_class() {
		this.__class = null;
		return this;
	} 

	public Table setContenteditable(Object value) {
	...
	public Table removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Table setContextmenu(Object value) {
	...
	public Table removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Table setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Table removeDir() {
		this._dir = null;
		return this;
	} 

	public Table setDraggable(Object value) {
	...
	public Table removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Table setDropzone(Object value) {
	...
	public Table removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Table setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Table removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Table setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Table removeId() {
		this._id = null;
		return this;
	} 

	public Table setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Table removeLang() {
		this._lang = null;
		return this;
	} 

	public Table setSpellcheck(Object value) {
	...
	public Table removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Table setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Table removeStyle() {
		this._style = null;
		return this;
	} 

	public Table setTabindex(Object value) {
	...
	public Table removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Table setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Table removeTitle() {
		this._title = null;
		return this;
	} 

	public Table setTranslate(Object value) {
	...
	public Table removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Table addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Table setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Table setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Table removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Table removeContent(int index) {
	...
	public Table addData(Object _name, Object _value) {
	...
	public Table addData(Table_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Table_Data> streamData() {
		return this._data.stream().map(Table_Data::new);
	}

	public static final class Table_Data {

		Object _name;
		Object _value;

		public Table_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Table_Data(java.util.Map<String, Object> map) {
