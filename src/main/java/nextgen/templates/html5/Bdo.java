...
public class Bdo {
	...
	Bdo(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("bdo");
		st.add("dir", _dir);
	...
	public Bdo setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Bdo removeDir() {
		this._dir = null;
		return this;
	} 

	public Bdo setDatabind(Object value) {
	...
	public Bdo removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Bdo setAccesskey(Object value) {
	...
	public Bdo removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Bdo set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Bdo remove_class() {
		this.__class = null;
		return this;
	} 

	public Bdo setContenteditable(Object value) {
	...
	public Bdo removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Bdo setContextmenu(Object value) {
	...
	public Bdo removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Bdo setDraggable(Object value) {
	...
	public Bdo removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Bdo setDropzone(Object value) {
	...
	public Bdo removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Bdo setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Bdo removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Bdo setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Bdo setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Bdo removeLang() {
		this._lang = null;
		return this;
	} 

	public Bdo setSpellcheck(Object value) {
	...
	public Bdo removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Bdo setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Bdo removeStyle() {
		this._style = null;
		return this;
	} 

	public Bdo setTabindex(Object value) {
	...
	public Bdo removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Bdo setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Bdo removeTitle() {
		this._title = null;
		return this;
	} 

	public Bdo setTranslate(Object value) {
	...
	public Bdo removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Bdo addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Bdo setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Bdo setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Bdo removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Bdo removeContent(int index) {
	...
	public Bdo addData(Object _name, Object _value) {
	...
	public Bdo addData(Bdo_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Bdo_Data> streamData() {
		return this._data.stream().map(Bdo_Data::new);
	}

	public static final class Bdo_Data {

		Object _name;
		Object _value;

		public Bdo_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Bdo_Data(java.util.Map<String, Object> map) {
