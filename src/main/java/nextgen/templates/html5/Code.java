...
public class Code {
	...
	Code(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("code");
	...
	public Code setDatabind(Object value) {
	...
	public Code removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Code setAccesskey(Object value) {
	...
	public Code removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Code set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Code remove_class() {
		this.__class = null;
		return this;
	} 

	public Code setContenteditable(Object value) {
	...
	public Code removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Code setContextmenu(Object value) {
	...
	public Code removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Code setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Code removeDir() {
		this._dir = null;
		return this;
	} 

	public Code setDraggable(Object value) {
	...
	public Code removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Code setDropzone(Object value) {
	...
	public Code removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Code setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Code removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Code setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Code removeId() {
		this._id = null;
		return this;
	} 

	public Code setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Code removeLang() {
		this._lang = null;
		return this;
	} 

	public Code setSpellcheck(Object value) {
	...
	public Code removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Code setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Code removeStyle() {
		this._style = null;
		return this;
	} 

	public Code setTabindex(Object value) {
	...
	public Code removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Code setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Code removeTitle() {
		this._title = null;
		return this;
	} 

	public Code setTranslate(Object value) {
	...
	public Code removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Code addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Code setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Code setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Code removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Code removeContent(int index) {
	...
	public Code addData(Object _name, Object _value) {
	...
	public Code addData(Code_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Code_Data> streamData() {
		return this._data.stream().map(Code_Data::new);
	}

	public static final class Code_Data {

		Object _name;
		Object _value;

		public Code_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Code_Data(java.util.Map<String, Object> map) {
