...
public class PrimitiveAccessors implements Accessor {
	...
	public PrimitiveAccessors setName(String value) {
		this._name = value;
		return this;
	}
	...
	static final String st = "primitiveAccessors(removeStatements,setStatements,type,className,name) ::= <<public static final String _~name~ = \"~name~\";\n" + 
				"\n" + 
