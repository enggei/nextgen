...
import static com.generator.app.plugins.ProjectPlugin.renderToFile;
...
public class DomainPlugin extends Plugin {
   ...
   DomainPlugin(App app, String name) {
      super(app, name);
   }
...
//                     final boolean isProperty = hasLabel(dstNode, Entities.Property) && hasLabel(selectedNode.getNode(), Entities.Value);
   ...
   void newEntityProperty(Node srcEntity, String name) {
   ...
   Node newEntityRelation(Node srcEntity, String name, RelationCardinality relationCardinality, Node... dstEntities) {
      return DomainMotif.newEntityRelation(getGraph(), srcEntity, name, relationCardinality, dstEntities);
   }

   Node newValueNode(String value) {
   ...
   protected abstract static class EntityRelationVisitor {

      abstract void onSingle(Node relationNode, Node dstNode);

      abstract void onList(Node relationNode, Node dstNode);
