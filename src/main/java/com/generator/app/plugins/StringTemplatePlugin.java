...
public class StringTemplatePlugin extends DomainPlugin {
   ...
   protected void addActionsTo(JMenu menu) {
      ...
      final JMenu groupMenu = new JMenu("STGroups");
      getGraph().findNodes(Entities.STGroup).forEachRemaining(node -> groupMenu.add(new App.TransactionAction("Show " + getNameAndLabelsFrom(node), app) {
         @Override
