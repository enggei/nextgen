...
public class MySQLPlugin extends DomainPlugin {
   ...
   protected void addActionsTo(JMenu menu) {
      ...
      menu.add(new App.TransactionAction("Import create table", app) {
         @Override
         protected void actionPerformed(ActionEvent e, Transaction tx) throws Exception {

            final JTextArea txtSql = new JTextArea(20, 30);

            SwingUtil.showTextInput("Create table statement", txtSql, app, () -> {
               ...
               getGraph().doInTransaction(new NeoModel.Committer() {
                  ...
                  private void visit(MySqlNodeListener.Node node) {
