...
public class ScalaNodeListener extends ScalaBaseListener {
   ...
   public Node getRoot() {
	...
	public void enterSimpleExpr(com.generator.generators.scala.parser.ScalaParser.SimpleExprContext arg) {
		onEnter(new Node("SimpleExpr", arg.getText(), arg.getStart().getText(), arg.getStop().getText()));
	...
	public void enterSimpleExpr2(com.generator.generators.scala.parser.ScalaParser.SimpleExpr2Context arg) {
		onEnter(new Node("SimpleExpr2", arg.getText(), arg.getStart().getText(), arg.getStop().getText()));
