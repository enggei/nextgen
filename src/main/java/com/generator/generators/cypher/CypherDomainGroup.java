 ...
 */
public final class CypherDomainGroup {
   // old cypher
   private final STGroup stGroup;
   private final char delimiter;

	public CypherDomainGroup() {
        ...
        if (generatorPath != null) {
        	...
        	this.stGroup = new org.stringtemplate.v4.STGroupFile(CypherDomainGroup.class.getResource("/com/generator/generators/cypher/cypher.stg"), "UTF-8", '~', '~');
        	this.stGroup.registerRenderer(String.class, new DefaultAttributeRenderer());
        	this.delimiter = stGroup.delimiterStartChar;
        }
   }

   public CypherDomainGroup(STGroup stGroup) {
      this.stGroup = stGroup;
      this.stGroup.registerRenderer(String.class, new DefaultAttributeRenderer());
      this.delimiter = stGroup.delimiterStartChar;
   }

   public CypherDomainGroup(java.io.File templateFile) {
   ...
   public char getDelimiter() {
	...
	public interface CypherDomainGroupTemplate {
   ...
   public final class eomST implements CypherDomainGroupTemplate {
   ...
   public final class gtST implements CypherDomainGroupTemplate {
   ...
   public final class createNodeST implements CypherDomainGroupTemplate {
   ...
   public final class createNodesST implements CypherDomainGroupTemplate {
   ...
   public final class createRelationshipST implements CypherDomainGroupTemplate {
   ...
   public final class createRelationshipsST implements CypherDomainGroupTemplate {
   ...
   public final class matchLabelST implements CypherDomainGroupTemplate {
   ...
   public final class queryST implements CypherDomainGroupTemplate {
   ...
   public final class stringPropertyST implements CypherDomainGroupTemplate {
   ...
   public final class valuePropertyST implements CypherDomainGroupTemplate {
