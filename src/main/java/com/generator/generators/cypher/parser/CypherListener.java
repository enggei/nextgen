...
public interface CypherListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CypherParser#cyper_match}.
	 * @param ctx the parse tree
	 */
	void enterCyper_match(CypherParser.Cyper_matchContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#cyper_match}.
	 * @param ctx the parse tree
	 */
	void exitCyper_match(CypherParser.Cyper_matchContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CypherParser#cypher_return}.
	 * @param ctx the parse tree
	 */
	void enterCypher_return(CypherParser.Cypher_returnContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#cypher_return}.
	 * @param ctx the parse tree
	 */
	void exitCypher_return(CypherParser.Cypher_returnContext ctx);
	/**
