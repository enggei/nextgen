...
public class LuaNodeVisitor extends LuaBaseVisitor<LuaNodeVisitor.Node> {
	...
	private final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(LuaNodeVisitor.class);
   ...
   public Node getRoot() {
	...
	public Node visitLabel(com.generator.generators.lua.parser.LuaParser.LabelContext arg) {
		final Node node = new Node("Label", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitFuncname(com.generator.generators.lua.parser.LuaParser.FuncnameContext arg) {
		final Node node = new Node("Funcname", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitVarlist(com.generator.generators.lua.parser.LuaParser.VarlistContext arg) {
		final Node node = new Node("Varlist", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitNamelist(com.generator.generators.lua.parser.LuaParser.NamelistContext arg) {
		final Node node = new Node("Namelist", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitExplist(com.generator.generators.lua.parser.LuaParser.ExplistContext arg) {
		final Node node = new Node("Explist", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitVarOrExp(com.generator.generators.lua.parser.LuaParser.VarOrExpContext arg) {
		final Node node = new Node("VarOrExp", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitVarSuffix(com.generator.generators.lua.parser.LuaParser.VarSuffixContext arg) {
		final Node node = new Node("VarSuffix", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitNameAndArgs(com.generator.generators.lua.parser.LuaParser.NameAndArgsContext arg) {
		final Node node = new Node("NameAndArgs", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitFunctiondef(com.generator.generators.lua.parser.LuaParser.FunctiondefContext arg) {
		final Node node = new Node("Functiondef", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitFuncbody(com.generator.generators.lua.parser.LuaParser.FuncbodyContext arg) {
		final Node node = new Node("Funcbody", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitParlist(com.generator.generators.lua.parser.LuaParser.ParlistContext arg) {
		final Node node = new Node("Parlist", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitTableconstructor(com.generator.generators.lua.parser.LuaParser.TableconstructorContext arg) {
		final Node node = new Node("Tableconstructor", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitFieldlist(com.generator.generators.lua.parser.LuaParser.FieldlistContext arg) {
		final Node node = new Node("Fieldlist", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitFieldsep(com.generator.generators.lua.parser.LuaParser.FieldsepContext arg) {
		final Node node = new Node("Fieldsep", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorOr(com.generator.generators.lua.parser.LuaParser.OperatorOrContext arg) {
		final Node node = new Node("OperatorOr", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorAnd(com.generator.generators.lua.parser.LuaParser.OperatorAndContext arg) {
		final Node node = new Node("OperatorAnd", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorComparison(com.generator.generators.lua.parser.LuaParser.OperatorComparisonContext arg) {
		final Node node = new Node("OperatorComparison", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorStrcat(com.generator.generators.lua.parser.LuaParser.OperatorStrcatContext arg) {
		final Node node = new Node("OperatorStrcat", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorAddSub(com.generator.generators.lua.parser.LuaParser.OperatorAddSubContext arg) {
		final Node node = new Node("OperatorAddSub", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorMulDivMod(com.generator.generators.lua.parser.LuaParser.OperatorMulDivModContext arg) {
		final Node node = new Node("OperatorMulDivMod", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorBitwise(com.generator.generators.lua.parser.LuaParser.OperatorBitwiseContext arg) {
		final Node node = new Node("OperatorBitwise", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorUnary(com.generator.generators.lua.parser.LuaParser.OperatorUnaryContext arg) {
		final Node node = new Node("OperatorUnary", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitOperatorPower(com.generator.generators.lua.parser.LuaParser.OperatorPowerContext arg) {
		final Node node = new Node("OperatorPower", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitExp(com.generator.generators.lua.parser.LuaParser.ExpContext arg) {
		final Node node = new Node("Exp", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
