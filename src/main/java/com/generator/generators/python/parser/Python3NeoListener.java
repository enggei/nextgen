...
public class Python3NeoListener extends Python3BaseListener {
   ...
   public Node getRoot() {
	...
	public void enterFor_stmt(com.generator.generators.python.parser.Python3Parser.For_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("For_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTry_stmt(com.generator.generators.python.parser.Python3Parser.Try_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("Try_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterWith_stmt(com.generator.generators.python.parser.Python3Parser.With_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("With_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterWith_item(com.generator.generators.python.parser.Python3Parser.With_itemContext arg) {
		final Node node = model.findOrCreate(Label.label("With_item"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterExcept_clause(com.generator.generators.python.parser.Python3Parser.Except_clauseContext arg) {
		final Node node = model.findOrCreate(Label.label("Except_clause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSuite(com.generator.generators.python.parser.Python3Parser.SuiteContext arg) {
		final Node node = model.findOrCreate(Label.label("Suite"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTest(com.generator.generators.python.parser.Python3Parser.TestContext arg) {
		final Node node = model.findOrCreate(Label.label("Test"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTest_nocond(com.generator.generators.python.parser.Python3Parser.Test_nocondContext arg) {
		final Node node = model.findOrCreate(Label.label("Test_nocond"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterLambdef(com.generator.generators.python.parser.Python3Parser.LambdefContext arg) {
		final Node node = model.findOrCreate(Label.label("Lambdef"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterLambdef_nocond(com.generator.generators.python.parser.Python3Parser.Lambdef_nocondContext arg) {
		final Node node = model.findOrCreate(Label.label("Lambdef_nocond"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterOr_test(com.generator.generators.python.parser.Python3Parser.Or_testContext arg) {
		final Node node = model.findOrCreate(Label.label("Or_test"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterAnd_test(com.generator.generators.python.parser.Python3Parser.And_testContext arg) {
		final Node node = model.findOrCreate(Label.label("And_test"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterNot_test(com.generator.generators.python.parser.Python3Parser.Not_testContext arg) {
		final Node node = model.findOrCreate(Label.label("Not_test"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterComparison(com.generator.generators.python.parser.Python3Parser.ComparisonContext arg) {
		final Node node = model.findOrCreate(Label.label("Comparison"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterComp_op(com.generator.generators.python.parser.Python3Parser.Comp_opContext arg) {
		final Node node = model.findOrCreate(Label.label("Comp_op"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterStar_expr(com.generator.generators.python.parser.Python3Parser.Star_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("Star_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterXor_expr(com.generator.generators.python.parser.Python3Parser.Xor_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("Xor_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterAnd_expr(com.generator.generators.python.parser.Python3Parser.And_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("And_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterShift_expr(com.generator.generators.python.parser.Python3Parser.Shift_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("Shift_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterArith_expr(com.generator.generators.python.parser.Python3Parser.Arith_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("Arith_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTerm(com.generator.generators.python.parser.Python3Parser.TermContext arg) {
		final Node node = model.findOrCreate(Label.label("Term"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterFactor(com.generator.generators.python.parser.Python3Parser.FactorContext arg) {
		final Node node = model.findOrCreate(Label.label("Factor"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPower(com.generator.generators.python.parser.Python3Parser.PowerContext arg) {
		final Node node = model.findOrCreate(Label.label("Power"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTestlist_comp(com.generator.generators.python.parser.Python3Parser.Testlist_compContext arg) {
		final Node node = model.findOrCreate(Label.label("Testlist_comp"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTrailer(com.generator.generators.python.parser.Python3Parser.TrailerContext arg) {
		final Node node = model.findOrCreate(Label.label("Trailer"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSubscriptlist(com.generator.generators.python.parser.Python3Parser.SubscriptlistContext arg) {
		final Node node = model.findOrCreate(Label.label("Subscriptlist"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSubscript(com.generator.generators.python.parser.Python3Parser.SubscriptContext arg) {
		final Node node = model.findOrCreate(Label.label("Subscript"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSliceop(com.generator.generators.python.parser.Python3Parser.SliceopContext arg) {
		final Node node = model.findOrCreate(Label.label("Sliceop"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterExprlist(com.generator.generators.python.parser.Python3Parser.ExprlistContext arg) {
		final Node node = model.findOrCreate(Label.label("Exprlist"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTestlist(com.generator.generators.python.parser.Python3Parser.TestlistContext arg) {
		final Node node = model.findOrCreate(Label.label("Testlist"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDictorsetmaker(com.generator.generators.python.parser.Python3Parser.DictorsetmakerContext arg) {
		final Node node = model.findOrCreate(Label.label("Dictorsetmaker"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterArgument(com.generator.generators.python.parser.Python3Parser.ArgumentContext arg) {
		final Node node = model.findOrCreate(Label.label("Argument"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterComp_iter(com.generator.generators.python.parser.Python3Parser.Comp_iterContext arg) {
		final Node node = model.findOrCreate(Label.label("Comp_iter"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterComp_for(com.generator.generators.python.parser.Python3Parser.Comp_forContext arg) {
		final Node node = model.findOrCreate(Label.label("Comp_for"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterComp_if(com.generator.generators.python.parser.Python3Parser.Comp_ifContext arg) {
		final Node node = model.findOrCreate(Label.label("Comp_if"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterYield_expr(com.generator.generators.python.parser.Python3Parser.Yield_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("Yield_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterYield_arg(com.generator.generators.python.parser.Python3Parser.Yield_argContext arg) {
		final Node node = model.findOrCreate(Label.label("Yield_arg"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterStr(com.generator.generators.python.parser.Python3Parser.StrContext arg) {
		final Node node = model.findOrCreate(Label.label("Str"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterInteger(com.generator.generators.python.parser.Python3Parser.IntegerContext arg) {
		final Node node = model.findOrCreate(Label.label("Integer"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSingle_input(com.generator.generators.python.parser.Python3Parser.Single_inputContext arg) {
		final Node node = model.findOrCreate(Label.label("Single_input"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterFile_input(com.generator.generators.python.parser.Python3Parser.File_inputContext arg) {
		final Node node = model.findOrCreate(Label.label("File_input"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterEval_input(com.generator.generators.python.parser.Python3Parser.Eval_inputContext arg) {
		final Node node = model.findOrCreate(Label.label("Eval_input"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDecorator(com.generator.generators.python.parser.Python3Parser.DecoratorContext arg) {
		final Node node = model.findOrCreate(Label.label("Decorator"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDecorators(com.generator.generators.python.parser.Python3Parser.DecoratorsContext arg) {
		final Node node = model.findOrCreate(Label.label("Decorators"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDecorated(com.generator.generators.python.parser.Python3Parser.DecoratedContext arg) {
		final Node node = model.findOrCreate(Label.label("Decorated"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterFuncdef(com.generator.generators.python.parser.Python3Parser.FuncdefContext arg) {
		final Node node = model.findOrCreate(Label.label("Funcdef"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTypedargslist(com.generator.generators.python.parser.Python3Parser.TypedargslistContext arg) {
		final Node node = model.findOrCreate(Label.label("Typedargslist"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTfpdef(com.generator.generators.python.parser.Python3Parser.TfpdefContext arg) {
		final Node node = model.findOrCreate(Label.label("Tfpdef"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterVarargslist(com.generator.generators.python.parser.Python3Parser.VarargslistContext arg) {
		final Node node = model.findOrCreate(Label.label("Varargslist"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterVfpdef(com.generator.generators.python.parser.Python3Parser.VfpdefContext arg) {
		final Node node = model.findOrCreate(Label.label("Vfpdef"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterStmt(com.generator.generators.python.parser.Python3Parser.StmtContext arg) {
		final Node node = model.findOrCreate(Label.label("Stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSimple_stmt(com.generator.generators.python.parser.Python3Parser.Simple_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("Simple_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSmall_stmt(com.generator.generators.python.parser.Python3Parser.Small_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("Small_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPrint_stmt(com.generator.generators.python.parser.Python3Parser.Print_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("Print_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterExpr_stmt(com.generator.generators.python.parser.Python3Parser.Expr_stmtContext arg) {
		final Node node = model.findOrCreate(Label.label("Expr_stmt"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTestlist_star_expr(com.generator.generators.python.parser.Python3Parser.Testlist_star_exprContext arg) {
		final Node node = model.findOrCreate(Label.label("Testlist_star_expr"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterAugassign(com.generator.generators.python.parser.Python3Parser.AugassignContext arg) {
		final Node node = model.findOrCreate(Label.label("Augassign"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
