...
public class TemplatesSwingVerticles {
	...
	public void newGroupPanelVerticle(VertxUtil.SuccessHandler<String> handler) {
		deploy(vertx, GroupPanelVerticle.class.getName(), log, handler);
	} 

	public void newTemplatePanelVerticle(VertxUtil.SuccessHandler<String> handler) {
		deploy(vertx, TemplatePanelVerticle.class.getName(), log, handler);
	} 
	...
	public static final class GroupPanelVerticle extends AbstractVerticle {
		...
		public void start(Future<Void> startFuture) throws Exception {
			...
			final TemplatesSwingGroup.GroupPanelST template = templateGroup.newGroupPanel();

			// string property name
			consume(vertx, "GroupPanel_" + deploymentID(), deploymentID() + ".name", log, new Handler<Message<String> >() {
				@Override
			...
			consume(vertx, "GroupPanel_" + deploymentID(), deploymentID() + ".packageName", log, new Handler<Message<String> >() {
				@Override
				public void handle(Message<String> message) {
			...
			consume(vertx, "GroupPanel_" + deploymentID(), deploymentID() + ".verticles", log, new Handler<Message<JsonObject> >() {
				@Override
				public void handle(Message<JsonObject> message) {
					template.addVerticlesValue(message.body().getString("addGroupVerticleAction"),message.body().getString("groupClassDeclarationPanel"));
				}
			}); 
		...
		public static void sendAddVerticles(Vertx vertx, java.util.UUID id, Object content, String addGroupVerticleAction, String groupClassDeclarationPanel, Handler<String> instanceHandler) {

			final JsonObject parameters = new JsonObject().put("addGroupVerticleAction", addGroupVerticleAction)
				.put("groupClassDeclarationPanel", groupClassDeclarationPanel);
	...
	public static final class TemplatePanelVerticle extends AbstractVerticle {
		...
		public void start(Future<Void> startFuture) throws Exception {
			...
			// new instance of template
			final TemplatesSwingGroup.TemplatePanelST template = templateGroup.newTemplatePanel();

			// string property name
			consume(vertx, "TemplatePanel_" + deploymentID(), deploymentID() + ".name", log, new Handler<Message<String> >() {
				@Override
				public void handle(Message<String> message) {
					template.setName(message.body());
					message.reply(message.body());
			...
			consume(vertx, "TemplatePanel_" + deploymentID(), deploymentID() + ".properties", log, new Handler<Message<JsonObject> >() {
				@Override
				public void handle(Message<JsonObject> message) {
					template.addPropertiesValue(message.body().getString("stringPanel"));
				}
			}); 
		...
		public static void sendAddProperties(Vertx vertx, java.util.UUID id, Object content, String stringPanel, Handler<String> instanceHandler) {

			final JsonObject parameters = new JsonObject().put("stringPanel", stringPanel);
	...
	public static void main(String[] args) {
		...
		verticles.newGroupPanelVerticle(loggingHandler(vertx));
		verticles.newTemplatePanelVerticle(loggingHandler(vertx));
