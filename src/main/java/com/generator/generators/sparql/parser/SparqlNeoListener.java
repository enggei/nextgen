...
public class SparqlNeoListener extends SparqlBaseListener {
	...
	private final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SparqlNeoListener.class);
   ...
   public Node getRoot() {
	...
	public void enterPrologue(com.generator.generators.sparql.parser.SparqlParser.PrologueContext arg) {
		final Node node = model.newNode(Label.label("Prologue"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterBaseDecl(com.generator.generators.sparql.parser.SparqlParser.BaseDeclContext arg) {
		final Node node = model.newNode(Label.label("BaseDecl"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPrefixDecl(com.generator.generators.sparql.parser.SparqlParser.PrefixDeclContext arg) {
		final Node node = model.newNode(Label.label("PrefixDecl"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSelectQuery(com.generator.generators.sparql.parser.SparqlParser.SelectQueryContext arg) {
		final Node node = model.newNode(Label.label("SelectQuery"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterConstructQuery(com.generator.generators.sparql.parser.SparqlParser.ConstructQueryContext arg) {
		final Node node = model.newNode(Label.label("ConstructQuery"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDescribeQuery(com.generator.generators.sparql.parser.SparqlParser.DescribeQueryContext arg) {
		final Node node = model.newNode(Label.label("DescribeQuery"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterAskQuery(com.generator.generators.sparql.parser.SparqlParser.AskQueryContext arg) {
		final Node node = model.newNode(Label.label("AskQuery"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDatasetClause(com.generator.generators.sparql.parser.SparqlParser.DatasetClauseContext arg) {
		final Node node = model.newNode(Label.label("DatasetClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDefaultGraphClause(com.generator.generators.sparql.parser.SparqlParser.DefaultGraphClauseContext arg) {
		final Node node = model.newNode(Label.label("DefaultGraphClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterNamedGraphClause(com.generator.generators.sparql.parser.SparqlParser.NamedGraphClauseContext arg) {
		final Node node = model.newNode(Label.label("NamedGraphClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSourceSelector(com.generator.generators.sparql.parser.SparqlParser.SourceSelectorContext arg) {
		final Node node = model.newNode(Label.label("SourceSelector"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterWhereClause(com.generator.generators.sparql.parser.SparqlParser.WhereClauseContext arg) {
		final Node node = model.newNode(Label.label("WhereClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSolutionModifier(com.generator.generators.sparql.parser.SparqlParser.SolutionModifierContext arg) {
		final Node node = model.newNode(Label.label("SolutionModifier"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterLimitOffsetClauses(com.generator.generators.sparql.parser.SparqlParser.LimitOffsetClausesContext arg) {
		final Node node = model.newNode(Label.label("LimitOffsetClauses"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterOrderClause(com.generator.generators.sparql.parser.SparqlParser.OrderClauseContext arg) {
		final Node node = model.newNode(Label.label("OrderClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterOrderCondition(com.generator.generators.sparql.parser.SparqlParser.OrderConditionContext arg) {
		final Node node = model.newNode(Label.label("OrderCondition"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterLimitClause(com.generator.generators.sparql.parser.SparqlParser.LimitClauseContext arg) {
		final Node node = model.newNode(Label.label("LimitClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterOffsetClause(com.generator.generators.sparql.parser.SparqlParser.OffsetClauseContext arg) {
		final Node node = model.newNode(Label.label("OffsetClause"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterGroupGraphPattern(com.generator.generators.sparql.parser.SparqlParser.GroupGraphPatternContext arg) {
		final Node node = model.newNode(Label.label("GroupGraphPattern"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTriplesBlock(com.generator.generators.sparql.parser.SparqlParser.TriplesBlockContext arg) {
		final Node node = model.newNode(Label.label("TriplesBlock"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterGraphPatternNotTriples(com.generator.generators.sparql.parser.SparqlParser.GraphPatternNotTriplesContext arg) {
		final Node node = model.newNode(Label.label("GraphPatternNotTriples"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterOptionalGraphPattern(com.generator.generators.sparql.parser.SparqlParser.OptionalGraphPatternContext arg) {
		final Node node = model.newNode(Label.label("OptionalGraphPattern"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterGraphGraphPattern(com.generator.generators.sparql.parser.SparqlParser.GraphGraphPatternContext arg) {
		final Node node = model.newNode(Label.label("GraphGraphPattern"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterGroupOrUnionGraphPattern(com.generator.generators.sparql.parser.SparqlParser.GroupOrUnionGraphPatternContext arg) {
		final Node node = model.newNode(Label.label("GroupOrUnionGraphPattern"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterFilter(com.generator.generators.sparql.parser.SparqlParser.FilterContext arg) {
		final Node node = model.newNode(Label.label("Filter"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterConstraint(com.generator.generators.sparql.parser.SparqlParser.ConstraintContext arg) {
		final Node node = model.newNode(Label.label("Constraint"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterConstructTemplate(com.generator.generators.sparql.parser.SparqlParser.ConstructTemplateContext arg) {
		final Node node = model.newNode(Label.label("ConstructTemplate"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterConstructTriples(com.generator.generators.sparql.parser.SparqlParser.ConstructTriplesContext arg) {
		final Node node = model.newNode(Label.label("ConstructTriples"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTriplesSameSubject(com.generator.generators.sparql.parser.SparqlParser.TriplesSameSubjectContext arg) {
		final Node node = model.newNode(Label.label("TriplesSameSubject"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPropertyListNotEmpty(com.generator.generators.sparql.parser.SparqlParser.PropertyListNotEmptyContext arg) {
		final Node node = model.newNode(Label.label("PropertyListNotEmpty"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPropertyList(com.generator.generators.sparql.parser.SparqlParser.PropertyListContext arg) {
		final Node node = model.newNode(Label.label("PropertyList"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTriplesNode(com.generator.generators.sparql.parser.SparqlParser.TriplesNodeContext arg) {
		final Node node = model.newNode(Label.label("TriplesNode"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterGraphNode(com.generator.generators.sparql.parser.SparqlParser.GraphNodeContext arg) {
		final Node node = model.newNode(Label.label("GraphNode"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterVarOrTerm(com.generator.generators.sparql.parser.SparqlParser.VarOrTermContext arg) {
		final Node node = model.newNode(Label.label("VarOrTerm"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterVarOrIRIref(com.generator.generators.sparql.parser.SparqlParser.VarOrIRIrefContext arg) {
		final Node node = model.newNode(Label.label("VarOrIRIref"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterGraphTerm(com.generator.generators.sparql.parser.SparqlParser.GraphTermContext arg) {
		final Node node = model.newNode(Label.label("GraphTerm"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterConditionalOrExpression(com.generator.generators.sparql.parser.SparqlParser.ConditionalOrExpressionContext arg) {
		final Node node = model.newNode(Label.label("ConditionalOrExpression"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterConditionalAndExpression(com.generator.generators.sparql.parser.SparqlParser.ConditionalAndExpressionContext arg) {
		final Node node = model.newNode(Label.label("ConditionalAndExpression"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterValueLogical(com.generator.generators.sparql.parser.SparqlParser.ValueLogicalContext arg) {
		final Node node = model.newNode(Label.label("ValueLogical"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterNumericExpression(com.generator.generators.sparql.parser.SparqlParser.NumericExpressionContext arg) {
		final Node node = model.newNode(Label.label("NumericExpression"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterBrackettedExpression(com.generator.generators.sparql.parser.SparqlParser.BrackettedExpressionContext arg) {
		final Node node = model.newNode(Label.label("BrackettedExpression"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterBuiltInCall(com.generator.generators.sparql.parser.SparqlParser.BuiltInCallContext arg) {
		final Node node = model.newNode(Label.label("BuiltInCall"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterRegexExpression(com.generator.generators.sparql.parser.SparqlParser.RegexExpressionContext arg) {
		final Node node = model.newNode(Label.label("RegexExpression"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterIriRefOrFunction(com.generator.generators.sparql.parser.SparqlParser.IriRefOrFunctionContext arg) {
		final Node node = model.newNode(Label.label("IriRefOrFunction"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterNumericLiteralUnsigned(com.generator.generators.sparql.parser.SparqlParser.NumericLiteralUnsignedContext arg) {
		final Node node = model.newNode(Label.label("NumericLiteralUnsigned"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterNumericLiteralPositive(com.generator.generators.sparql.parser.SparqlParser.NumericLiteralPositiveContext arg) {
		final Node node = model.newNode(Label.label("NumericLiteralPositive"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterNumericLiteralNegative(com.generator.generators.sparql.parser.SparqlParser.NumericLiteralNegativeContext arg) {
		final Node node = model.newNode(Label.label("NumericLiteralNegative"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterIriRef(com.generator.generators.sparql.parser.SparqlParser.IriRefContext arg) {
		final Node node = model.newNode(Label.label("IriRef"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPrefixedName(com.generator.generators.sparql.parser.SparqlParser.PrefixedNameContext arg) {
		final Node node = model.newNode(Label.label("PrefixedName"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterBlankNode(com.generator.generators.sparql.parser.SparqlParser.BlankNodeContext arg) {
		final Node node = model.newNode(Label.label("BlankNode"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
