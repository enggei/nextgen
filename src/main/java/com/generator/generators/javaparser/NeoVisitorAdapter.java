...
public class NeoVisitorAdapter extends VoidVisitorAdapter<Object> {
	...
	private Stack<org.neo4j.graphdb.Node> nodes = new Stack<>();
	...
	public void visit(Relationship relationship, org.neo4j.graphdb.Node node) {
		...
		switch (nodeType) {
			case "PrimitiveType":
				visitPrimitiveType(BaseDomainVisitor.other(node, relationship));
				break;
			case "MultiTypeParameter":
				visitMultiTypeParameter(BaseDomainVisitor.other(node, relationship));
				break;
			case "Parameter":
				visitParameter(BaseDomainVisitor.other(node, relationship));
				break;
			case "PackageDeclaration":
				visitPackageDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "ObjectCreationExpr":
				visitObjectCreationExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "NullLiteralExpr":
				visitNullLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "ReturnStmt":
				visitReturnStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "UnionType":
				visitUnionType(BaseDomainVisitor.other(node, relationship));
				break;
			case "IntersectionType":
				visitIntersectionType(BaseDomainVisitor.other(node, relationship));
				break;
			case "ReferenceType":
				visitReferenceType(BaseDomainVisitor.other(node, relationship));
				break;
			case "QualifiedNameExpr":
				visitQualifiedNameExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "MarkerAnnotationExpr":
				visitMarkerAnnotationExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "LongLiteralMinValueExpr":
				visitLongLiteralMinValueExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "LongLiteralExpr":
				visitLongLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "LineComment":
				visitLineComment(BaseDomainVisitor.other(node, relationship));
				break;
			case "TypeExpr":
				visitTypeExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "JavadocComment":
				visitJavadocComment(BaseDomainVisitor.other(node, relationship));
				break;
			case "NormalAnnotationExpr":
				visitNormalAnnotationExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "NameExpr":
				visitNameExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "MethodDeclaration":
				visitMethodDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "MethodCallExpr":
				visitMethodCallExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "MemberValuePair":
				visitMemberValuePair(BaseDomainVisitor.other(node, relationship));
				break;
			case "VariableDeclaratorId":
				visitVariableDeclaratorId(BaseDomainVisitor.other(node, relationship));
				break;
			case "VariableDeclarator":
				visitVariableDeclarator(BaseDomainVisitor.other(node, relationship));
				break;
			case "VariableDeclarationExpr":
				visitVariableDeclarationExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "UnknownType":
				visitUnknownType(BaseDomainVisitor.other(node, relationship));
				break;
			case "UnaryExpr":
				visitUnaryExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "TypeParameter":
				visitTypeParameter(BaseDomainVisitor.other(node, relationship));
				break;
			case "MethodReferenceExpr":
				visitMethodReferenceExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "LambdaExpr":
				visitLambdaExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "WildcardType":
				visitWildcardType(BaseDomainVisitor.other(node, relationship));
				break;
			case "WhileStmt":
				visitWhileStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "VoidType":
				visitVoidType(BaseDomainVisitor.other(node, relationship));
				break;
			case "SwitchStmt":
				visitSwitchStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "SwitchEntryStmt":
				visitSwitchEntryStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "SuperExpr":
				visitSuperExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "StringLiteralExpr":
				visitStringLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "SingleMemberAnnotationExpr":
				visitSingleMemberAnnotationExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "TypeDeclarationStmt":
				visitTypeDeclarationStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "TryStmt":
				visitTryStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ThrowStmt":
				visitThrowStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ThisExpr":
				visitThisExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "SynchronizedStmt":
				visitSynchronizedStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ClassExpr":
				visitClassExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "CharLiteralExpr":
				visitCharLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "CatchClause":
				visitCatchClause(BaseDomainVisitor.other(node, relationship));
				break;
			case "CastExpr":
				visitCastExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "BreakStmt":
				visitBreakStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "BooleanLiteralExpr":
				visitBooleanLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "ConstructorDeclaration":
				visitConstructorDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "ConditionalExpr":
				visitConditionalExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "CompilationUnit":
				visitCompilationUnit(BaseDomainVisitor.other(node, relationship));
				break;
			case "ClassOrInterfaceType":
				visitClassOrInterfaceType(BaseDomainVisitor.other(node, relationship));
				break;
			case "ClassOrInterfaceDeclaration":
				visitClassOrInterfaceDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "ArrayInitializerExpr":
				visitArrayInitializerExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "ArrayCreationExpr":
				visitArrayCreationExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "ArrayAccessExpr":
				visitArrayAccessExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "AnnotationMemberDeclaration":
				visitAnnotationMemberDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "AnnotationDeclaration":
				visitAnnotationDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "LabeledStmt":
				visitLabeledStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "BlockStmt":
				visitBlockStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "BlockComment":
				visitBlockComment(BaseDomainVisitor.other(node, relationship));
				break;
			case "BinaryExpr":
				visitBinaryExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "AssignExpr":
				visitAssignExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "AssertStmt":
				visitAssertStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "IfStmt":
				visitIfStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ForStmt":
				visitForStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ForeachStmt":
				visitForeachStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "FieldDeclaration":
				visitFieldDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "FieldAccessExpr":
				visitFieldAccessExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "ExpressionStmt":
				visitExpressionStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "IntegerLiteralMinValueExpr":
				visitIntegerLiteralMinValueExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "IntegerLiteralExpr":
				visitIntegerLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "InstanceOfExpr":
				visitInstanceOfExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "InitializerDeclaration":
				visitInitializerDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "ImportDeclaration":
				visitImportDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "EmptyStmt":
				visitEmptyStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "EmptyMemberDeclaration":
				visitEmptyMemberDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "DoubleLiteralExpr":
				visitDoubleLiteralExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "DoStmt":
				visitDoStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ContinueStmt":
				visitContinueStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "ExplicitConstructorInvocationStmt":
				visitExplicitConstructorInvocationStmt(BaseDomainVisitor.other(node, relationship));
				break;
			case "EnumDeclaration":
				visitEnumDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "EnumConstantDeclaration":
				visitEnumConstantDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
			case "EnclosedExpr":
				visitEnclosedExpr(BaseDomainVisitor.other(node, relationship));
				break;
			case "EmptyTypeDeclaration":
				visitEmptyTypeDeclaration(BaseDomainVisitor.other(node, relationship));
				break;
		}
	}
