...
public class ProtobufParser extends Parser {
    ...
    public static final String[] tokenNames = {
            "<INVALID>", "'import'", "']'", "'max'", "'extensions'", "'.'", "'default'",
    ...
    public final FileContext file() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 11) | (1L << 15) | (1L << 19) | (1L << SL_COMMENT))) != 0));
                end();
            }
    ...
    public static class PackageDeclContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitPackageDecl(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PackageNameContext extends ParserRuleContext {
        public List<TerminalNode> ID() {
            return getTokens(ProtobufParser.ID);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitPackageName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class OptionContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(ProtobufParser.ID, 0);
        }
    ...
    public static class MessageContext extends ParserRuleContext {
        ...
        public List<TerminalNode> SL_COMMENT() {
            return getTokens(ProtobufParser.SL_COMMENT);
        }
        ...
        try {
            ...
            switch (getInterpreter().adaptivePredict(_input, 14, _ctx)) {
                    ...
                    enterOuterAlt(_localctx, 1);
                {
                    ...
                    while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 4) | (1L << 11) | (1L << 15) | (1L << 19) | (1L << FIELDRULE) | (1L << SL_COMMENT))) != 0));
                    setState(92);
                    match(17);
                    endMessage();
                }
    ...
    public static class EnumNameContext extends ParserRuleContext {
        ...
        public TerminalNode INT() {
            return getToken(ProtobufParser.INT, 0);
        }
        ...
        public TerminalNode SL_COMMENT() {
            return getToken(ProtobufParser.SL_COMMENT, 0);
        }
    ...
    public static class MessageContentContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitMessageContent(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PropertyContext extends ParserRuleContext {
        ...
        public TerminalNode FIELDRULE() {
            return getToken(ProtobufParser.FIELDRULE, 0);
        }
    ...
    public static class DefaultValueContext extends ParserRuleContext {
        public List<TerminalNode> INT() {
            return getTokens(ProtobufParser.INT);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitDefaultValue(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final DefaultValueContext defaultValue() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                    ...
                    {
                        {
                            setState(164);
                            _la = _input.LA(1);
                            if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 8) | (1L << 18) | (1L << INT) | (1L << ID))) != 0))) {
                ...
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 8) | (1L << 18) | (1L << INT) | (1L << ID))) != 0));
                setState(169);
                match(2);
            }
        } catch (RecognitionException re) {
    ...
    public static class ExtensionsContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitExtensions(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PropertyNameContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitPropertyName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class PropertyTypeContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitPropertyType(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExtensionMaxContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ProtobufVisitor)
                return ((ProtobufVisitor<? extends T>) visitor).visitExtensionMax(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public