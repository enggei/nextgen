...
public class ProtobufEntitiesModel {
   ...
   public Set<ProtobufEnum> getProtobufEnumSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufEnum) RETURN entity");
   ...
   public Set<ProtobufEnumValue> getProtobufEnumValueSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufEnumValue) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
   ...
   public Set<ProtobufFieldConstraint> getProtobufFieldConstraintSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufFieldConstraint) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
   ...
   public Set<ProtobufFieldType> getProtobufFieldTypeSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufFieldType) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
   ...
   public Set<ProtobufMessage> getProtobufMessageSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufMessage) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
   ...
   public Set<ProtobufMessageField> getProtobufMessageFieldSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufMessageField) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
   ...
   public Set<ProtobufPackage> getProtobufPackageSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufPackage) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
   ...
   public Set<ProtobufPackageOption> getProtobufPackageOptionSet() {
      ...
      try (Transaction tx = graphDb.beginTx()) {
         final ExecutionResult res = engine.execute("MATCH (entity:ProtobufPackageOption) RETURN entity");
         Iterator<Node> n_column = res.columnAs("entity");
         for (Node node : IteratorUtil.asIterable(n_column))
