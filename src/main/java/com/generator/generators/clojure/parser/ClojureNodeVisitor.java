...
public class ClojureNodeVisitor extends ClojureBaseVisitor<ClojureNodeVisitor.Node> {
   ...
   public Node getRoot() {
	...
	public Node visitDeref(com.generator.generators.clojure.parser.ClojureParser.DerefContext arg) {
		final Node node = new Node("Deref", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitGensym(com.generator.generators.clojure.parser.ClojureParser.GensymContext arg) {
		final Node node = new Node("Gensym", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitLambda(com.generator.generators.clojure.parser.ClojureParser.LambdaContext arg) {
		final Node node = new Node("Lambda", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitMeta_data(com.generator.generators.clojure.parser.ClojureParser.Meta_dataContext arg) {
		final Node node = new Node("Meta_data", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitVar_quote(com.generator.generators.clojure.parser.ClojureParser.Var_quoteContext arg) {
		final Node node = new Node("Var_quote", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitHost_expr(com.generator.generators.clojure.parser.ClojureParser.Host_exprContext arg) {
		final Node node = new Node("Host_expr", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitDiscard(com.generator.generators.clojure.parser.ClojureParser.DiscardContext arg) {
		final Node node = new Node("Discard", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitForm(com.generator.generators.clojure.parser.ClojureParser.FormContext arg) {
		final Node node = new Node("Form", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitForms(com.generator.generators.clojure.parser.ClojureParser.FormsContext arg) {
		final Node node = new Node("Forms", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitVector(com.generator.generators.clojure.parser.ClojureParser.VectorContext arg) {
		final Node node = new Node("Vector", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitMap(com.generator.generators.clojure.parser.ClojureParser.MapContext arg) {
		final Node node = new Node("Map", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitReader_macro(com.generator.generators.clojure.parser.ClojureParser.Reader_macroContext arg) {
		final Node node = new Node("Reader_macro", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitQuote(com.generator.generators.clojure.parser.ClojureParser.QuoteContext arg) {
		final Node node = new Node("Quote", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitBacktick(com.generator.generators.clojure.parser.ClojureParser.BacktickContext arg) {
		final Node node = new Node("Backtick", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitUnquote(com.generator.generators.clojure.parser.ClojureParser.UnquoteContext arg) {
		final Node node = new Node("Unquote", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitUnquote_splicing(com.generator.generators.clojure.parser.ClojureParser.Unquote_splicingContext arg) {
		final Node node = new Node("Unquote_splicing", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitTag(com.generator.generators.clojure.parser.ClojureParser.TagContext arg) {
		final Node node = new Node("Tag", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitDispatch(com.generator.generators.clojure.parser.ClojureParser.DispatchContext arg) {
		final Node node = new Node("Dispatch", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitRegex(com.generator.generators.clojure.parser.ClojureParser.RegexContext arg) {
		final Node node = new Node("Regex", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitHex(com.generator.generators.clojure.parser.ClojureParser.HexContext arg) {
		final Node node = new Node("Hex", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitBin(com.generator.generators.clojure.parser.ClojureParser.BinContext arg) {
		final Node node = new Node("Bin", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitBign(com.generator.generators.clojure.parser.ClojureParser.BignContext arg) {
		final Node node = new Node("Bign", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitCharacter(com.generator.generators.clojure.parser.ClojureParser.CharacterContext arg) {
		final Node node = new Node("Character", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitNamed_char(com.generator.generators.clojure.parser.ClojureParser.Named_charContext arg) {
		final Node node = new Node("Named_char", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitAny_char(com.generator.generators.clojure.parser.ClojureParser.Any_charContext arg) {
		final Node node = new Node("Any_char", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitU_hex_quad(com.generator.generators.clojure.parser.ClojureParser.U_hex_quadContext arg) {
		final Node node = new Node("U_hex_quad", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitNil(com.generator.generators.clojure.parser.ClojureParser.NilContext arg) {
		final Node node = new Node("Nil", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitSimple_keyword(com.generator.generators.clojure.parser.ClojureParser.Simple_keywordContext arg) {
		final Node node = new Node("Simple_keyword", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitMacro_keyword(com.generator.generators.clojure.parser.ClojureParser.Macro_keywordContext arg) {
		final Node node = new Node("Macro_keyword", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitSymbol(com.generator.generators.clojure.parser.ClojureParser.SymbolContext arg) {
		final Node node = new Node("Symbol", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitSimple_sym(com.generator.generators.clojure.parser.ClojureParser.Simple_symContext arg) {
		final Node node = new Node("Simple_sym", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitNs_symbol(com.generator.generators.clojure.parser.ClojureParser.Ns_symbolContext arg) {
		final Node node = new Node("Ns_symbol", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
	...
	public Node visitParam_name(com.generator.generators.clojure.parser.ClojureParser.Param_nameContext arg) {
		final Node node = new Node("Param_name", arg.getText(), arg.getStart().getText(), arg.getStop().getText());
		onEnter(node);
      visitChildren(arg);
      onExit();
      return node;
