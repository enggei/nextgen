 ...
 */
public final class TemplateGroupDomainGroup {
   // old templateGroup
   private final STGroup stGroup;
   private final char delimiter;

	public TemplateGroupDomainGroup() {
        ...
        if (generatorPath != null) {
        	...
        	this.stGroup = new org.stringtemplate.v4.STGroupFile(TemplateGroupDomainGroup.class.getResource("/com/generator/generators/templateGroup/templateGroup.stg"), "UTF-8", '~', '~');
        	this.stGroup.registerRenderer(String.class, new DefaultAttributeRenderer());
        	this.delimiter = stGroup.delimiterStartChar;
        }
   }

   public TemplateGroupDomainGroup(STGroup stGroup) {
      this.stGroup = stGroup;
      this.stGroup.registerRenderer(String.class, new DefaultAttributeRenderer());
      this.delimiter = stGroup.delimiterStartChar;
   }

   public TemplateGroupDomainGroup(java.io.File templateFile) {
   ...
   public char getDelimiter() {
	...
	public interface TemplateGroupDomainGroupTemplate {
   ...
   public final class eomST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class gtST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class AttributeRendererDeclarationST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class GroupClassDeclarationST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class NewGroupInstanceST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class NewStatementDeclarationST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class NewStatementInstanceST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class StatementKeyValueListPropertySetterST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class StatementListPropertySetterST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class StatementStringPropertySetterST implements TemplateGroupDomainGroupTemplate {
   ...
   public final class bugfixST implements TemplateGroupDomainGroupTemplate {
