...
public class TurtleNeoListener extends TurtleBaseListener {
   ...
   public Node getRoot() {
	...
	public void enterSubject(com.generator.generators.turtle.parser.TurtleParser.SubjectContext arg) {
		final Node node = model.findOrCreate(Label.label("Subject"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPredicate(com.generator.generators.turtle.parser.TurtleParser.PredicateContext arg) {
		final Node node = model.findOrCreate(Label.label("Predicate"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterIri(com.generator.generators.turtle.parser.TurtleParser.IriContext arg) {
		final Node node = model.findOrCreate(Label.label("Iri"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTurtleDoc(com.generator.generators.turtle.parser.TurtleParser.TurtleDocContext arg) {
		final Node node = model.findOrCreate(Label.label("TurtleDoc"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSparqlBase(com.generator.generators.turtle.parser.TurtleParser.SparqlBaseContext arg) {
		final Node node = model.findOrCreate(Label.label("SparqlBase"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterSparqlPrefix(com.generator.generators.turtle.parser.TurtleParser.SparqlPrefixContext arg) {
		final Node node = model.findOrCreate(Label.label("SparqlPrefix"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterTriples(com.generator.generators.turtle.parser.TurtleParser.TriplesContext arg) {
		final Node node = model.findOrCreate(Label.label("Triples"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPredicateObjectList(com.generator.generators.turtle.parser.TurtleParser.PredicateObjectListContext arg) {
		final Node node = model.findOrCreate(Label.label("PredicateObjectList"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterDirective(com.generator.generators.turtle.parser.TurtleParser.DirectiveContext arg) {
		final Node node = model.findOrCreate(Label.label("Directive"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterPrefixID(com.generator.generators.turtle.parser.TurtleParser.PrefixIDContext arg) {
		final Node node = model.findOrCreate(Label.label("PrefixID"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
	...
	public void enterBase(com.generator.generators.turtle.parser.TurtleParser.BaseContext arg) {
		final Node node = model.findOrCreate(Label.label("Base"), "text", arg.getText(), "startToken", arg.getStart().getText(), "endToken", (arg.getStop() == null ? "" : arg.getStop().getText()));
		onEnter(node);
