 ...
 * goe on 5/20/16.
 */
public class AddMessageVerticle extends AbstractVerticle {

	private final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(AddMessageVerticle.class);

	public static void sendInstanceMessage(Vertx vertx, java.util.UUID instanceId, Handler<String> instanceHandler) {
		sendMessage(vertx, "new.TemplatesVertxGroup.AddMessage", instanceId.toString(), log, new VertxUtil.SuccessHandler<Message<String> >() {
			@Override
			...
			public void onFail(Throwable t) {
				log.error("sendAddMessageMessage failed");
			}
		});
	}
	...
	public void start(Future<Void> startFuture) throws Exception {
		...
		consume(vertx, deploymentID(), "new.TemplatesVertxGroup.AddMessage", log, new Handler<Message<String> >() {
			@Override
