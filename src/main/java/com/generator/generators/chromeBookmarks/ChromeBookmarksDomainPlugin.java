...
public abstract class ChromeBookmarksDomainPlugin extends Plugin {
   ...
   ChromeBookmarksDomainPlugin(App app) {
      super(app, "ChromeBookmarks");
		...
		domainNode = newDomain(getGraph(), "ChromeBookmarks");
   ...
   public JComponent getEditorFor(NeoNode neoNode) {
	...
	protected <T extends PropertyContainer> T setIconProperty(T container, Object value) { setEntityProperty(getGraph(), container, Properties.icon.name(), value); return container; }
	...
	protected <T extends PropertyContainer> T setDateProperty(T container, Object value) { setEntityProperty(getGraph(), container, Properties.date.name(), value); return container; }
	...
	protected <T extends PropertyContainer> T setHrefProperty(T container, Object value) { setEntityProperty(getGraph(), container, Properties.href.name(), value); return container; }
