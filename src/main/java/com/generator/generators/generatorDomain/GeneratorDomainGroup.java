   ...
   private final char delimiter;
	...
	public GeneratorDomainGroup() {
		...
		if (generatorPath != null) {
			this.stGroup = new org.stringtemplate.v4.STGroupFile(generatorPath + java.io.File.separator + "generatorDomain" + java.io.File.separator + "generatorDomain.stg");
			this.stGroup.registerRenderer(String.class, new DefaultAttributeRenderer());
			this.delimiter = stGroup.delimiterStartChar;
		} else {
			this.stGroup = new org.stringtemplate.v4.STGroupFile(GeneratorDomainGroup.class.getResource("/com/generator/generators/generatorDomain/generatorDomain.stg"), "UTF-8", '~', '~');
			this.stGroup.registerRenderer(String.class, new DefaultAttributeRenderer());
			this.delimiter = stGroup.delimiterStartChar;
		}
