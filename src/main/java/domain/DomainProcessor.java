...
public class DomainProcessor {
   ...
   private static MetaDomain newNeoDomain() {
   ...
   private static MetaDomain newMetaDomain() {
      ...
      final MetaDomainFactory domain = new MetaDomainFactoryImpl("MetaDomain");
   ...
   public static void main(String[] args) {
      ...
      final String packageName = args.length <= 1 ? "domain.neo" : args[1];

      final MetaDomain metaDomain = newNeoDomain();
      ...
      final DefaultFactoryImpl defaultFactoryImpl = new ToDefaultFactoryImpl(packageName, new ToDomainDeclaration(packageName)).transform(metaDomain);
