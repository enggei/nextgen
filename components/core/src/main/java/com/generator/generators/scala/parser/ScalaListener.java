...
public interface ScalaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ScalaParser#simpleExpr2}.
	 * @param ctx the parse tree
	 */
	void enterSimpleExpr2(ScalaParser.SimpleExpr2Context ctx);
	/**
	 * Exit a parse tree produced by {@link ScalaParser#simpleExpr2}.
	 * @param ctx the parse tree
	 */
	void exitSimpleExpr2(ScalaParser.SimpleExpr2Context ctx);
	/**
