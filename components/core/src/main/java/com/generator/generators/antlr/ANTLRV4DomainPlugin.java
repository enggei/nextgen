...
public abstract class ANTLRV4DomainPlugin extends Plugin {
   ...
   ANTLRV4DomainPlugin(App app) {
      super(app, "ANTLR");
		...
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.GRAMMARTYPE.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.GrammarType));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.PREQUELCONSTRUCT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PrequelConstruct));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.RULES.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Rules));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.RULESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.RuleSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.MODESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ModeSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.LEXERRULESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerRuleSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.EXCEPTIONGROUP.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ExceptionGroup));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.GrammarSpec), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PrequelConstruct), Relations.OPTIONSSPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.OptionsSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PrequelConstruct), Relations.DELEGATEGRAMMARS.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.DelegateGrammars));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PrequelConstruct), Relations.TOKENSSPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.TokensSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PrequelConstruct), Relations.CHANNELSSPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ChannelsSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.OptionsSpec), Relations.OPTION.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Option));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Option), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Option), Relations.OPTIONVALUE.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.OptionValue));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.OptionValue), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.DelegateGrammars), Relations.DELEGATEGRAMMAR.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.DelegateGrammar));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.DelegateGrammar), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.TokensSpec), Relations.IDLIST.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.IdList));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.IdList), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ChannelsSpec), Relations.IDLIST.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.IdList));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Rules), Relations.RULESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.RuleSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleSpec), Relations.LEXERRULESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerRuleSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleSpec), Relations.PARSERRULESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ParserRuleSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleSpec), Relations.EXCEPTIONGROUP.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ExceptionGroup));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleSpec), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleSpec), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleSpec), Relations.LABELEDALT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LabeledAlt));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerRuleSpec), Relations.LEXERRULEBLOCK.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerRuleBlock));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerRuleBlock), Relations.LEXERALTLIST.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerAltList));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerRuleBlock), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAltList), Relations.LEXERALT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerAlt));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAltList), Relations.LEXERCOMMANDS.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerCommands));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAltList), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAlt), Relations.LEXERELEMENTS.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerElements));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAlt), Relations.LEXERCOMMANDS.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerCommands));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAlt), Relations.LEXERELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerElement));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAlt), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerElements), Relations.LEXERELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerElement));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerElements), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerElement), Relations.LEXERATOM.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerAtom));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerElement), Relations.ACTIONBLOCK.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ActionBlock));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerElement), Relations.LEXERBLOCK.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerBlock));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAtom), Relations.TERMINAL.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Terminal));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAtom), Relations.NOTSET.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.NotSet));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerAtom), Relations.CHARACTERRANGE.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.CharacterRange));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerCommands), Relations.LEXERCOMMAND.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerCommand));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerCommand), Relations.LEXERCOMMANDNAME.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerCommandName));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerCommand), Relations.LEXERCOMMANDEXPR.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerCommandExpr));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerCommandName), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerCommandExpr), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ModeSpec), Relations.IDENTIFIER.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Identifier));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ModeSpec), Relations.LEXERRULESPEC.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerRuleSpec));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LexerBlock), Relations.LEXERALTLIST.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LexerAltList));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.NotSet), Relations.SETELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.SetElement));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ParserRuleSpec), Relations.RULEBLOCK.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.RuleBlock));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ParserRuleSpec), Relations.EXCEPTIONGROUP.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ExceptionGroup));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ParserRuleSpec), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ParserRuleSpec), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.ParserRuleSpec), Relations.LABELEDALT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LabeledAlt));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleBlock), Relations.RULEALTLIST.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.RuleAltList));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleBlock), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleBlock), Relations.LABELEDALT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LabeledAlt));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleBlock), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleAltList), Relations.LABELEDALT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.LabeledAlt));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleAltList), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.RuleAltList), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LabeledAlt), Relations.ALTERNATIVE.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Alternative));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LabeledAlt), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.LabeledAlt), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Alternative), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Alternative), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Alternative), Relations.BLOCKSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.BlockSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Element), Relations.ATOM.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Atom));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Element), Relations.EBNF.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Ebnf));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Atom), Relations.TERMINAL.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Terminal));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Atom), Relations.RULEREF.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Ruleref));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Ebnf), Relations.BLOCK.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Block));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Ebnf), Relations.BLOCKSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.BlockSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Ebnf), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Block), Relations.ALTLIST.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.AltList));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Block), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.AltList), Relations.ALTERNATIVE.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Alternative));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.AltList), Relations.ELEMENT.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Element));
		DomainMotif.newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.AltList), Relations.EBNFSUFFIX.name(), DomainDomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.EbnfSuffix));
   }
