        ...
        if (hasPackageNameProperty(neoDomainNode.getNode()) && hasRootProperty(neoDomainNode.getNode())) {
            ...
            pop.add(new App.TransactionAction("Generate Verticle", app) {
                ...
                protected void actionPerformed(ActionEvent e, Transaction tx) throws Exception {
                    ...
                    final Triple<String, String, String> triple = domain.toVerticle(packageName, "", "com.nextgen.swing.VerticleFacade");
                    GeneratedFile.newJavaFile(root, packageName, name + "Verticle").write(triple.getFirst());
                }
            });
            ...
            pop.add(new App.TransactionAction("Add NeoProperties", app) {
                ...
                protected void actionPerformed(ActionEvent e, Transaction tx) throws Exception {
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        if (i == 0)
                            columns.addElementsValue("50dlu").addElementsValue("4dlu").addElementsValue("50dlu");
