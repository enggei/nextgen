...
import static com.generator.app.DomainMotif.newDomainEntityRelation;
        ...
        TemplateEditor(NeoNode templateNode, TemplateEditorListener templateEditorListener) {
            ...
            txtEditor.addKeyListener(new KeyAdapter() {
                ...
                private void format() {
                    ...
                    for (int i = 0; i < txtEditor.getTabSize(); i++)
                        spaces.append(" ");

                    final StringBuilder formatted = new StringBuilder();
                    for (String s : split)
                        formatted.append(s.replace(spaces, "\t")).append("\n");
                    ...
                    txtEditor.setCaretPosition(Math.min(formatted2.length(), caretPosition));
                }
            });
