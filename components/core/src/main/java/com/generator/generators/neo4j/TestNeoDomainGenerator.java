...
//      GeneratedFile.newJavaFile("/home/goe/projects/nextgen/components/core/src/main/java", packageName, domainName).write(generator.toDomain(packageName));
        GeneratedFile.newJavaFile("/home/goe/udc/bk-cloud/server/src/main/java", packageName, domainName + "Verticle").write(generator.toVerticle(packageName, "", "com.nextgen.swing.VerticleFacade"));
