...
public abstract class EnglishGrammarDomainPlugin extends Plugin {
   ...
   EnglishGrammarDomainPlugin(App app) {
      super(app, "EnglishGrammar");
		...
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Aspect), Relations.SIMPLE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.SimpleAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Aspect), Relations.PERFECT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Aspect), Relations.PROGRESSIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Aspect), Relations.PERFECTPROGRESSIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.TENSE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Tense));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.ACTION.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ActionVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.STATIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.StativeVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.TRANSITIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.TransitiveVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.INTRANSITIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.IntransitiveVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.AUXILIARY.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.AuxiliaryVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.MODAL.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ModalVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.PHRASAL.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PhrasalVerb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Verb), Relations.CONJUGATION.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Conjugation));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Tense), Relations.PAST.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PastTense));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Tense), Relations.PRESENT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PresentTense));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Tense), Relations.FUTURE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.FutureTense));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PastTense), Relations.SIMPLEPAST.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.SimpleAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PastTense), Relations.PERFECTPAST.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PastTense), Relations.PROGRESSIVEPAST.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PastTense), Relations.PERFECTPROGRESSIVEPAST.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PresentTense), Relations.SIMPLEPRESENT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.SimpleAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PresentTense), Relations.PROGRESSIVEPRESENT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PresentTense), Relations.PERFECTPRESENT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.PresentTense), Relations.PERFECTPROGRESSIVEPRESENT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.FutureTense), Relations.SIMPLEFUTURE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.SimpleAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.FutureTense), Relations.PERFECTFUTURE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.FutureTense), Relations.PROGRESSIVEFUTURE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.FutureTense), Relations.PERFECTPROGRESSIVEFUTURE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.PerfectProgressiveAspect));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.DECLARATIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.DeclarativeSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.IMPERATIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ImperativeSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.INTERROGATIVE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.InterrogativeSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.EXCLAMATORY.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ExclamatorySentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.COMPLEX.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.ComplexSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.COMPOUND.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.CompoundSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.SIMPLE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.SimpleSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.COMPOUNDCOMPLEX.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.CompoundComplexSentence));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.PREDICATE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Predicate));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Sentence), Relations.CLAUSE.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Clause));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Predicate), Relations.VERB.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Verb));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Clause), Relations.SUBJECT.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Subject));
		newDomainEntityRelation(getGraph(), entitiesNodeMap.get(Entities.Clause), Relations.VERB.name(), DomainPlugin.RelationCardinality.SINGLE, entitiesNodeMap.get(Entities.Verb));
   }
