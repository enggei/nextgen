...
public class WebappPatterns {
    ...
    public static ClassComponent loginPage(Map<String, ClassComponent> pageMap, MobXStore authStore, MaterialUIComponent loginForm, MaterialUIComponent copyright, MaterialUIComponent listErrors) {
        ...
        addPageEvent("handleSubmitForm", loginPage)
                .addParameters("e")
                .addStatements("e.preventDefault();")
                .addStatements("this.props.authStore.login().then(() => this.props.history.replace('/')).catch(e => { console.info(\"" + loginPage.getName() + ".handleSubmitForm.errors \" + e); });");
