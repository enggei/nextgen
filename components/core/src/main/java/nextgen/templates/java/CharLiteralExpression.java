...
public class CharLiteralExpression {
	...
	CharLiteralExpression(org.stringtemplate.v4.STGroup stGroup) {
	...
	public boolean equals(Object o) {
		...
		CharLiteralExpression that = (CharLiteralExpression) o;
	...
	public CharLiteralExpression setValue(Object value) {
		this._value = value;
		return this;
	}
