...
public class Rp {
	...
	Rp(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("rp");
	...
	public Rp setDatabind(Object value) {
	...
	public Rp removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Rp setAccesskey(Object value) {
	...
	public Rp removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Rp set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Rp remove_class() {
		this.__class = null;
		return this;
	} 

	public Rp setContenteditable(Object value) {
	...
	public Rp removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Rp setContextmenu(Object value) {
	...
	public Rp removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Rp setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Rp setDraggable(Object value) {
	...
	public Rp removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Rp setDropzone(Object value) {
	...
	public Rp removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Rp setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Rp removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Rp setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Rp setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Rp removeLang() {
		this._lang = null;
		return this;
	} 

	public Rp setSpellcheck(Object value) {
	...
	public Rp removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Rp setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Rp removeStyle() {
		this._style = null;
		return this;
	} 

	public Rp setTabindex(Object value) {
	...
	public Rp removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Rp setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Rp removeTitle() {
		this._title = null;
		return this;
	} 

	public Rp setTranslate(Object value) {
	...
	public Rp removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Rp addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Rp setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Rp setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Rp removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Rp removeContent(int index) {
	...
	public Rp addData(Object _name, Object _value) {
	...
	public Rp addData(Rp_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Rp_Data> streamData() {
		return this._data.stream().map(Rp_Data::new);
	}

	public static final class Rp_Data {

		Object _name;
		Object _value;

		public Rp_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Rp_Data(java.util.Map<String, Object> map) {
