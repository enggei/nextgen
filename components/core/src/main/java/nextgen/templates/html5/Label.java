...
public class Label {
	...
	public Label setFor(Object value) {
		this._for = value;
		return this;
	}
	...
	public Label removeFor() {
		this._for = null;
		return this;
	} 

	public Label setForm(Object value) {
		this._form = value;
		return this;
	}
	...
	public Label removeForm() {
		this._form = null;
		return this;
	} 

	public Label setDatabind(Object value) {
	...
	public Label removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Label setAccesskey(Object value) {
	...
	public Label removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Label set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Label remove_class() {
		this.__class = null;
		return this;
	} 

	public Label setContenteditable(Object value) {
	...
	public Label removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Label setContextmenu(Object value) {
	...
	public Label removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Label setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Label removeDir() {
		this._dir = null;
		return this;
	} 

	public Label setDraggable(Object value) {
	...
	public Label removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Label setDropzone(Object value) {
	...
	public Label removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Label setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Label removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Label setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Label removeId() {
		this._id = null;
		return this;
	} 

	public Label setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Label removeLang() {
		this._lang = null;
		return this;
	} 

	public Label setSpellcheck(Object value) {
	...
	public Label removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Label setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Label removeStyle() {
		this._style = null;
		return this;
	} 

	public Label setTabindex(Object value) {
	...
	public Label removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Label setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Label removeTitle() {
		this._title = null;
		return this;
	} 

	public Label setTranslate(Object value) {
	...
	public Label removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Label addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Label setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Label setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Label removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Label removeContent(int index) {
	...
	public Label addData(Object _name, Object _value) {
	...
	public Label addData(Label_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Label_Data> streamData() {
		return this._data.stream().map(Label_Data::new);
	}

	public static final class Label_Data {

		Object _name;
		Object _value;

		public Label_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Label_Data(java.util.Map<String, Object> map) {
