...
public class Strong {
	...
	Strong(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("strong");
	...
	public Strong setDatabind(Object value) {
	...
	public Strong removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Strong setAccesskey(Object value) {
	...
	public Strong removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Strong set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Strong remove_class() {
		this.__class = null;
		return this;
	} 

	public Strong setContenteditable(Object value) {
	...
	public Strong removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Strong setContextmenu(Object value) {
	...
	public Strong removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Strong setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Strong removeDir() {
		this._dir = null;
		return this;
	} 

	public Strong setDraggable(Object value) {
	...
	public Strong removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Strong setDropzone(Object value) {
	...
	public Strong removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Strong setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Strong removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Strong setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Strong removeId() {
		this._id = null;
		return this;
	} 

	public Strong setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Strong removeLang() {
		this._lang = null;
		return this;
	} 

	public Strong setSpellcheck(Object value) {
	...
	public Strong removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Strong setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Strong removeStyle() {
		this._style = null;
		return this;
	} 

	public Strong setTabindex(Object value) {
	...
	public Strong removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Strong setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Strong removeTitle() {
		this._title = null;
		return this;
	} 

	public Strong setTranslate(Object value) {
	...
	public Strong removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Strong addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Strong setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Strong setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Strong removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Strong removeContent(int index) {
	...
	public Strong addData(Object _name, Object _value) {
	...
	public Strong addData(Strong_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Strong_Data> streamData() {
		return this._data.stream().map(Strong_Data::new);
	}

	public static final class Strong_Data {

		Object _name;
		Object _value;

		public Strong_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Strong_Data(java.util.Map<String, Object> map) {
