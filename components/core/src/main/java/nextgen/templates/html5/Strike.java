...
public class Strike {
	...
	Strike(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("strike");
	...
	public Strike setDatabind(Object value) {
	...
	public Strike removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Strike setAccesskey(Object value) {
	...
	public Strike removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Strike set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Strike remove_class() {
		this.__class = null;
		return this;
	} 

	public Strike setContenteditable(Object value) {
	...
	public Strike removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Strike setContextmenu(Object value) {
	...
	public Strike removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Strike setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Strike removeDir() {
		this._dir = null;
		return this;
	} 

	public Strike setDraggable(Object value) {
	...
	public Strike removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Strike setDropzone(Object value) {
	...
	public Strike removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Strike setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Strike removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Strike setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Strike removeId() {
		this._id = null;
		return this;
	} 

	public Strike setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Strike removeLang() {
		this._lang = null;
		return this;
	} 

	public Strike setSpellcheck(Object value) {
	...
	public Strike removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Strike setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Strike removeStyle() {
		this._style = null;
		return this;
	} 

	public Strike setTabindex(Object value) {
	...
	public Strike removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Strike setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Strike removeTitle() {
		this._title = null;
		return this;
	} 

	public Strike setTranslate(Object value) {
	...
	public Strike removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Strike addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Strike setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Strike setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Strike removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Strike removeContent(int index) {
	...
	public Strike addData(Object _name, Object _value) {
	...
	public Strike addData(Strike_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Strike_Data> streamData() {
		return this._data.stream().map(Strike_Data::new);
	}

	public static final class Strike_Data {

		Object _name;
		Object _value;

		public Strike_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Strike_Data(java.util.Map<String, Object> map) {
