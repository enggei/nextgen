...
public class Section {
	...
	Section(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("section");
	...
	public Section setDatabind(Object value) {
	...
	public Section removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Section setAccesskey(Object value) {
	...
	public Section removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Section set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Section remove_class() {
		this.__class = null;
		return this;
	} 

	public Section setContenteditable(Object value) {
	...
	public Section removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Section setContextmenu(Object value) {
	...
	public Section removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Section setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Section removeDir() {
		this._dir = null;
		return this;
	} 

	public Section setDraggable(Object value) {
	...
	public Section removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Section setDropzone(Object value) {
	...
	public Section removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Section setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Section removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Section setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Section removeId() {
		this._id = null;
		return this;
	} 

	public Section setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Section removeLang() {
		this._lang = null;
		return this;
	} 

	public Section setSpellcheck(Object value) {
	...
	public Section removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Section setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Section removeStyle() {
		this._style = null;
		return this;
	} 

	public Section setTabindex(Object value) {
	...
	public Section removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Section setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Section removeTitle() {
		this._title = null;
		return this;
	} 

	public Section setTranslate(Object value) {
	...
	public Section removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Section addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Section setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Section setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Section removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Section removeContent(int index) {
	...
	public Section addData(Object _name, Object _value) {
	...
	public Section addData(Section_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Section_Data> streamData() {
		return this._data.stream().map(Section_Data::new);
	}

	public static final class Section_Data {

		Object _name;
		Object _value;

		public Section_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Section_Data(java.util.Map<String, Object> map) {
