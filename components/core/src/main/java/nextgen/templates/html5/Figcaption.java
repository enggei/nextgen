...
public class Figcaption {
	...
	Figcaption(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("figcaption");
	...
	public Figcaption setDatabind(Object value) {
	...
	public Figcaption removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Figcaption setAccesskey(Object value) {
	...
	public Figcaption removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Figcaption set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Figcaption remove_class() {
		this.__class = null;
		return this;
	} 

	public Figcaption setContenteditable(Object value) {
	...
	public Figcaption removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Figcaption setContextmenu(Object value) {
	...
	public Figcaption removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Figcaption setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Figcaption removeDir() {
		this._dir = null;
		return this;
	} 

	public Figcaption setDraggable(Object value) {
	...
	public Figcaption removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Figcaption setDropzone(Object value) {
	...
	public Figcaption removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Figcaption setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Figcaption removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Figcaption setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Figcaption removeId() {
		this._id = null;
		return this;
	} 

	public Figcaption setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Figcaption removeLang() {
		this._lang = null;
		return this;
	} 

	public Figcaption setSpellcheck(Object value) {
	...
	public Figcaption removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Figcaption setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Figcaption removeStyle() {
		this._style = null;
		return this;
	} 

	public Figcaption setTabindex(Object value) {
	...
	public Figcaption removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Figcaption setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Figcaption removeTitle() {
		this._title = null;
		return this;
	} 

	public Figcaption setTranslate(Object value) {
	...
	public Figcaption removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Figcaption addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Figcaption setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Figcaption setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Figcaption removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Figcaption removeContent(int index) {
	...
	public Figcaption addData(Object _name, Object _value) {
	...
	public Figcaption addData(Figcaption_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Figcaption_Data> streamData() {
		return this._data.stream().map(Figcaption_Data::new);
	}

	public static final class Figcaption_Data {

		Object _name;
		Object _value;

		public Figcaption_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Figcaption_Data(java.util.Map<String, Object> map) {
