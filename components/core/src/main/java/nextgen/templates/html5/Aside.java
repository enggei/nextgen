...
public class Aside {
	...
	Aside(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("aside");
	...
	public Aside setDatabind(Object value) {
	...
	public Aside removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Aside setAccesskey(Object value) {
	...
	public Aside removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Aside set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Aside remove_class() {
		this.__class = null;
		return this;
	} 

	public Aside setContenteditable(Object value) {
	...
	public Aside removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Aside setContextmenu(Object value) {
	...
	public Aside removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Aside setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Aside removeDir() {
		this._dir = null;
		return this;
	} 

	public Aside setDraggable(Object value) {
	...
	public Aside removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Aside setDropzone(Object value) {
	...
	public Aside removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Aside setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Aside removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Aside setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Aside removeId() {
		this._id = null;
		return this;
	} 

	public Aside setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Aside removeLang() {
		this._lang = null;
		return this;
	} 

	public Aside setSpellcheck(Object value) {
	...
	public Aside removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Aside setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Aside removeStyle() {
		this._style = null;
		return this;
	} 

	public Aside setTabindex(Object value) {
	...
	public Aside removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Aside setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Aside removeTitle() {
		this._title = null;
		return this;
	} 

	public Aside setTranslate(Object value) {
	...
	public Aside removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Aside addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Aside setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Aside setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Aside removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Aside removeContent(int index) {
	...
	public Aside addData(Object _name, Object _value) {
	...
	public Aside addData(Aside_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Aside_Data> streamData() {
		return this._data.stream().map(Aside_Data::new);
	}

	public static final class Aside_Data {

		Object _name;
		Object _value;

		public Aside_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Aside_Data(java.util.Map<String, Object> map) {
