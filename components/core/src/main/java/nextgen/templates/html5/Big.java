...
public class Big {
	...
	Big(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("big");
	...
	public Big setDatabind(Object value) {
	...
	public Big removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Big setAccesskey(Object value) {
	...
	public Big removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Big set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Big remove_class() {
		this.__class = null;
		return this;
	} 

	public Big setContenteditable(Object value) {
	...
	public Big removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Big setContextmenu(Object value) {
	...
	public Big removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Big setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Big removeDir() {
		this._dir = null;
		return this;
	} 

	public Big setDraggable(Object value) {
	...
	public Big removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Big setDropzone(Object value) {
	...
	public Big removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Big setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Big removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Big setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Big setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Big removeLang() {
		this._lang = null;
		return this;
	} 

	public Big setSpellcheck(Object value) {
	...
	public Big removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Big setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Big removeStyle() {
		this._style = null;
		return this;
	} 

	public Big setTabindex(Object value) {
	...
	public Big removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Big setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Big removeTitle() {
		this._title = null;
		return this;
	} 

	public Big setTranslate(Object value) {
	...
	public Big removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Big addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Big setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Big setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Big removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Big removeContent(int index) {
	...
	public Big addData(Object _name, Object _value) {
	...
	public Big addData(Big_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Big_Data> streamData() {
		return this._data.stream().map(Big_Data::new);
	}

	public static final class Big_Data {

		Object _name;
		Object _value;

		public Big_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Big_Data(java.util.Map<String, Object> map) {
