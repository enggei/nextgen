...
public class Address {
	...
	Address(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("address");
	...
	public Address setDatabind(Object value) {
	...
	public Address removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Address setAccesskey(Object value) {
	...
	public Address removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Address set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Address remove_class() {
		this.__class = null;
		return this;
	} 

	public Address setContenteditable(Object value) {
	...
	public Address removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Address setContextmenu(Object value) {
	...
	public Address removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Address setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Address removeDir() {
		this._dir = null;
		return this;
	} 

	public Address setDraggable(Object value) {
	...
	public Address removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Address setDropzone(Object value) {
	...
	public Address removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Address setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Address removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Address setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Address setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Address removeLang() {
		this._lang = null;
		return this;
	} 

	public Address setSpellcheck(Object value) {
	...
	public Address removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Address setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Address removeStyle() {
		this._style = null;
		return this;
	} 

	public Address setTabindex(Object value) {
	...
	public Address removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Address setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Address removeTitle() {
		this._title = null;
		return this;
	} 

	public Address setTranslate(Object value) {
	...
	public Address removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Address addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Address setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Address setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Address removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Address removeContent(int index) {
	...
	public Address addData(Object _name, Object _value) {
	...
	public Address addData(Address_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Address_Data> streamData() {
		return this._data.stream().map(Address_Data::new);
	}

	public static final class Address_Data {

		Object _name;
		Object _value;

		public Address_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Address_Data(java.util.Map<String, Object> map) {
