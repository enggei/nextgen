...
public class Thead {
	...
	Thead(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("thead");
	...
	public Thead setDatabind(Object value) {
	...
	public Thead removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Thead setAccesskey(Object value) {
	...
	public Thead removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Thead set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Thead remove_class() {
		this.__class = null;
		return this;
	} 

	public Thead setContenteditable(Object value) {
	...
	public Thead removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Thead setContextmenu(Object value) {
	...
	public Thead removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Thead setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Thead removeDir() {
		this._dir = null;
		return this;
	} 

	public Thead setDraggable(Object value) {
	...
	public Thead removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Thead setDropzone(Object value) {
	...
	public Thead removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Thead setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Thead removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Thead setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Thead removeId() {
		this._id = null;
		return this;
	} 

	public Thead setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Thead removeLang() {
		this._lang = null;
		return this;
	} 

	public Thead setSpellcheck(Object value) {
	...
	public Thead removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Thead setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Thead removeStyle() {
		this._style = null;
		return this;
	} 

	public Thead setTabindex(Object value) {
	...
	public Thead removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Thead setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Thead removeTitle() {
		this._title = null;
		return this;
	} 

	public Thead setTranslate(Object value) {
	...
	public Thead removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Thead addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Thead setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Thead setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Thead removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Thead removeContent(int index) {
	...
	public Thead addData(Object _name, Object _value) {
	...
	public Thead addData(Thead_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Thead_Data> streamData() {
		return this._data.stream().map(Thead_Data::new);
	}

	public static final class Thead_Data {

		Object _name;
		Object _value;

		public Thead_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Thead_Data(java.util.Map<String, Object> map) {
