...
public class Bdi {
	...
	Bdi(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("bdi");
	...
	public Bdi setDatabind(Object value) {
	...
	public Bdi removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Bdi setAccesskey(Object value) {
	...
	public Bdi removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Bdi set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Bdi remove_class() {
		this.__class = null;
		return this;
	} 

	public Bdi setContenteditable(Object value) {
	...
	public Bdi removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Bdi setContextmenu(Object value) {
	...
	public Bdi removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Bdi setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Bdi removeDir() {
		this._dir = null;
		return this;
	} 

	public Bdi setDraggable(Object value) {
	...
	public Bdi removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Bdi setDropzone(Object value) {
	...
	public Bdi removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Bdi setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Bdi removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Bdi setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Bdi setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Bdi removeLang() {
		this._lang = null;
		return this;
	} 

	public Bdi setSpellcheck(Object value) {
	...
	public Bdi removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Bdi setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Bdi removeStyle() {
		this._style = null;
		return this;
	} 

	public Bdi setTabindex(Object value) {
	...
	public Bdi removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Bdi setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Bdi removeTitle() {
		this._title = null;
		return this;
	} 

	public Bdi setTranslate(Object value) {
	...
	public Bdi removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Bdi addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Bdi setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Bdi setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Bdi removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Bdi removeContent(int index) {
	...
	public Bdi addData(Object _name, Object _value) {
	...
	public Bdi addData(Bdi_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Bdi_Data> streamData() {
		return this._data.stream().map(Bdi_Data::new);
	}

	public static final class Bdi_Data {

		Object _name;
		Object _value;

		public Bdi_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Bdi_Data(java.util.Map<String, Object> map) {
