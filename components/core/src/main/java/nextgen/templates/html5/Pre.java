...
public class Pre {
	...
	Pre(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("pre");
	...
	public Pre setDatabind(Object value) {
	...
	public Pre removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Pre setAccesskey(Object value) {
	...
	public Pre removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Pre set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Pre remove_class() {
		this.__class = null;
		return this;
	} 

	public Pre setContenteditable(Object value) {
	...
	public Pre removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Pre setContextmenu(Object value) {
	...
	public Pre removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Pre setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Pre removeDir() {
		this._dir = null;
		return this;
	} 

	public Pre setDraggable(Object value) {
	...
	public Pre removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Pre setDropzone(Object value) {
	...
	public Pre removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Pre setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Pre removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Pre setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Pre setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Pre removeLang() {
		this._lang = null;
		return this;
	} 

	public Pre setSpellcheck(Object value) {
	...
	public Pre removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Pre setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Pre removeStyle() {
		this._style = null;
		return this;
	} 

	public Pre setTabindex(Object value) {
	...
	public Pre removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Pre setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Pre removeTitle() {
		this._title = null;
		return this;
	} 

	public Pre setTranslate(Object value) {
	...
	public Pre removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Pre addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Pre setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Pre setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Pre removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Pre removeContent(int index) {
	...
	public Pre addData(Object _name, Object _value) {
	...
	public Pre addData(Pre_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Pre_Data> streamData() {
		return this._data.stream().map(Pre_Data::new);
	}

	public static final class Pre_Data {

		Object _name;
		Object _value;

		public Pre_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Pre_Data(java.util.Map<String, Object> map) {
