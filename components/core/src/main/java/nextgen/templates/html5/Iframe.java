...
public class Iframe {
	...
	Iframe(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("iframe");
		st.add("height", _height);
		st.add("name", _name);
		st.add("sandbox", _sandbox);
		st.add("src", _src);
		st.add("srcdoc", _srcdoc);
		st.add("width", _width);
	...
	public Iframe setHeight(Object value) {
		this._height = value;
		return this;
	}
	...
	public Iframe removeHeight() {
		this._height = null;
		return this;
	} 

	public Iframe setName(Object value) {
		this._name = value;
		return this;
	}
	...
	public Iframe removeName() {
		this._name = null;
		return this;
	} 

	public Iframe setSandbox(Object value) {
		this._sandbox = value;
		return this;
	}
	...
	public Object getSandbox(Object defaultValue) {
		return this._sandbox == null ? defaultValue : this._sandbox;
	}
	...
	public Iframe removeSandbox() {
		this._sandbox = null;
		return this;
	} 

	public Iframe setSrc(Object value) {
		this._src = value;
		return this;
	}
	...
	public Iframe removeSrc() {
		this._src = null;
		return this;
	} 

	public Iframe setSrcdoc(Object value) {
		this._srcdoc = value;
		return this;
	}

	public Object getSrcdoc() {
		return this._srcdoc;
	}

	public Object getSrcdoc(Object defaultValue) {
		return this._srcdoc == null ? defaultValue : this._srcdoc;
	}

	public boolean hasSrcdoc() {
		return this._srcdoc != null;
	}

	public Iframe removeSrcdoc() {
		this._srcdoc = null;
		return this;
	} 

	public Iframe setWidth(Object value) {
		this._width = value;
		return this;
	}
	...
	public Iframe removeWidth() {
		this._width = null;
		return this;
	} 

	public Iframe setDatabind(Object value) {
	...
	public Iframe removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Iframe setAccesskey(Object value) {
	...
	public Iframe removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Iframe set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Iframe remove_class() {
		this.__class = null;
		return this;
	} 

	public Iframe setContenteditable(Object value) {
	...
	public Iframe removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Iframe setContextmenu(Object value) {
	...
	public Iframe removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Iframe setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Iframe removeDir() {
		this._dir = null;
		return this;
	} 

	public Iframe setDraggable(Object value) {
	...
	public Iframe removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Iframe setDropzone(Object value) {
	...
	public Iframe removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Iframe setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Iframe removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Iframe setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Iframe removeId() {
		this._id = null;
		return this;
	} 

	public Iframe setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Iframe removeLang() {
		this._lang = null;
		return this;
	} 

	public Iframe setSpellcheck(Object value) {
	...
	public Iframe removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Iframe setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Iframe removeStyle() {
		this._style = null;
		return this;
	} 

	public Iframe setTabindex(Object value) {
	...
	public Iframe removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Iframe setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Iframe removeTitle() {
		this._title = null;
		return this;
	} 

	public Iframe setTranslate(Object value) {
	...
	public Iframe removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Iframe addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Iframe setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Iframe setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Iframe removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Iframe removeContent(int index) {
	...
	public Iframe addData(Object _name, Object _value) {
	...
	public Iframe addData(Iframe_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Iframe_Data> streamData() {
		return this._data.stream().map(Iframe_Data::new);
	}

	public static final class Iframe_Data {

		Object _name;
		Object _value;

		public Iframe_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Iframe_Data(java.util.Map<String, Object> map) {
