...
public class Th {
	...
	Th(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("th");
		st.add("abbr", _abbr);
		st.add("colspan", _colspan);
		st.add("headers", _headers);
		st.add("rowspan", _rowspan);
		st.add("scope", _scope);
		st.add("sorted", _sorted);
	...
	public Th setAbbr(Object value) {
		this._abbr = value;
		return this;
	}
	...
	public Object getAbbr(Object defaultValue) {
		return this._abbr == null ? defaultValue : this._abbr;
	}

	public boolean hasAbbr() {
		return this._abbr != null;
	}

	public Th removeAbbr() {
		this._abbr = null;
		return this;
	} 

	public Th setColspan(Object value) {
		this._colspan = value;
		return this;
	}
	...
	public Th removeColspan() {
		this._colspan = null;
		return this;
	} 

	public Th setHeaders(Object value) {
		this._headers = value;
		return this;
	}
	...
	public Th removeHeaders() {
		this._headers = null;
		return this;
	} 

	public Th setRowspan(Object value) {
		this._rowspan = value;
		return this;
	}
	...
	public Th removeRowspan() {
		this._rowspan = null;
		return this;
	} 

	public Th setScope(Object value) {
		this._scope = value;
		return this;
	}
	...
	public Th removeScope() {
		this._scope = null;
		return this;
	} 

	public Th setSorted(Object value) {
		this._sorted = value;
		return this;
	}
	...
	public Object getSorted(Object defaultValue) {
		return this._sorted == null ? defaultValue : this._sorted;
	}
	...
	public Th removeSorted() {
		this._sorted = null;
		return this;
	} 

	public Th setDatabind(Object value) {
	...
	public Th removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Th setAccesskey(Object value) {
	...
	public Th removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Th set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Th remove_class() {
		this.__class = null;
		return this;
	} 

	public Th setContenteditable(Object value) {
	...
	public Th removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Th setContextmenu(Object value) {
	...
	public Th removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Th setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Th setDraggable(Object value) {
	...
	public Th removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Th setDropzone(Object value) {
	...
	public Th removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Th setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Th removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Th setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Th setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Th removeLang() {
		this._lang = null;
		return this;
	} 

	public Th setSpellcheck(Object value) {
	...
	public Th removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Th setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Th removeStyle() {
		this._style = null;
		return this;
	} 

	public Th setTabindex(Object value) {
	...
	public Th removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Th setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Th removeTitle() {
		this._title = null;
		return this;
	} 

	public Th setTranslate(Object value) {
	...
	public Th removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Th addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Th setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Th setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Th removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Th removeContent(int index) {
	...
	public Th addData(Object _name, Object _value) {
	...
	public Th addData(Th_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Th_Data> streamData() {
		return this._data.stream().map(Th_Data::new);
	}

	public static final class Th_Data {

		Object _name;
		Object _value;

		public Th_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Th_Data(java.util.Map<String, Object> map) {
