...
public class Track {
	...
	Track(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("track");
		st.add("default_", _default_);
		st.add("kind", _kind);
		st.add("label", _label);
		st.add("src", _src);
		st.add("srclang", _srclang);
	...
	public Track setDefault_(Object value) {
	...
	public Track removeDefault_() {
		this._default_ = null;
		return this;
	} 

	public Track setKind(Object value) {
		this._kind = value;
		return this;
	}
	...
	public Object getKind(Object defaultValue) {
		return this._kind == null ? defaultValue : this._kind;
	}
	...
	public Track removeKind() {
		this._kind = null;
		return this;
	} 

	public Track setLabel(Object value) {
		this._label = value;
		return this;
	}
	...
	public Track removeLabel() {
		this._label = null;
		return this;
	} 

	public Track setSrc(Object value) {
		this._src = value;
		return this;
	}
	...
	public Track removeSrc() {
		this._src = null;
		return this;
	} 

	public Track setSrclang(Object value) {
		this._srclang = value;
		return this;
	}

	public Object getSrclang() {
		return this._srclang;
	}

	public Object getSrclang(Object defaultValue) {
		return this._srclang == null ? defaultValue : this._srclang;
	}

	public boolean hasSrclang() {
		return this._srclang != null;
	}

	public Track removeSrclang() {
		this._srclang = null;
		return this;
	} 

	public Track setDatabind(Object value) {
	...
	public Track removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Track setAccesskey(Object value) {
	...
	public Track removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Track set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Track remove_class() {
		this.__class = null;
		return this;
	} 

	public Track setContenteditable(Object value) {
	...
	public Track removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Track setContextmenu(Object value) {
	...
	public Track removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Track setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Track removeDir() {
		this._dir = null;
		return this;
	} 

	public Track setDraggable(Object value) {
	...
	public Track removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Track setDropzone(Object value) {
	...
	public Track removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Track setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Track removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Track setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Track removeId() {
		this._id = null;
		return this;
	} 

	public Track setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Track removeLang() {
		this._lang = null;
		return this;
	} 

	public Track setSpellcheck(Object value) {
	...
	public Track removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Track setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Track removeStyle() {
		this._style = null;
		return this;
	} 

	public Track setTabindex(Object value) {
	...
	public Track removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Track setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Track removeTitle() {
		this._title = null;
		return this;
	} 

	public Track setTranslate(Object value) {
	...
	public Track removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Track addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Track setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Track setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Track removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Track removeContent(int index) {
	...
	public Track addData(Object _name, Object _value) {
	...
	public Track addData(Track_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Track_Data> streamData() {
		return this._data.stream().map(Track_Data::new);
	}

	public static final class Track_Data {

		Object _name;
		Object _value;

		public Track_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Track_Data(java.util.Map<String, Object> map) {
