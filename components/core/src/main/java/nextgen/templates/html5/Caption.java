...
public class Caption {
	...
	Caption(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("caption");
	...
	public Caption setDatabind(Object value) {
	...
	public Caption removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Caption setAccesskey(Object value) {
	...
	public Caption removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Caption set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Caption remove_class() {
		this.__class = null;
		return this;
	} 

	public Caption setContenteditable(Object value) {
	...
	public Caption removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Caption setContextmenu(Object value) {
	...
	public Caption removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Caption setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Caption removeDir() {
		this._dir = null;
		return this;
	} 

	public Caption setDraggable(Object value) {
	...
	public Caption removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Caption setDropzone(Object value) {
	...
	public Caption removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Caption setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Caption removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Caption setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Caption removeId() {
		this._id = null;
		return this;
	} 

	public Caption setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Caption removeLang() {
		this._lang = null;
		return this;
	} 

	public Caption setSpellcheck(Object value) {
	...
	public Caption removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Caption setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Caption removeStyle() {
		this._style = null;
		return this;
	} 

	public Caption setTabindex(Object value) {
	...
	public Caption removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Caption setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Caption removeTitle() {
		this._title = null;
		return this;
	} 

	public Caption setTranslate(Object value) {
	...
	public Caption removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Caption addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Caption setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Caption setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Caption removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Caption removeContent(int index) {
	...
	public Caption addData(Object _name, Object _value) {
	...
	public Caption addData(Caption_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Caption_Data> streamData() {
		return this._data.stream().map(Caption_Data::new);
	}

	public static final class Caption_Data {

		Object _name;
		Object _value;

		public Caption_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Caption_Data(java.util.Map<String, Object> map) {
