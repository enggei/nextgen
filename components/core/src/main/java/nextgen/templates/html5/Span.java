...
public class Span {
	...
	Span(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("span");
	...
	public Span setDatabind(Object value) {
	...
	public Span removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Span setAccesskey(Object value) {
	...
	public Span removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Span set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Span remove_class() {
		this.__class = null;
		return this;
	} 

	public Span setContenteditable(Object value) {
	...
	public Span removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Span setContextmenu(Object value) {
	...
	public Span removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Span setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Span removeDir() {
		this._dir = null;
		return this;
	} 

	public Span setDraggable(Object value) {
	...
	public Span removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Span setDropzone(Object value) {
	...
	public Span removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Span setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Span removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Span setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Span removeId() {
		this._id = null;
		return this;
	} 

	public Span setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Span removeLang() {
		this._lang = null;
		return this;
	} 

	public Span setSpellcheck(Object value) {
	...
	public Span removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Span setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Span removeStyle() {
		this._style = null;
		return this;
	} 

	public Span setTabindex(Object value) {
	...
	public Span removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Span setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Span removeTitle() {
		this._title = null;
		return this;
	} 

	public Span setTranslate(Object value) {
	...
	public Span removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Span addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Span setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Span setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Span removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Span removeContent(int index) {
	...
	public Span addData(Object _name, Object _value) {
	...
	public Span addData(Span_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Span_Data> streamData() {
		return this._data.stream().map(Span_Data::new);
	}

	public static final class Span_Data {

		Object _name;
		Object _value;

		public Span_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Span_Data(java.util.Map<String, Object> map) {
