...
public class Meta {
	...
	Meta(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("meta");
		st.add("charset", _charset);
		st.add("http_equiv", _http_equiv);
		st.add("name", _name);
	...
	public Meta setCharset(Object value) {
		this._charset = value;
		return this;
	}
	...
	public Meta removeCharset() {
		this._charset = null;
		return this;
	} 

	public Meta setHttp_equiv(Object value) {
		this._http_equiv = value;
		return this;
	}

	public Object getHttp_equiv() {
		return this._http_equiv;
	}

	public Object getHttp_equiv(Object defaultValue) {
		return this._http_equiv == null ? defaultValue : this._http_equiv;
	}

	public boolean hasHttp_equiv() {
		return this._http_equiv != null;
	}

	public Meta removeHttp_equiv() {
		this._http_equiv = null;
		return this;
	} 

	public Meta setName(Object value) {
		this._name = value;
		return this;
	}
	...
	public Meta removeName() {
		this._name = null;
		return this;
	} 

	public Meta setDatabind(Object value) {
	...
	public Meta removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Meta setAccesskey(Object value) {
	...
	public Meta removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Meta set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Meta remove_class() {
		this.__class = null;
		return this;
	} 

	public Meta setContenteditable(Object value) {
	...
	public Meta removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Meta setContextmenu(Object value) {
	...
	public Meta removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Meta setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Meta removeDir() {
		this._dir = null;
		return this;
	} 

	public Meta setDraggable(Object value) {
	...
	public Meta removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Meta setDropzone(Object value) {
	...
	public Meta removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Meta setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Meta removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Meta setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Meta removeId() {
		this._id = null;
		return this;
	} 

	public Meta setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Meta removeLang() {
		this._lang = null;
		return this;
	} 

	public Meta setSpellcheck(Object value) {
	...
	public Meta removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Meta setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Meta removeStyle() {
		this._style = null;
		return this;
	} 

	public Meta setTabindex(Object value) {
	...
	public Meta removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Meta setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Meta removeTitle() {
		this._title = null;
		return this;
	} 

	public Meta setTranslate(Object value) {
	...
	public Meta removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Meta addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Meta setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Meta setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Meta removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Meta removeContent(int index) {
	...
	public Meta addData(Object _name, Object _value) {
	...
	public Meta addData(Meta_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Meta_Data> streamData() {
		return this._data.stream().map(Meta_Data::new);
	}
	...
	public static final class Meta_Data {
		...
		public Meta_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Meta_Data(java.util.Map<String, Object> map) {
