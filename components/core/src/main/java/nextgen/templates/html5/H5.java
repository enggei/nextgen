...
public class H5 {
	...
	H5(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("h5");
	...
	public H5 setDatabind(Object value) {
	...
	public H5 removeDatabind() {
		this._databind = null;
		return this;
	} 

	public H5 setAccesskey(Object value) {
	...
	public H5 removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public H5 set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public H5 remove_class() {
		this.__class = null;
		return this;
	} 

	public H5 setContenteditable(Object value) {
	...
	public H5 removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public H5 setContextmenu(Object value) {
	...
	public H5 removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public H5 setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public H5 setDraggable(Object value) {
	...
	public H5 removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public H5 setDropzone(Object value) {
	...
	public H5 removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public H5 setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public H5 removeHidden() {
		this._hidden = null;
		return this;
	} 

	public H5 setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public H5 setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public H5 removeLang() {
		this._lang = null;
		return this;
	} 

	public H5 setSpellcheck(Object value) {
	...
	public H5 removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public H5 setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public H5 removeStyle() {
		this._style = null;
		return this;
	} 

	public H5 setTabindex(Object value) {
	...
	public H5 removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public H5 setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public H5 removeTitle() {
		this._title = null;
		return this;
	} 

	public H5 setTranslate(Object value) {
	...
	public H5 removeTranslate() {
		this._translate = null;
		return this;
	} 

	public H5 addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public H5 setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public H5 setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public H5 removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public H5 removeContent(int index) {
	...
	public H5 addData(Object _name, Object _value) {
	...
	public H5 addData(H5_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<H5_Data> streamData() {
		return this._data.stream().map(H5_Data::new);
	}

	public static final class H5_Data {

		Object _name;
		Object _value;

		public H5_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private H5_Data(java.util.Map<String, Object> map) {
