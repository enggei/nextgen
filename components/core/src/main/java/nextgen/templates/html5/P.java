...
public class P {
	...
	P(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("p");
	...
	public P setDatabind(Object value) {
	...
	public P removeDatabind() {
		this._databind = null;
		return this;
	} 

	public P setAccesskey(Object value) {
	...
	public P removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public P set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public P remove_class() {
		this.__class = null;
		return this;
	} 

	public P setContenteditable(Object value) {
	...
	public P removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public P setContextmenu(Object value) {
	...
	public P removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public P setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public P setDraggable(Object value) {
	...
	public P removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public P setDropzone(Object value) {
	...
	public P removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public P setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public P removeHidden() {
		this._hidden = null;
		return this;
	} 

	public P setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public P setSpellcheck(Object value) {
	...
	public P removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public P setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public P removeStyle() {
		this._style = null;
		return this;
	} 

	public P setTabindex(Object value) {
	...
	public P removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public P setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public P removeTitle() {
		this._title = null;
		return this;
	} 

	public P setTranslate(Object value) {
	...
	public P removeTranslate() {
		this._translate = null;
		return this;
	} 

	public P addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public P setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public P setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public P removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public P removeContent(int index) {
	...
	public P addData(Object _name, Object _value) {
	...
	public P addData(P_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<P_Data> streamData() {
		return this._data.stream().map(P_Data::new);
	}

	public static final class P_Data {

		Object _name;
		Object _value;

		public P_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private P_Data(java.util.Map<String, Object> map) {
