...
public class Ol {
	...
	Ol(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("ol");
		st.add("reversed", _reversed);
		st.add("start", _start);
		st.add("type", _type);
	...
	public Ol setReversed(Object value) {
	...
	public Object getReversed(Object defaultValue) {
		return this._reversed == null ? defaultValue : this._reversed;
	}

	public boolean hasReversed() {
		return this._reversed != null;
	}

	public Ol removeReversed() {
		this._reversed = null;
		return this;
	} 

	public Ol setStart(Object value) {
		this._start = value;
		return this;
	}
	...
	public Ol removeStart() {
		this._start = null;
		return this;
	} 

	public Ol setType(Object value) {
		this._type = value;
		return this;
	}
	...
	public Ol removeType() {
		this._type = null;
		return this;
	} 

	public Ol setDatabind(Object value) {
	...
	public Ol removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Ol setAccesskey(Object value) {
	...
	public Ol removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Ol set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Ol remove_class() {
		this.__class = null;
		return this;
	} 

	public Ol setContenteditable(Object value) {
	...
	public Ol removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Ol setContextmenu(Object value) {
	...
	public Ol removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Ol setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Ol setDraggable(Object value) {
	...
	public Ol removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Ol setDropzone(Object value) {
	...
	public Ol removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Ol setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Ol removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Ol setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Ol setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Ol removeLang() {
		this._lang = null;
		return this;
	} 

	public Ol setSpellcheck(Object value) {
	...
	public Ol removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Ol setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Ol removeStyle() {
		this._style = null;
		return this;
	} 

	public Ol setTabindex(Object value) {
	...
	public Ol removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Ol setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Ol removeTitle() {
		this._title = null;
		return this;
	} 

	public Ol setTranslate(Object value) {
	...
	public Ol removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Ol addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Ol setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Ol setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Ol removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Ol removeContent(int index) {
	...
	public Ol addData(Object _name, Object _value) {
	...
	public Ol addData(Ol_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Ol_Data> streamData() {
		return this._data.stream().map(Ol_Data::new);
	}

	public static final class Ol_Data {

		Object _name;
		Object _value;

		public Ol_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Ol_Data(java.util.Map<String, Object> map) {
