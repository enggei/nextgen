...
public class B {
	...
	B(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("b");
	...
	public B setDatabind(Object value) {
	...
	public B removeDatabind() {
		this._databind = null;
		return this;
	} 

	public B setAccesskey(Object value) {
	...
	public B removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public B set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public B remove_class() {
		this.__class = null;
		return this;
	} 

	public B setContenteditable(Object value) {
	...
	public B removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public B setContextmenu(Object value) {
	...
	public B removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public B setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public B setDraggable(Object value) {
	...
	public B removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public B setDropzone(Object value) {
	...
	public B removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public B setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public B setSpellcheck(Object value) {
	...
	public B removeStyle() {
		this._style = null;
		return this;
	} 

	public B setTabindex(Object value) {
	...
	public B removeTitle() {
		this._title = null;
		return this;
	} 

	public B setTranslate(Object value) {
	...
	public B removeTranslate() {
		this._translate = null;
		return this;
	} 

	public B addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public B setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public B setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public B removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public B removeContent(int index) {
	...
	public B addData(Object _name, Object _value) {
	...
	public B addData(B_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<B_Data> streamData() {
		return this._data.stream().map(B_Data::new);
	}

	public static final class B_Data {

		Object _name;
		Object _value;

		public B_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private B_Data(java.util.Map<String, Object> map) {
