...
public class Wbr {
	...
	Wbr(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("wbr");
	...
	public Wbr setDatabind(Object value) {
	...
	public Wbr removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Wbr setAccesskey(Object value) {
	...
	public Wbr removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Wbr set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Wbr remove_class() {
		this.__class = null;
		return this;
	} 

	public Wbr setContenteditable(Object value) {
	...
	public Wbr removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Wbr setContextmenu(Object value) {
	...
	public Wbr removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Wbr setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Wbr removeDir() {
		this._dir = null;
		return this;
	} 

	public Wbr setDraggable(Object value) {
	...
	public Wbr removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Wbr setDropzone(Object value) {
	...
	public Wbr removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Wbr setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Wbr removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Wbr setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Wbr setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Wbr removeLang() {
		this._lang = null;
		return this;
	} 

	public Wbr setSpellcheck(Object value) {
	...
	public Wbr removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Wbr setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Wbr removeStyle() {
		this._style = null;
		return this;
	} 

	public Wbr setTabindex(Object value) {
	...
	public Wbr removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Wbr setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Wbr removeTitle() {
		this._title = null;
		return this;
	} 

	public Wbr setTranslate(Object value) {
	...
	public Wbr removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Wbr addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Wbr setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Wbr setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Wbr removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Wbr removeContent(int index) {
	...
	public Wbr addData(Object _name, Object _value) {
	...
	public Wbr addData(Wbr_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Wbr_Data> streamData() {
		return this._data.stream().map(Wbr_Data::new);
	}

	public static final class Wbr_Data {

		Object _name;
		Object _value;

		public Wbr_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Wbr_Data(java.util.Map<String, Object> map) {
