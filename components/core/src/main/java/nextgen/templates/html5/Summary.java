...
public class Summary {
	...
	Summary(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("summary");
	...
	public Summary setDatabind(Object value) {
	...
	public Summary removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Summary setAccesskey(Object value) {
	...
	public Summary removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Summary set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Summary remove_class() {
		this.__class = null;
		return this;
	} 

	public Summary setContenteditable(Object value) {
	...
	public Summary removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Summary setContextmenu(Object value) {
	...
	public Summary removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Summary setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Summary removeDir() {
		this._dir = null;
		return this;
	} 

	public Summary setDraggable(Object value) {
	...
	public Summary removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Summary setDropzone(Object value) {
	...
	public Summary removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Summary setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Summary removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Summary setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Summary removeId() {
		this._id = null;
		return this;
	} 

	public Summary setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Summary removeLang() {
		this._lang = null;
		return this;
	} 

	public Summary setSpellcheck(Object value) {
	...
	public Summary removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Summary setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Summary removeStyle() {
		this._style = null;
		return this;
	} 

	public Summary setTabindex(Object value) {
	...
	public Summary removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Summary setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Summary removeTitle() {
		this._title = null;
		return this;
	} 

	public Summary setTranslate(Object value) {
	...
	public Summary removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Summary addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Summary setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Summary setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Summary removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Summary removeContent(int index) {
	...
	public Summary addData(Object _name, Object _value) {
	...
	public Summary addData(Summary_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Summary_Data> streamData() {
		return this._data.stream().map(Summary_Data::new);
	}

	public static final class Summary_Data {

		Object _name;
		Object _value;

		public Summary_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Summary_Data(java.util.Map<String, Object> map) {
