...
public class Ins {
	...
	Ins(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("ins");
		st.add("cite", _cite);
	...
	public Ins setCite(Object value) {
		this._cite = value;
		return this;
	}
	...
	public Ins removeCite() {
		this._cite = null;
		return this;
	} 

	public Ins setDatetime(Object value) {
	...
	public Ins removeDatetime() {
		this._datetime = null;
		return this;
	} 

	public Ins setDatabind(Object value) {
	...
	public Ins removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Ins setAccesskey(Object value) {
	...
	public Ins removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Ins set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Ins remove_class() {
		this.__class = null;
		return this;
	} 

	public Ins setContenteditable(Object value) {
	...
	public Ins removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Ins setContextmenu(Object value) {
	...
	public Ins removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Ins setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Ins removeDir() {
		this._dir = null;
		return this;
	} 

	public Ins setDraggable(Object value) {
	...
	public Ins removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Ins setDropzone(Object value) {
	...
	public Ins removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Ins setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Ins removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Ins setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Ins setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Ins removeLang() {
		this._lang = null;
		return this;
	} 

	public Ins setSpellcheck(Object value) {
	...
	public Ins removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Ins setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Ins removeStyle() {
		this._style = null;
		return this;
	} 

	public Ins setTabindex(Object value) {
	...
	public Ins removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Ins setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Ins removeTitle() {
		this._title = null;
		return this;
	} 

	public Ins setTranslate(Object value) {
	...
	public Ins removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Ins addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Ins setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Ins setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Ins removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Ins removeContent(int index) {
	...
	public Ins addData(Object _name, Object _value) {
	...
	public Ins addData(Ins_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Ins_Data> streamData() {
		return this._data.stream().map(Ins_Data::new);
	}

	public static final class Ins_Data {

		Object _name;
		Object _value;

		public Ins_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Ins_Data(java.util.Map<String, Object> map) {
