...
public class Figure {
	...
	Figure(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("figure");
	...
	public Figure setDatabind(Object value) {
	...
	public Figure removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Figure setAccesskey(Object value) {
	...
	public Figure removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Figure set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Figure remove_class() {
		this.__class = null;
		return this;
	} 

	public Figure setContenteditable(Object value) {
	...
	public Figure removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Figure setContextmenu(Object value) {
	...
	public Figure removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Figure setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Figure removeDir() {
		this._dir = null;
		return this;
	} 

	public Figure setDraggable(Object value) {
	...
	public Figure removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Figure setDropzone(Object value) {
	...
	public Figure removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Figure setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Figure removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Figure setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Figure removeId() {
		this._id = null;
		return this;
	} 

	public Figure setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Figure removeLang() {
		this._lang = null;
		return this;
	} 

	public Figure setSpellcheck(Object value) {
	...
	public Figure removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Figure setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Figure removeStyle() {
		this._style = null;
		return this;
	} 

	public Figure setTabindex(Object value) {
	...
	public Figure removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Figure setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Figure removeTitle() {
		this._title = null;
		return this;
	} 

	public Figure setTranslate(Object value) {
	...
	public Figure removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Figure addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Figure setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Figure setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Figure removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Figure removeContent(int index) {
	...
	public Figure addData(Object _name, Object _value) {
	...
	public Figure addData(Figure_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Figure_Data> streamData() {
		return this._data.stream().map(Figure_Data::new);
	}

	public static final class Figure_Data {

		Object _name;
		Object _value;

		public Figure_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Figure_Data(java.util.Map<String, Object> map) {
