...
public class Abbr {
	...
	Abbr(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("abbr");
	...
	public Abbr setDatabind(Object value) {
	...
	public Abbr removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Abbr setAccesskey(Object value) {
	...
	public Abbr removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Abbr set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Abbr remove_class() {
		this.__class = null;
		return this;
	} 

	public Abbr setContenteditable(Object value) {
	...
	public Abbr removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Abbr setContextmenu(Object value) {
	...
	public Abbr removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Abbr setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Abbr removeDir() {
		this._dir = null;
		return this;
	} 

	public Abbr setDraggable(Object value) {
	...
	public Abbr removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Abbr setDropzone(Object value) {
	...
	public Abbr removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Abbr setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Abbr removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Abbr setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Abbr removeId() {
		this._id = null;
		return this;
	} 

	public Abbr setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Abbr removeLang() {
		this._lang = null;
		return this;
	} 

	public Abbr setSpellcheck(Object value) {
	...
	public Abbr removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Abbr setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Abbr removeStyle() {
		this._style = null;
		return this;
	} 

	public Abbr setTabindex(Object value) {
	...
	public Abbr removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Abbr setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Abbr removeTitle() {
		this._title = null;
		return this;
	} 

	public Abbr setTranslate(Object value) {
	...
	public Abbr removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Abbr addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Abbr setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Abbr setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Abbr removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Abbr removeContent(int index) {
	...
	public Abbr addData(Object _name, Object _value) {
	...
	public Abbr addData(Abbr_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Abbr_Data> streamData() {
		return this._data.stream().map(Abbr_Data::new);
	}

	public static final class Abbr_Data {

		Object _name;
		Object _value;

		public Abbr_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Abbr_Data(java.util.Map<String, Object> map) {
