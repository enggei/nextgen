...
public class Noframes {
	...
	Noframes(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("noframes");
	...
	public Noframes setDatabind(Object value) {
	...
	public Noframes removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Noframes setAccesskey(Object value) {
	...
	public Noframes removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Noframes set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Noframes remove_class() {
		this.__class = null;
		return this;
	} 

	public Noframes setContenteditable(Object value) {
	...
	public Noframes removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Noframes setContextmenu(Object value) {
	...
	public Noframes removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Noframes setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Noframes removeDir() {
		this._dir = null;
		return this;
	} 

	public Noframes setDraggable(Object value) {
	...
	public Noframes removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Noframes setDropzone(Object value) {
	...
	public Noframes removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Noframes setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Noframes removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Noframes setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Noframes removeId() {
		this._id = null;
		return this;
	} 

	public Noframes setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Noframes removeLang() {
		this._lang = null;
		return this;
	} 

	public Noframes setSpellcheck(Object value) {
	...
	public Noframes removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Noframes setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Noframes removeStyle() {
		this._style = null;
		return this;
	} 

	public Noframes setTabindex(Object value) {
	...
	public Noframes removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Noframes setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Noframes removeTitle() {
		this._title = null;
		return this;
	} 

	public Noframes setTranslate(Object value) {
	...
	public Noframes removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Noframes addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Noframes setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Noframes setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Noframes removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Noframes removeContent(int index) {
	...
	public Noframes addData(Object _name, Object _value) {
	...
	public Noframes addData(Noframes_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Noframes_Data> streamData() {
		return this._data.stream().map(Noframes_Data::new);
	}

	public static final class Noframes_Data {

		Object _name;
		Object _value;

		public Noframes_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Noframes_Data(java.util.Map<String, Object> map) {
