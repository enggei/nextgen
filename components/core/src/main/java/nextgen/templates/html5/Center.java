...
public class Center {
	...
	Center(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("center");
	...
	public Center setDatabind(Object value) {
	...
	public Center removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Center setAccesskey(Object value) {
	...
	public Center removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Center set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Center remove_class() {
		this.__class = null;
		return this;
	} 

	public Center setContenteditable(Object value) {
	...
	public Center removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Center setContextmenu(Object value) {
	...
	public Center removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Center setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Center removeDir() {
		this._dir = null;
		return this;
	} 

	public Center setDraggable(Object value) {
	...
	public Center removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Center setDropzone(Object value) {
	...
	public Center removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Center setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Center removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Center setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Center removeId() {
		this._id = null;
		return this;
	} 

	public Center setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Center removeLang() {
		this._lang = null;
		return this;
	} 

	public Center setSpellcheck(Object value) {
	...
	public Center removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Center setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Center removeStyle() {
		this._style = null;
		return this;
	} 

	public Center setTabindex(Object value) {
	...
	public Center removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Center setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Center removeTitle() {
		this._title = null;
		return this;
	} 

	public Center setTranslate(Object value) {
	...
	public Center removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Center addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Center setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Center setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Center removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Center removeContent(int index) {
	...
	public Center addData(Object _name, Object _value) {
	...
	public Center addData(Center_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Center_Data> streamData() {
		return this._data.stream().map(Center_Data::new);
	}

	public static final class Center_Data {

		Object _name;
		Object _value;

		public Center_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Center_Data(java.util.Map<String, Object> map) {
