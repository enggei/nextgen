...
public class Blockquote {
	...
	Blockquote(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("blockquote");
		st.add("cite", _cite);
	...
	public Blockquote setCite(Object value) {
		this._cite = value;
		return this;
	}

	public Object getCite() {
		return this._cite;
	}

	public Object getCite(Object defaultValue) {
		return this._cite == null ? defaultValue : this._cite;
	}

	public boolean hasCite() {
		return this._cite != null;
	}

	public Blockquote removeCite() {
		this._cite = null;
		return this;
	} 

	public Blockquote setDatabind(Object value) {
	...
	public Blockquote removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Blockquote setAccesskey(Object value) {
	...
	public Blockquote removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Blockquote set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Blockquote remove_class() {
		this.__class = null;
		return this;
	} 

	public Blockquote setContenteditable(Object value) {
	...
	public Blockquote removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Blockquote setContextmenu(Object value) {
	...
	public Blockquote removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Blockquote setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Blockquote removeDir() {
		this._dir = null;
		return this;
	} 

	public Blockquote setDraggable(Object value) {
	...
	public Blockquote removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Blockquote setDropzone(Object value) {
	...
	public Blockquote removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Blockquote setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Blockquote removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Blockquote setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Blockquote removeId() {
		this._id = null;
		return this;
	} 

	public Blockquote setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Blockquote removeLang() {
		this._lang = null;
		return this;
	} 

	public Blockquote setSpellcheck(Object value) {
	...
	public Blockquote removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Blockquote setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Blockquote removeStyle() {
		this._style = null;
		return this;
	} 

	public Blockquote setTabindex(Object value) {
	...
	public Blockquote removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Blockquote setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Blockquote removeTitle() {
		this._title = null;
		return this;
	} 

	public Blockquote setTranslate(Object value) {
	...
	public Blockquote removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Blockquote addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Blockquote setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Blockquote setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Blockquote removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Blockquote removeContent(int index) {
	...
	public Blockquote addData(Object _name, Object _value) {
	...
	public Blockquote addData(Blockquote_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Blockquote_Data> streamData() {
		return this._data.stream().map(Blockquote_Data::new);
	}

	public static final class Blockquote_Data {

		Object _name;
		Object _value;

		public Blockquote_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Blockquote_Data(java.util.Map<String, Object> map) {
