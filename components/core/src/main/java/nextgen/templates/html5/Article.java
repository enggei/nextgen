...
public class Article {
	...
	Article(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("article");
	...
	public Article setDatabind(Object value) {
	...
	public Article removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Article setAccesskey(Object value) {
	...
	public Article removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Article set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Article remove_class() {
		this.__class = null;
		return this;
	} 

	public Article setContenteditable(Object value) {
	...
	public Article removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Article setContextmenu(Object value) {
	...
	public Article removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Article setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Article removeDir() {
		this._dir = null;
		return this;
	} 

	public Article setDraggable(Object value) {
	...
	public Article removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Article setDropzone(Object value) {
	...
	public Article removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Article setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Article removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Article setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Article removeId() {
		this._id = null;
		return this;
	} 

	public Article setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Article removeLang() {
		this._lang = null;
		return this;
	} 

	public Article setSpellcheck(Object value) {
	...
	public Article removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Article setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Article removeStyle() {
		this._style = null;
		return this;
	} 

	public Article setTabindex(Object value) {
	...
	public Article removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Article setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Article removeTitle() {
		this._title = null;
		return this;
	} 

	public Article setTranslate(Object value) {
	...
	public Article removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Article addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Article setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Article setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Article removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Article removeContent(int index) {
	...
	public Article addData(Object _name, Object _value) {
	...
	public Article addData(Article_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Article_Data> streamData() {
		return this._data.stream().map(Article_Data::new);
	}

	public static final class Article_Data {

		Object _name;
		Object _value;

		public Article_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Article_Data(java.util.Map<String, Object> map) {
