...
public class I {
	...
	I(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("i");
	...
	public I setDatabind(Object value) {
	...
	public I removeDatabind() {
		this._databind = null;
		return this;
	} 

	public I setAccesskey(Object value) {
	...
	public I removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public I set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public I remove_class() {
		this.__class = null;
		return this;
	} 

	public I setContenteditable(Object value) {
	...
	public I removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public I setContextmenu(Object value) {
	...
	public I removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public I setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public I setDraggable(Object value) {
	...
	public I removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public I setDropzone(Object value) {
	...
	public I removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public I setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public I removeHidden() {
		this._hidden = null;
		return this;
	} 

	public I setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public I setSpellcheck(Object value) {
	...
	public I removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public I setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public I removeStyle() {
		this._style = null;
		return this;
	} 

	public I setTabindex(Object value) {
	...
	public I removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public I setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public I removeTitle() {
		this._title = null;
		return this;
	} 

	public I setTranslate(Object value) {
	...
	public I removeTranslate() {
		this._translate = null;
		return this;
	} 

	public I addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public I setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public I setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public I removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public I removeContent(int index) {
	...
	public I addData(Object _name, Object _value) {
	...
	public I addData(I_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<I_Data> streamData() {
		return this._data.stream().map(I_Data::new);
	}

	public static final class I_Data {

		Object _name;
		Object _value;

		public I_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private I_Data(java.util.Map<String, Object> map) {
