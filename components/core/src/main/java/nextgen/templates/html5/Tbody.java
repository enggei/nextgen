...
public class Tbody {
	...
	Tbody(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("tbody");
	...
	public Tbody setDatabind(Object value) {
	...
	public Tbody removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Tbody setAccesskey(Object value) {
	...
	public Tbody removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Tbody set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Tbody remove_class() {
		this.__class = null;
		return this;
	} 

	public Tbody setContenteditable(Object value) {
	...
	public Tbody removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Tbody setContextmenu(Object value) {
	...
	public Tbody removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Tbody setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Tbody removeDir() {
		this._dir = null;
		return this;
	} 

	public Tbody setDraggable(Object value) {
	...
	public Tbody removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Tbody setDropzone(Object value) {
	...
	public Tbody removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Tbody setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Tbody removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Tbody setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Tbody removeId() {
		this._id = null;
		return this;
	} 

	public Tbody setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Tbody removeLang() {
		this._lang = null;
		return this;
	} 

	public Tbody setSpellcheck(Object value) {
	...
	public Tbody removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Tbody setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Tbody removeStyle() {
		this._style = null;
		return this;
	} 

	public Tbody setTabindex(Object value) {
	...
	public Tbody removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Tbody setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Tbody removeTitle() {
		this._title = null;
		return this;
	} 

	public Tbody setTranslate(Object value) {
	...
	public Tbody removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Tbody addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Tbody setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Tbody setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Tbody removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Tbody removeContent(int index) {
	...
	public Tbody addData(Object _name, Object _value) {
	...
	public Tbody addData(Tbody_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Tbody_Data> streamData() {
		return this._data.stream().map(Tbody_Data::new);
	}

	public static final class Tbody_Data {

		Object _name;
		Object _value;

		public Tbody_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Tbody_Data(java.util.Map<String, Object> map) {
