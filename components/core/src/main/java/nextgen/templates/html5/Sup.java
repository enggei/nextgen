...
public class Sup {
	...
	Sup(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("sup");
	...
	public Sup setDatabind(Object value) {
	...
	public Sup removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Sup setAccesskey(Object value) {
	...
	public Sup removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Sup set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Sup remove_class() {
		this.__class = null;
		return this;
	} 

	public Sup setContenteditable(Object value) {
	...
	public Sup removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Sup setContextmenu(Object value) {
	...
	public Sup removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Sup setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Sup removeDir() {
		this._dir = null;
		return this;
	} 

	public Sup setDraggable(Object value) {
	...
	public Sup removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Sup setDropzone(Object value) {
	...
	public Sup removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Sup setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Sup removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Sup setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Sup setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Sup removeLang() {
		this._lang = null;
		return this;
	} 

	public Sup setSpellcheck(Object value) {
	...
	public Sup removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Sup setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Sup removeStyle() {
		this._style = null;
		return this;
	} 

	public Sup setTabindex(Object value) {
	...
	public Sup removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Sup setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Sup removeTitle() {
		this._title = null;
		return this;
	} 

	public Sup setTranslate(Object value) {
	...
	public Sup removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Sup addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Sup setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Sup setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Sup removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Sup removeContent(int index) {
	...
	public Sup addData(Object _name, Object _value) {
	...
	public Sup addData(Sup_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Sup_Data> streamData() {
		return this._data.stream().map(Sup_Data::new);
	}

	public static final class Sup_Data {

		Object _name;
		Object _value;

		public Sup_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Sup_Data(java.util.Map<String, Object> map) {
