...
public class Cite {
	...
	Cite(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("cite");
	...
	public Cite setDatabind(Object value) {
	...
	public Cite removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Cite setAccesskey(Object value) {
	...
	public Cite removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Cite set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Cite remove_class() {
		this.__class = null;
		return this;
	} 

	public Cite setContenteditable(Object value) {
	...
	public Cite removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Cite setContextmenu(Object value) {
	...
	public Cite removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Cite setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Cite removeDir() {
		this._dir = null;
		return this;
	} 

	public Cite setDraggable(Object value) {
	...
	public Cite removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Cite setDropzone(Object value) {
	...
	public Cite removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Cite setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Cite removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Cite setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Cite removeId() {
		this._id = null;
		return this;
	} 

	public Cite setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Cite removeLang() {
		this._lang = null;
		return this;
	} 

	public Cite setSpellcheck(Object value) {
	...
	public Cite removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Cite setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Cite removeStyle() {
		this._style = null;
		return this;
	} 

	public Cite setTabindex(Object value) {
	...
	public Cite removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Cite setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Cite removeTitle() {
		this._title = null;
		return this;
	} 

	public Cite setTranslate(Object value) {
	...
	public Cite removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Cite addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Cite setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Cite setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Cite removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Cite removeContent(int index) {
	...
	public Cite addData(Object _name, Object _value) {
	...
	public Cite addData(Cite_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Cite_Data> streamData() {
		return this._data.stream().map(Cite_Data::new);
	}

	public static final class Cite_Data {

		Object _name;
		Object _value;

		public Cite_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Cite_Data(java.util.Map<String, Object> map) {
