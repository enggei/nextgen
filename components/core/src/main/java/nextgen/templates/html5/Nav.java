...
public class Nav {
	...
	Nav(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("nav");
	...
	public Nav setDatabind(Object value) {
	...
	public Nav removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Nav setAccesskey(Object value) {
	...
	public Nav removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Nav set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Nav remove_class() {
		this.__class = null;
		return this;
	} 

	public Nav setContenteditable(Object value) {
	...
	public Nav removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Nav setContextmenu(Object value) {
	...
	public Nav removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Nav setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Nav removeDir() {
		this._dir = null;
		return this;
	} 

	public Nav setDraggable(Object value) {
	...
	public Nav removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Nav setDropzone(Object value) {
	...
	public Nav removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Nav setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Nav removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Nav setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Nav setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Nav removeLang() {
		this._lang = null;
		return this;
	} 

	public Nav setSpellcheck(Object value) {
	...
	public Nav removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Nav setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Nav removeStyle() {
		this._style = null;
		return this;
	} 

	public Nav setTabindex(Object value) {
	...
	public Nav removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Nav setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Nav removeTitle() {
		this._title = null;
		return this;
	} 

	public Nav setTranslate(Object value) {
	...
	public Nav removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Nav addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Nav setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Nav setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Nav removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Nav removeContent(int index) {
	...
	public Nav addData(Object _name, Object _value) {
	...
	public Nav addData(Nav_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Nav_Data> streamData() {
		return this._data.stream().map(Nav_Data::new);
	}

	public static final class Nav_Data {

		Object _name;
		Object _value;

		public Nav_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Nav_Data(java.util.Map<String, Object> map) {
