...
public class Legend {
	...
	Legend(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("legend");
	...
	public Legend setDatabind(Object value) {
	...
	public Legend removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Legend setAccesskey(Object value) {
	...
	public Legend removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Legend set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Legend remove_class() {
		this.__class = null;
		return this;
	} 

	public Legend setContenteditable(Object value) {
	...
	public Legend removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Legend setContextmenu(Object value) {
	...
	public Legend removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Legend setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Legend removeDir() {
		this._dir = null;
		return this;
	} 

	public Legend setDraggable(Object value) {
	...
	public Legend removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Legend setDropzone(Object value) {
	...
	public Legend removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Legend setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Legend removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Legend setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Legend removeId() {
		this._id = null;
		return this;
	} 

	public Legend setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Legend removeLang() {
		this._lang = null;
		return this;
	} 

	public Legend setSpellcheck(Object value) {
	...
	public Legend removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Legend setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Legend removeStyle() {
		this._style = null;
		return this;
	} 

	public Legend setTabindex(Object value) {
	...
	public Legend removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Legend setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Legend removeTitle() {
		this._title = null;
		return this;
	} 

	public Legend setTranslate(Object value) {
	...
	public Legend removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Legend addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Legend setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Legend setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Legend removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Legend removeContent(int index) {
	...
	public Legend addData(Object _name, Object _value) {
	...
	public Legend addData(Legend_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Legend_Data> streamData() {
		return this._data.stream().map(Legend_Data::new);
	}

	public static final class Legend_Data {

		Object _name;
		Object _value;

		public Legend_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Legend_Data(java.util.Map<String, Object> map) {
