...
public class Em {
	...
	Em(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("em");
	...
	public Em setDatabind(Object value) {
	...
	public Em removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Em setAccesskey(Object value) {
	...
	public Em removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Em set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Em remove_class() {
		this.__class = null;
		return this;
	} 

	public Em setContenteditable(Object value) {
	...
	public Em removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Em setContextmenu(Object value) {
	...
	public Em removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Em setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Em setDraggable(Object value) {
	...
	public Em removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Em setDropzone(Object value) {
	...
	public Em removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Em setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Em removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Em setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Em setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Em removeLang() {
		this._lang = null;
		return this;
	} 

	public Em setSpellcheck(Object value) {
	...
	public Em removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Em setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Em removeStyle() {
		this._style = null;
		return this;
	} 

	public Em setTabindex(Object value) {
	...
	public Em removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Em setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Em removeTitle() {
		this._title = null;
		return this;
	} 

	public Em setTranslate(Object value) {
	...
	public Em removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Em addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Em setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Em setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Em removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Em removeContent(int index) {
	...
	public Em addData(Object _name, Object _value) {
	...
	public Em addData(Em_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Em_Data> streamData() {
		return this._data.stream().map(Em_Data::new);
	}

	public static final class Em_Data {

		Object _name;
		Object _value;

		public Em_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Em_Data(java.util.Map<String, Object> map) {
