...
public class Samp {
	...
	Samp(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("samp");
	...
	public Samp setDatabind(Object value) {
	...
	public Samp removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Samp setAccesskey(Object value) {
	...
	public Samp removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Samp set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Samp remove_class() {
		this.__class = null;
		return this;
	} 

	public Samp setContenteditable(Object value) {
	...
	public Samp removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Samp setContextmenu(Object value) {
	...
	public Samp removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Samp setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Samp removeDir() {
		this._dir = null;
		return this;
	} 

	public Samp setDraggable(Object value) {
	...
	public Samp removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Samp setDropzone(Object value) {
	...
	public Samp removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Samp setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Samp removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Samp setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Samp removeId() {
		this._id = null;
		return this;
	} 

	public Samp setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Samp removeLang() {
		this._lang = null;
		return this;
	} 

	public Samp setSpellcheck(Object value) {
	...
	public Samp removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Samp setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Samp removeStyle() {
		this._style = null;
		return this;
	} 

	public Samp setTabindex(Object value) {
	...
	public Samp removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Samp setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Samp removeTitle() {
		this._title = null;
		return this;
	} 

	public Samp setTranslate(Object value) {
	...
	public Samp removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Samp addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Samp setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Samp setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Samp removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Samp removeContent(int index) {
	...
	public Samp addData(Object _name, Object _value) {
	...
	public Samp addData(Samp_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Samp_Data> streamData() {
		return this._data.stream().map(Samp_Data::new);
	}

	public static final class Samp_Data {

		Object _name;
		Object _value;

		public Samp_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Samp_Data(java.util.Map<String, Object> map) {
