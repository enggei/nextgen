...
public class Canvas {
	...
	public Canvas setHeight(Object value) {
		this._height = value;
		return this;
	}
	...
	public Canvas removeHeight() {
		this._height = null;
		return this;
	} 

	public Canvas setWidth(Object value) {
		this._width = value;
		return this;
	}
	...
	public Canvas removeWidth() {
		this._width = null;
		return this;
	} 

	public Canvas setDatabind(Object value) {
	...
	public Canvas removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Canvas setAccesskey(Object value) {
	...
	public Canvas removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Canvas set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Canvas remove_class() {
		this.__class = null;
		return this;
	} 

	public Canvas setContenteditable(Object value) {
	...
	public Canvas removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Canvas setContextmenu(Object value) {
	...
	public Canvas removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Canvas setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Canvas removeDir() {
		this._dir = null;
		return this;
	} 

	public Canvas setDraggable(Object value) {
	...
	public Canvas removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Canvas setDropzone(Object value) {
	...
	public Canvas removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Canvas setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Canvas removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Canvas setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Canvas removeId() {
		this._id = null;
		return this;
	} 

	public Canvas setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Canvas removeLang() {
		this._lang = null;
		return this;
	} 

	public Canvas setSpellcheck(Object value) {
	...
	public Canvas removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Canvas setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Canvas removeStyle() {
		this._style = null;
		return this;
	} 

	public Canvas setTabindex(Object value) {
	...
	public Canvas removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Canvas setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Canvas removeTitle() {
		this._title = null;
		return this;
	} 

	public Canvas setTranslate(Object value) {
	...
	public Canvas removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Canvas addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Canvas setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Canvas setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Canvas removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Canvas removeContent(int index) {
	...
	public Canvas addData(Object _name, Object _value) {
	...
	public Canvas addData(Canvas_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Canvas_Data> streamData() {
		return this._data.stream().map(Canvas_Data::new);
	}

	public static final class Canvas_Data {

		Object _name;
		Object _value;

		public Canvas_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Canvas_Data(java.util.Map<String, Object> map) {
