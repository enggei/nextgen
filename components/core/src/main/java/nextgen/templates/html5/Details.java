...
public class Details {
	...
	Details(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("details");
		st.add("open", _open);
	...
	public Details setOpen(Object value) {
		this._open = value;
		return this;
	}
	...
	public Details removeOpen() {
		this._open = null;
		return this;
	} 

	public Details setDatabind(Object value) {
	...
	public Details removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Details setAccesskey(Object value) {
	...
	public Details removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Details set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Details remove_class() {
		this.__class = null;
		return this;
	} 

	public Details setContenteditable(Object value) {
	...
	public Details removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Details setContextmenu(Object value) {
	...
	public Details removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Details setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Details removeDir() {
		this._dir = null;
		return this;
	} 

	public Details setDraggable(Object value) {
	...
	public Details removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Details setDropzone(Object value) {
	...
	public Details removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Details setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Details removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Details setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Details removeId() {
		this._id = null;
		return this;
	} 

	public Details setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Details removeLang() {
		this._lang = null;
		return this;
	} 

	public Details setSpellcheck(Object value) {
	...
	public Details removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Details setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Details removeStyle() {
		this._style = null;
		return this;
	} 

	public Details setTabindex(Object value) {
	...
	public Details removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Details setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Details removeTitle() {
		this._title = null;
		return this;
	} 

	public Details setTranslate(Object value) {
	...
	public Details removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Details addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Details setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Details setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Details removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Details removeContent(int index) {
	...
	public Details addData(Object _name, Object _value) {
	...
	public Details addData(Details_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Details_Data> streamData() {
		return this._data.stream().map(Details_Data::new);
	}

	public static final class Details_Data {

		Object _name;
		Object _value;

		public Details_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Details_Data(java.util.Map<String, Object> map) {
