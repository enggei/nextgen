...
public class Header {
	...
	Header(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("header");
	...
	public Header setDatabind(Object value) {
	...
	public Header removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Header setAccesskey(Object value) {
	...
	public Header removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Header set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Header remove_class() {
		this.__class = null;
		return this;
	} 

	public Header setContenteditable(Object value) {
	...
	public Header removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Header setContextmenu(Object value) {
	...
	public Header removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Header setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Header removeDir() {
		this._dir = null;
		return this;
	} 

	public Header setDraggable(Object value) {
	...
	public Header removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Header setDropzone(Object value) {
	...
	public Header removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Header setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Header removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Header setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Header removeId() {
		this._id = null;
		return this;
	} 

	public Header setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Header removeLang() {
		this._lang = null;
		return this;
	} 

	public Header setSpellcheck(Object value) {
	...
	public Header removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Header setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Header removeStyle() {
		this._style = null;
		return this;
	} 

	public Header setTabindex(Object value) {
	...
	public Header removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Header setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Header removeTitle() {
		this._title = null;
		return this;
	} 

	public Header setTranslate(Object value) {
	...
	public Header removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Header addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Header setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Header setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Header removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Header removeContent(int index) {
	...
	public Header addData(Object _name, Object _value) {
	...
	public Header addData(Header_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Header_Data> streamData() {
		return this._data.stream().map(Header_Data::new);
	}

	public static final class Header_Data {

		Object _name;
		Object _value;

		public Header_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Header_Data(java.util.Map<String, Object> map) {
