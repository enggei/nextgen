...
public class Dir {
	...
	Dir(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("dir");
	...
	public Dir setDatabind(Object value) {
	...
	public Dir removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Dir setAccesskey(Object value) {
	...
	public Dir removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Dir set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Dir remove_class() {
		this.__class = null;
		return this;
	} 

	public Dir setContenteditable(Object value) {
	...
	public Dir removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Dir setContextmenu(Object value) {
	...
	public Dir removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Dir setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Dir setDraggable(Object value) {
	...
	public Dir removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Dir setDropzone(Object value) {
	...
	public Dir removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Dir setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Dir removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Dir setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Dir setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Dir removeLang() {
		this._lang = null;
		return this;
	} 

	public Dir setSpellcheck(Object value) {
	...
	public Dir removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Dir setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Dir removeStyle() {
		this._style = null;
		return this;
	} 

	public Dir setTabindex(Object value) {
	...
	public Dir removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Dir setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Dir removeTitle() {
		this._title = null;
		return this;
	} 

	public Dir setTranslate(Object value) {
	...
	public Dir removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Dir addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Dir setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Dir setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Dir removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Dir removeContent(int index) {
	...
	public Dir addData(Object _name, Object _value) {
	...
	public Dir addData(Dir_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Dir_Data> streamData() {
		return this._data.stream().map(Dir_Data::new);
	}

	public static final class Dir_Data {

		Object _name;
		Object _value;

		public Dir_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Dir_Data(java.util.Map<String, Object> map) {
