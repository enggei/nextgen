...
public class H3 {
	...
	H3(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("h3");
	...
	public H3 setDatabind(Object value) {
	...
	public H3 removeDatabind() {
		this._databind = null;
		return this;
	} 

	public H3 setAccesskey(Object value) {
	...
	public H3 removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public H3 set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public H3 remove_class() {
		this.__class = null;
		return this;
	} 

	public H3 setContenteditable(Object value) {
	...
	public H3 removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public H3 setContextmenu(Object value) {
	...
	public H3 removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public H3 setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public H3 setDraggable(Object value) {
	...
	public H3 removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public H3 setDropzone(Object value) {
	...
	public H3 removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public H3 setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public H3 removeHidden() {
		this._hidden = null;
		return this;
	} 

	public H3 setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public H3 setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public H3 removeLang() {
		this._lang = null;
		return this;
	} 

	public H3 setSpellcheck(Object value) {
	...
	public H3 removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public H3 setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public H3 removeStyle() {
		this._style = null;
		return this;
	} 

	public H3 setTabindex(Object value) {
	...
	public H3 removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public H3 setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public H3 removeTitle() {
		this._title = null;
		return this;
	} 

	public H3 setTranslate(Object value) {
	...
	public H3 removeTranslate() {
		this._translate = null;
		return this;
	} 

	public H3 addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public H3 setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public H3 setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public H3 removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public H3 removeContent(int index) {
	...
	public H3 addData(Object _name, Object _value) {
	...
	public H3 addData(H3_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<H3_Data> streamData() {
		return this._data.stream().map(H3_Data::new);
	}

	public static final class H3_Data {

		Object _name;
		Object _value;

		public H3_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private H3_Data(java.util.Map<String, Object> map) {
