...
public class Acronym {
	...
	Acronym(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("acronym");
	...
	public Acronym setDatabind(Object value) {
	...
	public Acronym removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Acronym setAccesskey(Object value) {
	...
	public Acronym removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Acronym set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Acronym remove_class() {
		this.__class = null;
		return this;
	} 

	public Acronym setContenteditable(Object value) {
	...
	public Acronym removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Acronym setContextmenu(Object value) {
	...
	public Acronym removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Acronym setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Acronym removeDir() {
		this._dir = null;
		return this;
	} 

	public Acronym setDraggable(Object value) {
	...
	public Acronym removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Acronym setDropzone(Object value) {
	...
	public Acronym removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Acronym setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Acronym removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Acronym setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Acronym removeId() {
		this._id = null;
		return this;
	} 

	public Acronym setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Acronym removeLang() {
		this._lang = null;
		return this;
	} 

	public Acronym setSpellcheck(Object value) {
	...
	public Acronym removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Acronym setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Acronym removeStyle() {
		this._style = null;
		return this;
	} 

	public Acronym setTabindex(Object value) {
	...
	public Acronym removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Acronym setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Acronym removeTitle() {
		this._title = null;
		return this;
	} 

	public Acronym setTranslate(Object value) {
	...
	public Acronym removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Acronym addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Acronym setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Acronym setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Acronym removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Acronym removeContent(int index) {
	...
	public Acronym addData(Object _name, Object _value) {
	...
	public Acronym addData(Acronym_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Acronym_Data> streamData() {
		return this._data.stream().map(Acronym_Data::new);
	}

	public static final class Acronym_Data {

		Object _name;
		Object _value;

		public Acronym_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Acronym_Data(java.util.Map<String, Object> map) {
