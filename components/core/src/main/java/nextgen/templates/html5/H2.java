...
public class H2 {
	...
	H2(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("h2");
	...
	public H2 setDatabind(Object value) {
	...
	public H2 removeDatabind() {
		this._databind = null;
		return this;
	} 

	public H2 setAccesskey(Object value) {
	...
	public H2 removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public H2 set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public H2 remove_class() {
		this.__class = null;
		return this;
	} 

	public H2 setContenteditable(Object value) {
	...
	public H2 removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public H2 setContextmenu(Object value) {
	...
	public H2 removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public H2 setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public H2 setDraggable(Object value) {
	...
	public H2 removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public H2 setDropzone(Object value) {
	...
	public H2 removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public H2 setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public H2 removeHidden() {
		this._hidden = null;
		return this;
	} 

	public H2 setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public H2 setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public H2 removeLang() {
		this._lang = null;
		return this;
	} 

	public H2 setSpellcheck(Object value) {
	...
	public H2 removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public H2 setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public H2 removeStyle() {
		this._style = null;
		return this;
	} 

	public H2 setTabindex(Object value) {
	...
	public H2 removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public H2 setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public H2 removeTitle() {
		this._title = null;
		return this;
	} 

	public H2 setTranslate(Object value) {
	...
	public H2 removeTranslate() {
		this._translate = null;
		return this;
	} 

	public H2 addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public H2 setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public H2 setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public H2 removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public H2 removeContent(int index) {
	...
	public H2 addData(Object _name, Object _value) {
	...
	public H2 addData(H2_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<H2_Data> streamData() {
		return this._data.stream().map(H2_Data::new);
	}

	public static final class H2_Data {

		Object _name;
		Object _value;

		public H2_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private H2_Data(java.util.Map<String, Object> map) {
