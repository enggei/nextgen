...
public class Hgroup {
	...
	Hgroup(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("hgroup");
	...
	public Hgroup setDatabind(Object value) {
	...
	public Hgroup removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Hgroup setAccesskey(Object value) {
	...
	public Hgroup removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Hgroup set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Hgroup remove_class() {
		this.__class = null;
		return this;
	} 

	public Hgroup setContenteditable(Object value) {
	...
	public Hgroup removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Hgroup setContextmenu(Object value) {
	...
	public Hgroup removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Hgroup setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Hgroup removeDir() {
		this._dir = null;
		return this;
	} 

	public Hgroup setDraggable(Object value) {
	...
	public Hgroup removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Hgroup setDropzone(Object value) {
	...
	public Hgroup removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Hgroup setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Hgroup removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Hgroup setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Hgroup removeId() {
		this._id = null;
		return this;
	} 

	public Hgroup setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Hgroup removeLang() {
		this._lang = null;
		return this;
	} 

	public Hgroup setSpellcheck(Object value) {
	...
	public Hgroup removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Hgroup setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Hgroup removeStyle() {
		this._style = null;
		return this;
	} 

	public Hgroup setTabindex(Object value) {
	...
	public Hgroup removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Hgroup setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Hgroup removeTitle() {
		this._title = null;
		return this;
	} 

	public Hgroup setTranslate(Object value) {
	...
	public Hgroup removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Hgroup addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Hgroup setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Hgroup setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Hgroup removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Hgroup removeContent(int index) {
	...
	public Hgroup addData(Object _name, Object _value) {
	...
	public Hgroup addData(Hgroup_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Hgroup_Data> streamData() {
		return this._data.stream().map(Hgroup_Data::new);
	}

	public static final class Hgroup_Data {

		Object _name;
		Object _value;

		public Hgroup_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Hgroup_Data(java.util.Map<String, Object> map) {
