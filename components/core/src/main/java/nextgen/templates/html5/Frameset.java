...
public class Frameset {
	...
	Frameset(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("frameset");
	...
	public Frameset setDatabind(Object value) {
	...
	public Frameset removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Frameset setAccesskey(Object value) {
	...
	public Frameset removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Frameset set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Frameset remove_class() {
		this.__class = null;
		return this;
	} 

	public Frameset setContenteditable(Object value) {
	...
	public Frameset removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Frameset setContextmenu(Object value) {
	...
	public Frameset removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Frameset setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Frameset removeDir() {
		this._dir = null;
		return this;
	} 

	public Frameset setDraggable(Object value) {
	...
	public Frameset removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Frameset setDropzone(Object value) {
	...
	public Frameset removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Frameset setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Frameset removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Frameset setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Frameset removeId() {
		this._id = null;
		return this;
	} 

	public Frameset setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Frameset removeLang() {
		this._lang = null;
		return this;
	} 

	public Frameset setSpellcheck(Object value) {
	...
	public Frameset removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Frameset setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Frameset removeStyle() {
		this._style = null;
		return this;
	} 

	public Frameset setTabindex(Object value) {
	...
	public Frameset removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Frameset setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Frameset removeTitle() {
		this._title = null;
		return this;
	} 

	public Frameset setTranslate(Object value) {
	...
	public Frameset removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Frameset addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Frameset setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Frameset setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Frameset removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Frameset removeContent(int index) {
	...
	public Frameset addData(Object _name, Object _value) {
	...
	public Frameset addData(Frameset_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Frameset_Data> streamData() {
		return this._data.stream().map(Frameset_Data::new);
	}

	public static final class Frameset_Data {

		Object _name;
		Object _value;

		public Frameset_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Frameset_Data(java.util.Map<String, Object> map) {
