...
public class Mark {
	...
	Mark(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("mark");
	...
	public Mark setDatabind(Object value) {
	...
	public Mark removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Mark setAccesskey(Object value) {
	...
	public Mark removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Mark set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Mark remove_class() {
		this.__class = null;
		return this;
	} 

	public Mark setContenteditable(Object value) {
	...
	public Mark removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Mark setContextmenu(Object value) {
	...
	public Mark removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Mark setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Mark removeDir() {
		this._dir = null;
		return this;
	} 

	public Mark setDraggable(Object value) {
	...
	public Mark removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Mark setDropzone(Object value) {
	...
	public Mark removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Mark setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Mark removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Mark setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Mark removeId() {
		this._id = null;
		return this;
	} 

	public Mark setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Mark removeLang() {
		this._lang = null;
		return this;
	} 

	public Mark setSpellcheck(Object value) {
	...
	public Mark removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Mark setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Mark removeStyle() {
		this._style = null;
		return this;
	} 

	public Mark setTabindex(Object value) {
	...
	public Mark removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Mark setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Mark removeTitle() {
		this._title = null;
		return this;
	} 

	public Mark setTranslate(Object value) {
	...
	public Mark removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Mark addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Mark setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Mark setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Mark removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Mark removeContent(int index) {
	...
	public Mark addData(Object _name, Object _value) {
	...
	public Mark addData(Mark_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Mark_Data> streamData() {
		return this._data.stream().map(Mark_Data::new);
	}

	public static final class Mark_Data {

		Object _name;
		Object _value;

		public Mark_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Mark_Data(java.util.Map<String, Object> map) {
