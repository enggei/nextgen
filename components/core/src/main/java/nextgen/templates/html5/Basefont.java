...
public class Basefont {
	...
	Basefont(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("basefont");
	...
	public Basefont setDatabind(Object value) {
	...
	public Basefont removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Basefont setAccesskey(Object value) {
	...
	public Basefont removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Basefont set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Basefont remove_class() {
		this.__class = null;
		return this;
	} 

	public Basefont setContenteditable(Object value) {
	...
	public Basefont removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Basefont setContextmenu(Object value) {
	...
	public Basefont removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Basefont setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Basefont removeDir() {
		this._dir = null;
		return this;
	} 

	public Basefont setDraggable(Object value) {
	...
	public Basefont removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Basefont setDropzone(Object value) {
	...
	public Basefont removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Basefont setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Basefont removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Basefont setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Basefont removeId() {
		this._id = null;
		return this;
	} 

	public Basefont setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Basefont removeLang() {
		this._lang = null;
		return this;
	} 

	public Basefont setSpellcheck(Object value) {
	...
	public Basefont removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Basefont setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Basefont removeStyle() {
		this._style = null;
		return this;
	} 

	public Basefont setTabindex(Object value) {
	...
	public Basefont removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Basefont setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Basefont removeTitle() {
		this._title = null;
		return this;
	} 

	public Basefont setTranslate(Object value) {
	...
	public Basefont removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Basefont addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Basefont setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Basefont setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Basefont removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Basefont removeContent(int index) {
	...
	public Basefont addData(Object _name, Object _value) {
	...
	public Basefont addData(Basefont_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Basefont_Data> streamData() {
		return this._data.stream().map(Basefont_Data::new);
	}

	public static final class Basefont_Data {

		Object _name;
		Object _value;

		public Basefont_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Basefont_Data(java.util.Map<String, Object> map) {
