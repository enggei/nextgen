...
public class Colgroup {
	...
	Colgroup(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("colgroup");
		st.add("span", _span);
	...
	public Colgroup setSpan(Object value) {
		this._span = value;
		return this;
	}
	...
	public Colgroup removeSpan() {
		this._span = null;
		return this;
	} 

	public Colgroup setDatabind(Object value) {
	...
	public Colgroup removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Colgroup setAccesskey(Object value) {
	...
	public Colgroup removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Colgroup set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Colgroup remove_class() {
		this.__class = null;
		return this;
	} 

	public Colgroup setContenteditable(Object value) {
	...
	public Colgroup removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Colgroup setContextmenu(Object value) {
	...
	public Colgroup removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Colgroup setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Colgroup removeDir() {
		this._dir = null;
		return this;
	} 

	public Colgroup setDraggable(Object value) {
	...
	public Colgroup removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Colgroup setDropzone(Object value) {
	...
	public Colgroup removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Colgroup setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Colgroup removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Colgroup setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Colgroup removeId() {
		this._id = null;
		return this;
	} 

	public Colgroup setLang(Object value) {
		this._lang = value;
		return this;
	}
	...
	public Colgroup removeLang() {
		this._lang = null;
		return this;
	} 

	public Colgroup setSpellcheck(Object value) {
	...
	public Colgroup removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Colgroup setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Colgroup removeStyle() {
		this._style = null;
		return this;
	} 

	public Colgroup setTabindex(Object value) {
	...
	public Colgroup removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Colgroup setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Colgroup removeTitle() {
		this._title = null;
		return this;
	} 

	public Colgroup setTranslate(Object value) {
	...
	public Colgroup removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Colgroup addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Colgroup setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Colgroup setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Colgroup removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Colgroup removeContent(int index) {
	...
	public Colgroup addData(Object _name, Object _value) {
	...
	public Colgroup addData(Colgroup_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Colgroup_Data> streamData() {
		return this._data.stream().map(Colgroup_Data::new);
	}

	public static final class Colgroup_Data {

		Object _name;
		Object _value;

		public Colgroup_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Colgroup_Data(java.util.Map<String, Object> map) {
