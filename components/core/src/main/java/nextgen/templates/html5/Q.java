...
public class Q {
	...
	Q(org.stringtemplate.v4.STGroup stGroup) {
	...
	public String toString() {
		final org.stringtemplate.v4.ST st = stGroup.getInstanceOf("q");
		st.add("cite", _cite);
	...
	public Q setDatabind(Object value) {
	...
	public Q removeDatabind() {
		this._databind = null;
		return this;
	} 

	public Q setAccesskey(Object value) {
	...
	public Q removeAccesskey() {
		this._accesskey = null;
		return this;
	} 

	public Q set_class(Object value) {
		this.__class = value;
		return this;
	}
	...
	public Q remove_class() {
		this.__class = null;
		return this;
	} 

	public Q setContenteditable(Object value) {
	...
	public Q removeContenteditable() {
		this._contenteditable = null;
		return this;
	} 

	public Q setContextmenu(Object value) {
	...
	public Q removeContextmenu() {
		this._contextmenu = null;
		return this;
	} 

	public Q setDir(Object value) {
		this._dir = value;
		return this;
	}
	...
	public Q setDraggable(Object value) {
	...
	public Q removeDraggable() {
		this._draggable = null;
		return this;
	} 

	public Q setDropzone(Object value) {
	...
	public Q removeDropzone() {
		this._dropzone = null;
		return this;
	} 

	public Q setHidden(Object value) {
		this._hidden = value;
		return this;
	}
	...
	public Q removeHidden() {
		this._hidden = null;
		return this;
	} 

	public Q setId(Object value) {
		this._id = value;
		return this;
	}
	...
	public Q setSpellcheck(Object value) {
	...
	public Q removeSpellcheck() {
		this._spellcheck = null;
		return this;
	} 

	public Q setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public Q removeStyle() {
		this._style = null;
		return this;
	} 

	public Q setTabindex(Object value) {
	...
	public Q removeTabindex() {
		this._tabindex = null;
		return this;
	} 

	public Q setTitle(Object value) {
		this._title = value;
		return this;
	}
	...
	public Q removeTitle() {
		this._title = null;
		return this;
	} 

	public Q setTranslate(Object value) {
	...
	public Q removeTranslate() {
		this._translate = null;
		return this;
	} 

	public Q addContent(Object value) {
		this._content.add(value);
		return this;
	}

	public Q setContent(Object[] value) {
		this._content.addAll(java.util.Arrays.asList(value));
		return this;
	}

	public Q setContent(java.util.Collection<Object> values) {
		this._content.addAll(values);
		return this;
	}

	public Q removeContent(Object value) {
		this._content.remove(value);
		return this;
	}

	public Q removeContent(int index) {
	...
	public Q addData(Object _name, Object _value) {
	...
	public Q addData(Q_Data value) {
		return addData(value._name, value._value);
	}

	public java.util.stream.Stream<Q_Data> streamData() {
		return this._data.stream().map(Q_Data::new);
	}

	public static final class Q_Data {

		Object _name;
		Object _value;

		public Q_Data(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private Q_Data(java.util.Map<String, Object> map) {
