...
public class DependencyModel {
	...
	public static final String stTemplateUuid = "c7c5c8b4-df97-446b-bf2f-4721d782af39";
	...
	public DependencyModel setValue(String value) {
		return setValue(db.newSTValue(value));
	}

	public DependencyModel setValue(STValue value) {
	...
	public DependencyModel removeValue() {
		return removeArgument("value");
	}

	public DependencyModel setPackageName(String value) {
		return setPackageName(db.newSTValue(value));
	}

	public DependencyModel setPackageName(STValue value) {
	...
	public DependencyModel removePackageName() {
