...
public class Log4JST {
	...
	.append(Category.st + "\n")
	.append(ConsoleAppender.st + "\n")
	.append(FileinfoAppender.st + "\n")
	.toString()  ;
	...
	private static org.stringtemplate.v4.STGroup stGroup = decorate(new org.stringtemplate.v4.STGroupString("Log4JST", stg, '~', '~'));
	...
	public static Category newCategory() {
		return new Category(stGroup);
	}  

	public static ConsoleAppender newConsoleAppender() {
		return new ConsoleAppender(stGroup);
	}  

	public static FileinfoAppender newFileinfoAppender() {
		return new FileinfoAppender(stGroup);
	}  
