...
public class PropertyReference implements PomProperty {
	...
	PropertyReference(org.stringtemplate.v4.STGroup stGroup) {
	...
	public PropertyReference setName(Object value) {
		this._name = value;
		return this;
	}
