...
public class ListItemAvatarElement {
	...
	public ListItemAvatarElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public ListItemAvatarElement removeKey() {
		this._key = null;
		return this;
	} 

	public ListItemAvatarElement setStyle(Object value) {
		this._style = value;
		return this;
	}
	...
	public ListItemAvatarElement removeStyle() {
		this._style = null;
		return this;
	} 
	...
	public ListItemAvatarElement addAttribute(Object _name, Object _value) {
	...
	public ListItemAvatarElement addAttribute(ListItemAvatarElement_Attribute value) {
		return addAttribute(value._name, value._value);
	}

	public java.util.stream.Stream<ListItemAvatarElement_Attribute> streamAttribute() {
	...
	public static final class ListItemAvatarElement_Attribute {
		...
		public ListItemAvatarElement_Attribute(Object _name, Object _value) {
			this._name = _name;
			this._value = _value;
		}

		private ListItemAvatarElement_Attribute(java.util.Map<String, Object> map) {
	...
	static final String st = "ListItemAvatarElement(classes,className,id,key,style,attribute,children) ::= <<<ListItemAvatar~if(classes)~\n" + 
