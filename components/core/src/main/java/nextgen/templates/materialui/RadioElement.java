...
public class RadioElement {
	...
	static final String st = "RadioElement(checked,checkedIcon,classes,className,color,disabled,disableRipple,icon,id,inputProps,inputRef,name,onChange,required,size,value) ::= <<<Radio~if(checked)~\n" + 
