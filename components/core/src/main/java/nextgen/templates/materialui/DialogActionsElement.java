...
public class DialogActionsElement {
	...
	public DialogActionsElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public DialogActionsElement removeKey() {
		this._key = null;
		return this;
	} 
	...
	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(DialogActionsElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(DialogActionsElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}
	...
	static final String st = "DialogActionsElement(classes,className,disableSpacing,id,key,style,attribute,children) ::= <<<DialogActions~if(classes)~\n" + 
