...
public class TreeItemElement {
	...
	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(TreeItemElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(TreeItemElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}
