...
public class MaterialUIST {
	...
	ButtonElement.st + "\n" + 
	DividerElement.st + "\n" + 
	GridContainerElement.st + "\n" + 
	GridItemElement.st + "\n" + 
	LinkElement.st + "\n" + 
	PaperElement.st + "\n" + 
	TypographyElement.st + "\n" ;
	...
	public static SimpleElement newSimpleElement() {
		return new SimpleElement(stGroup);
	} 
	...
	public static GridContainerElement newGridContainerElement() {
		return new GridContainerElement(stGroup);
	} 

	public static GridItemElement newGridItemElement() {
		return new GridItemElement(stGroup);
	} 
