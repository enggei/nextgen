...
public class FilledInputElement {
	...
	public FilledInputElement setKey(Object value) {
		this._key = value;
		return this;
	}
	...
	public FilledInputElement removeKey() {
		this._key = null;
		return this;
	} 
	...
	public java.util.List<Object> getAttribute_Name() {
		return streamAttribute().map(FilledInputElement_Attribute::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getAttribute_Value() {
		return streamAttribute().map(FilledInputElement_Attribute::getValue).collect(java.util.stream.Collectors.toList());
	}
	...
	static final String st = "FilledInputElement(autoComplete,autoFocus,classes,className,color,defaultValue,disabled,disableUnderline,endAdornment,error,fullWidth,id,inputComponent,inputProps,inputRef,key,margin,multiline,name,onChange,placeholder,readOnly,required,rows,rowsMax,startAdornment,style,type,value,attribute) ::= <<<FilledInput~if(autoComplete)~\n" + 
