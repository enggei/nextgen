...
public class Complex {
	...
	public java.util.List<Object> getList_Name() {
		return streamList().map(Complex_List::getName).collect(java.util.stream.Collectors.toList());
	}


	public java.util.List<Object> getList_Value() {
		return streamList().map(Complex_List::getValue).collect(java.util.stream.Collectors.toList());
	}
