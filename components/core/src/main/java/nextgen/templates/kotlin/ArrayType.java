...
public class ArrayType implements TypeDeclaration {
	...
	public ArrayType setType(TypeDeclaration value) {
		this._type = value;
		return this;
	}
	...
	static final String st = "ArrayType(type) ::= <<Array<~type~> >>";
}  