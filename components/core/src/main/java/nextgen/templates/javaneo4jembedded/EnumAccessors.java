...
public class EnumAccessors {
	...
	static final String st = "enumAccessors(className,name,type,setStatements,removeStatements) ::= <<public ~className;format=\"capitalize\"~ set~name;format=\"capitalize\"~(~type~ value) {\n" + 
				"	if (value == null) \n" + 
