...
public final class NewSTArgument {
	...
	public static void post(nextgen.st.model.STArgument argument, nextgen.st.model.STModel model, nextgen.st.domain.STParameter parameter, nextgen.st.model.STValue value) {
	...
	public NewSTArgument(nextgen.st.model.STArgument argument, nextgen.st.model.STModel model, nextgen.st.domain.STParameter parameter, nextgen.st.model.STValue value) {
