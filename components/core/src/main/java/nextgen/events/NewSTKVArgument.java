...
public final class NewSTKVArgument {
	...
	public static void post(nextgen.st.model.STModel model, nextgen.st.domain.STParameter stParameter, nextgen.st.model.STArgument argument, java.util.Collection<nextgen.st.model.STArgumentKV> kvs) {
	...
	public NewSTKVArgument(nextgen.st.model.STModel model, nextgen.st.domain.STParameter stParameter, nextgen.st.model.STArgument argument, java.util.Collection<nextgen.st.model.STArgumentKV> kvs) {
		this.model = model;
