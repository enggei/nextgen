...
public final class TemplateNavigatorSTParameterTreeNodeClicked {
	...
	public static void post(nextgen.st.model.STParameter parameter, nextgen.st.model.STModel model) {
	...
	public TemplateNavigatorSTParameterTreeNodeClicked(nextgen.st.model.STParameter parameter, nextgen.st.model.STModel model) {
