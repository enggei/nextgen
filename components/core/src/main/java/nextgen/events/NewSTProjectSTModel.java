...
public final class NewSTProjectSTModel {
	...
	public static void post(nextgen.st.model.STModel model, nextgen.st.model.STProject project, nextgen.st.domain.STTemplate template) {
	...
	public NewSTProjectSTModel(nextgen.st.model.STModel model, nextgen.st.model.STProject project, nextgen.st.domain.STTemplate template) {
		this.model = model;
