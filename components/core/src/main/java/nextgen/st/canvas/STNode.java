...
public class STNode extends PNode implements PropertyChangeListener {
	...
	protected final STModelCanvas canvas;
	...
	public STNode(STModelCanvas canvas, String text) {
		this(canvas, text, UUID.randomUUID());
	}

	public STNode(STModelCanvas canvas, String text, UUID uuid) {
		this.canvas = canvas;
	...
	static abstract class NodeAction<N extends STNode> extends AbstractAction {
		...
		NodeAction(String name, N node, STModelCanvas canvas, PInputEvent event) {
			super(name);
			this.node = node;
			this.canvas = canvas;
			this.event = event;
		...
		abstract void actionPerformed(N node, STModelCanvas canvas, PInputEvent event, ActionEvent e);
	...
	protected static final class LayoutTreeAction extends NodeAction<STNode> {
		...
		protected LayoutTreeAction(STNode root, STModelCanvas canvas, PInputEvent event) {
		...
		protected LayoutTreeAction(STNode root, STModelCanvas canvas, PInputEvent event, org.abego.treelayout.Configuration.Location location, org.abego.treelayout.Configuration.AlignmentInLevel alignmentInLevel) {
		...
		@Override
		void actionPerformed(STNode node, STModelCanvas canvas, PInputEvent event, ActionEvent e) {
	...
	private static final class RetainNode extends NodeAction<nextgen.st.canvas.STNode> {
		...
		RetainNode(nextgen.st.canvas.STNode node, STModelCanvas canvas, PInputEvent event) {
			super("Retain", node, canvas, event);
		}

		@Override
		void actionPerformed(nextgen.st.canvas.STNode node, STModelCanvas canvas, PInputEvent event, ActionEvent e) {
	...
	private static final class CloseNode extends NodeAction<nextgen.st.canvas.STNode> {
		...
		CloseNode(nextgen.st.canvas.STNode node, STModelCanvas canvas, PInputEvent event) {
	...
	private static final class PopupAction extends NodeAction<nextgen.st.canvas.STNode> {
		...
		PopupAction(nextgen.st.canvas.STNode node, STModelCanvas canvas, PInputEvent event) {
	...
	private static final class DebugAction extends NodeAction<nextgen.st.canvas.STNode> {
		...
		DebugAction(nextgen.st.canvas.STNode node, STModelCanvas canvas, PInputEvent event) {
