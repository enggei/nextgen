...
public class STKVNode extends nextgen.st.canvas.STNode {
	...
	public STKVNode(STModelCanvas canvas, nextgen.st.domain.STParameter stParameter, nextgen.st.model.STArgument stArgument) {
	...
	private static final class SetInputValueArgumentAction extends NodeAction<STKVNode> {
		...
		SetInputValueArgumentAction(String name, STKVNode node, STModelCanvas canvas, PInputEvent event, nextgen.st.domain.STParameter stParameter, nextgen.st.domain.STParameterKey stParameterKey, nextgen.st.model.STArgument stArgument) {
		...
		@Override
		void actionPerformed(STKVNode node, STModelCanvas canvas, PInputEvent event, ActionEvent e) {
	...
	private static final class SetSTValueArgumentAction extends NodeAction<STKVNode> {
		...
		SetSTValueArgumentAction(String name, STKVNode node, STModelCanvas canvas, PInputEvent event, nextgen.st.domain.STParameter stParameter, nextgen.st.domain.STParameterKey stParameterKey, nextgen.st.model.STArgument stArgument, STValueNode stValueNode) {
			super(name, node, canvas, event);
			this.stParameter = stParameter;
			this.stParameterKey = stParameterKey;
			this.stArgument = stArgument;
	...
	private static final class SetSTModelArgumentAction extends NodeAction<STKVNode> {
		...
		SetSTModelArgumentAction(String name, STKVNode node, STModelCanvas canvas, PInputEvent event, nextgen.st.domain.STParameter stParameter, nextgen.st.domain.STParameterKey stParameterKey, nextgen.st.model.STArgument stArgument, STModelNode stModelNode) {
			super(name, node, canvas, event);
			this.stParameter = stParameter;
			this.stParameterKey = stParameterKey;
			this.stArgument = stArgument;
	...
	private static final class OpenAllArguments extends NodeAction<STKVNode> {
		...
		OpenAllArguments(STKVNode node, STModelCanvas canvas, PInputEvent event) {
	...
	private static final class OpenArgument extends NodeAction<STKVNode> {
		...
		OpenArgument(String name, STKVNode node, STModelCanvas canvas, PInputEvent event, nextgen.st.model.STArgument stArgument, nextgen.st.domain.STParameterKey stParameterKey, nextgen.st.model.STArgumentKV stArgumentKV) {
			super(name, node, canvas, event);
			this.stArgument = stArgument;
			this.stParameterKey = stParameterKey;
	...
	private static final class RemoveArgument extends NodeAction<STKVNode> {
		...
		RemoveArgument(String name, STKVNode node, STModelCanvas canvas, PInputEvent event, nextgen.st.model.STArgument stArgument, nextgen.st.domain.STParameterKey stParameterKey, nextgen.st.model.STArgumentKV stArgumentKV) {
			super(name, node, canvas, event);
			this.stArgument = stArgument;
			this.stParameterKey = stParameterKey;
			this.stArgumentKV = stArgumentKV;
	...
	private static final class SetClipboardValueArgumentAction extends NodeAction<nextgen.st.canvas.STKVNode> {
		...
		SetClipboardValueArgumentAction(String name, nextgen.st.canvas.STKVNode node, STModelCanvas canvas, PInputEvent event, nextgen.st.domain.STParameter stParameter, nextgen.st.domain.STParameterKey stParameterKey, nextgen.st.model.STArgument stArgument) {
			super(name, node, canvas, event);
			this.stParameter = stParameter;
			this.stParameterKey = stParameterKey;
			this.stArgument = stArgument;
		...
		@Override
		void actionPerformed(nextgen.st.canvas.STKVNode node, STModelCanvas canvas, PInputEvent event, ActionEvent e) {
			canvas.presentationModel.doLaterInTransaction(tx -> {
