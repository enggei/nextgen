...
public class STModelEditorNavigator extends JPanel {
      ...
      STParameterTreeNode(nextgen.st.domain.STParameter model, STModel stModel) {
         ...
         stModel.getArgumentsSorted()
                ...
                .forEach(appModel().stArgumentConsumer(model)
                                   ...
                                   .onSingleSTModel((stArgument, stValue) -> addChild(new STModelTreeNode(stValue.getStModel(), appModel()
                                   ...
                                   .onListSTModel((stArgument, stValue) -> addChild(new STModelTreeNode(stValue.getStModel(), appModel()
                                         .findSTTemplateByUuid(stValue.getStModel().getStTemplate()), stArgument)))
   ...
   @org.greenrobot.eventbus.Subscribe()
   public void onArgumentAdded(nextgen.events.ArgumentAdded event) {
                  ...
                  .ifPresent(stParameterTreeNode -> {
                     appModel().stArgumentConsumer(event.stParameter)
                               .onSingleSTValue((stArgument, stValue) -> treeModel
                                     .addNodeInSortedOrder(stParameterTreeNode, new nextgen.st.STModelEditorNavigator.STValueTreeNode(stValue, event.stArgument)))
                               .onSingleSTModel((stArgument, stValue) -> treeModel
                                     .addNodeInSortedOrder(stParameterTreeNode, new nextgen.st.STModelEditorNavigator.STModelTreeNode(stValue
                                           .getStModel(), appModel().findSTTemplateByUuid(stValue.getStModel().getStTemplate()), event.stArgument)))
                               ...
                               .onKVListConsumer((stArgument, stKVValues) -> treeModel
                                     .addNodeInSortedOrder(stParameterTreeNode, new nextgen.st.STModelEditorNavigator.STKVArgumentTreeNode(event.stArgument, event.stParameter)));
