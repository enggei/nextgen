...
public class STModelEditorGrid extends JPanel {
   ...
   private Action getSearchAction(JTextField txtSearch) {
      return new AbstractAction("Search") {
         ...
         public void actionPerformed(ActionEvent e) {
            SwingUtilities.invokeLater(() -> {
               ...
               appModel().doInTransaction(transaction -> {
                        final List<STValueElement> stValues = new ArrayList<>();
                        addSTValues(stModel, stValues);
         ...
         public void addSTValues(STModel stModel, List<STValueElement> stValues) {
            ...
            stModel.getArguments()
                  ...
                  .map(STArgument::getValue)
                  .filter(stValue -> stValue.getType() != null)
                  .filter(stValue -> stValue.getType().equals(STValueType.STMODEL))
