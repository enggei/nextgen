...
public class EntityVisitorMethod {

	private final org.neo4j.graphdb.Node node;

	public EntityVisitorMethod(org.neo4j.graphdb.Node node) { 
		this.node = node;
	}
	...
	public boolean equals(java.lang.Object o) { 
		...
		final EntityVisitorMethod other = (EntityVisitorMethod) o;
	...
	public EntityVisitorMethod setUuid(String value) { 
	...
	public EntityVisitorMethod removeUuid() { 
		node.removeProperty(_uuid);
		return this;
	}

	public EntityVisitorMethod set_meta(MetaEntity dst) { 
	...
	public MetaEntity get_meta() { 
		final org.neo4j.graphdb.Relationship relationship = get_metaRelation();
		return relationship == null ? null : new MetaEntity(relationship.getOtherNode(node));
	}

	public EntityVisitorMethod remove_meta() { 
	...
	public EntityVisitorMethod setStatements(String value) { 
	...
	public EntityVisitorMethod removeStatements() { 
		node.removeProperty(_statements);
		return this;
	}

	public java.util.stream.Stream<DomainVisitor> getIncomingEntityVisitorsDomainVisitor() { 
		return java.util.stream.StreamSupport.stream(node.getRelationships(org.neo4j.graphdb.Direction.INCOMING, org.neo4j.graphdb.RelationshipType.withName("entityVisitors")).spliterator(), false).map((relationship) -> new DomainVisitor(relationship.getOtherNode(node)));
	}
	...
	public io.vertx.core.json.JsonObject toJsonObject() {
		...
		final MetaEntity __meta = get_meta();
