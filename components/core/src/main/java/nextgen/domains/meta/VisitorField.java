...
public class VisitorField {
	...
	public VisitorField(org.neo4j.graphdb.Node node) { 
		this.node = node;
	}
	...
	public boolean equals(java.lang.Object o) { 
		...
		final VisitorField other = (VisitorField) o;
	...
	public VisitorField setUuid(String value) { 
	...
	public VisitorField removeUuid() { 
	...
	public VisitorField setName(String value) { 
	...
	public VisitorField removeName() { 
	...
	public VisitorField setType(String value) { 
	...
	public VisitorField removeType() { 
		node.removeProperty(_type);
		return this;
	}

	public java.util.stream.Stream<DomainVisitor> getIncomingFieldsDomainVisitor() { 
		return java.util.stream.StreamSupport.stream(node.getRelationships(org.neo4j.graphdb.Direction.INCOMING, org.neo4j.graphdb.RelationshipType.withName("fields")).spliterator(), false).map((relationship) -> new DomainVisitor(relationship.getOtherNode(node)));
	}
