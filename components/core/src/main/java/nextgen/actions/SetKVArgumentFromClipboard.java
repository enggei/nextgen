...
public class SetKVArgumentFromClipboard extends TransactionAction {
   ...
   private final nextgen.st.domain.STParameterKey stParameterKey;
	...
	public SetKVArgumentFromClipboard(String name, nextgen.st.model.STModel stModel, nextgen.st.model.STArgument stArgument, nextgen.st.domain.STParameterKey stParameterKey) {
      super(name);
