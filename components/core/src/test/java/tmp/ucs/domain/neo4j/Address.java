...
public class Address {
	...
	public java.util.stream.Stream<Cinema> getIncomingAddress() { 
		return java.util.stream.StreamSupport.stream(node.getRelationships(org.neo4j.graphdb.Direction.INCOMING, org.neo4j.graphdb.RelationshipType.withName("address")).spliterator(), false).map((relationship) -> new Cinema(relationship.getOtherNode(node)));
	}
}